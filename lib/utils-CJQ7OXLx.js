...
var Gn = (e, t, i) => t in e ? Kn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: i }) : e[t] = i;
var ue = (e, t, i) => Gn(e, typeof t != "symbol" ? t + "" : t, i);
import { jsxs as m, jsx as r, Fragment as K } from "react/jsx-runtime";
import * as D from "react";
import Ae, { useState as p, useRef as X, useEffect as E, useCallback as A, useMemo as B, Fragment as lt, forwardRef as Tt, useImperativeHandle as At } from "react";
import "@radix-ui/react-toast";
import { ChevronRight as Zn, Check as ei, Circle as Jn, ChevronDown as Lt, ChevronUp as Ji, HelpCircle as Xi, Pencil as Yi, Trash2 as Qi, X as Xn, Plus as en, Bold as Yn, LoaderCircle as Qn, Italic as er, Underline as tr, Quote as ir, Strikethrough as nr, Minus as rr, Eraser as ar, PaintRoller as or, Redo2 as cr, Undo2 as sr, Subscript as lr, Superscript as dr, Code as hr, CodeXml as ur, Type as mr, IndentIncrease as fr, IndentDecrease as gr, List as xr, ListOrdered as br, ListTodo as pr, Link as wr, ImageUp as _r, Video as vr, Maximize as yr, Minimize as kr, Table as Cr, Sparkles as Nr, Unlink as Tr, BetweenHorizonalEnd as Ar, BetweenHorizonalStart as Lr, BetweenVerticalStart as Sr, BetweenVerticalEnd as Mr, TableCellsMerge as Ir, TableCellsSplit as zr, Trash as Hr, Replace as Ci, ChevronsUpDown as Er, Heading1 as Rr, Heading2 as Or, Heading3 as Pr, Heading4 as Br, Heading5 as $r, Heading6 as Dr, Columns2 as Ni, Columns3 as jr, Columns4 as Fr, GripVertical as Vr, Copy as tn, Clipboard as Ur, PanelLeft as Wr, PanelRight as qr, Frame as Kr, SmilePlus as Gr, SmilePlusIcon as Zr, Sigma as Jr, BookMarked as Xr, ZoomIn as Yr, ZoomOut as Qr, Settings as ea, Eye as ta, Paperclip as ia, CropIcon as na, CopyCheck as ra, Clock3 as aa, Laugh as oa, LucideTableProperties as ca, LucideSheet as sa, LucideImage as la, LucideFile as da, LucideVideo as ha, LucideAudioLines as ua } from "lucide-react";
import { B as le, N as ce, a as fe, m as re, R as xe, n as ti, u as ma, E as fa, i as ga, b as xa, c as ba, I as pa, U as wa, S as _a, C as va, f as rt, d as ya, e as ka, F as Ca, H as Na, T as Ta, g as J, h as Aa, j as La, k as Sa, O as Ma, l as Ia, o as za, p as Ha, L as Ea, q as Ra, r as Oa, s as Pa, D as Ba, t as yt, P as $a, v as Da, w as ja, G as Fa, x as Va, y as Ua, z as Wa, A as qa, J as Ka, K as Ga, M as nn, Q as rn, V as an, W as ii, X as ni, Y as Za, Z as Ja, _ as Xa, $ as Ya, a0 as Qa, a1 as Ti } from "./tiptap-YQs34NjN.js";
import { ah as eo, ai as ee, aj as ri, ak as ai, al as to, am as on, an as io, ao as Le, e as St, d as Se, ap as cn, aq as no, ar as ro, as as oi, at as ao, P as Ge, a as Me, Z as at, _ as ot, au as oo, av as kt, aw as sn, ae as co } from "./vendor-B-Qwdobh.js";
import { bundledThemes as ln, bundledLanguages as dn, createHighlighter as so } from "shiki";
import { u as F, C as lo, E as ho, l as W, B as uo, I as Ct, V as Vt, M as mo, D as hn, a as fo, b as go, c as Ai, d as un, e as xo, f as Fe, g as Ve, h as ci, T as ft, i as gt, j as xt } from "./locales-CuqNRoh_.js";
import * as Z from "@radix-ui/react-select";
import { Slot as Mt } from "@radix-ui/react-slot";
import si, { sticky as bo } from "tippy.js";
import { flushSync as Ue } from "react-dom";
import po from "react-image-crop";
...
import { Packer as wo } from "docx";
import { defaultNodes as ye, DocxSerializer as _o, defaultMarks as vo } from "prosemirror-docx";
...
import { TextAlignCenterIcon as ko, TextAlignJustifyIcon as Co, TextAlignLeftIcon as No, TextAlignRightIcon as To } from "@radix-ui/react-icons";
...
let Rt;
function Ot() {
  return Rt === void 0 && (Rt = navigator.platform.includes("Mac")), Rt;
}
function It(e) {
  return `${e}`.toLowerCase() === "mod" ? Ot() ? "⌘" : "Ctrl" : `${e}`.toLowerCase() === "alt" ? Ot() ? "⌥" : "Alt" : `${e}`.toLowerCase() === "shift" ? Ot() ? "⇧" : "Shift" : e;
}
function zt(e) {
...
const _ = Ae.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ m(Je, { children: [
      /* @__PURE__ */ r(Xe, { asChild: !0, children: /* @__PURE__ */ m(
        u ? Mt : Ze,
        {
          ref: t,
          size: "sm",
          className: O("richtext-w-[32px] richtext-h-[32px]", o),
          disabled: a,
          onClick: d,
      ...
      n && /* @__PURE__ */ r(He, { ...s, children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
        ...
        !!(c != null && c.length) && /* @__PURE__ */ r("span", { children: zt(c) })
      ] }) })
    ] });
  }
), mi = Ae.forwardRef(
  ({ asChild: e, ...t }, i) => {
    ...
    return /* @__PURE__ */ m(Je, { children: [
      ...
      /* @__PURE__ */ r(He, { children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
        ...
        /* @__PURE__ */ r("div", { className: "richtext-flex", children: !!((o = t == null ? void 0 : t.shortcutKeys) != null && o.length) && /* @__PURE__ */ r("span", { children: zt(t == null ? void 0 : t.shortcutKeys) }) })
      ] }) })
    ] });
  }
);
...
function ut(e, t, i, n) {
  ...
  return E(() => {
    const d = () => {
      ...
      const h = a(l);
      ri(s.current, h) || (c(h), s.current = h);
    };
...
const Lo = ai(
  ...
  ({ className: e, variant: t, size: i, asChild: n = !1, ...a }, o) => /* @__PURE__ */ r(
    n ? Mt : "button",
    {
      className: O(Lo({ variant: t, size: i, className: e })),
      ref: o,
      ...a
    }
  )
...
const pe = G.Root, we = G.Trigger, Li = G.Portal, Si = G.Sub, qt = D.forwardRef(({ className: e, inset: t, children: i, ...n }, a) => /* @__PURE__ */ m(
  G.SubTrigger,
  {
    ref: a,
    className: O(
    ...
    children: [
      i,
      /* @__PURE__ */ r(Zn, { className: "richtext-ml-auto richtext-h-4 richtext-w-4" })
    ]
  }
));
qt.displayName = G.SubTrigger.displayName;
const Kt = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  G.SubContent,
  {
    ref: i,
    className: O(
...
Kt.displayName = G.SubContent.displayName;
...
const ze = D.forwardRef(({ className: e, children: t, checked: i, ...n }, a) => /* @__PURE__ */ m(
  G.CheckboxItem,
  {
    ref: a,
    className: O(
    ...
    ...n,
    children: [
      /* @__PURE__ */ r("span", { className: "richtext-absolute richtext-left-2 richtext-flex richtext-h-3.5 richtext-w-3.5 richtext-items-center richtext-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(ei, { className: "richtext-h-4 richtext-w-4" }) }) }),
      t
    ]
  }
));
ze.displayName = G.CheckboxItem.displayName;
const So = D.forwardRef(({ className: e, children: t, ...i }, n) => /* @__PURE__ */ m(
  G.RadioItem,
  {
    ref: n,
    className: O(
    ...
    ...i,
    children: [
      /* @__PURE__ */ r("span", { className: "richtext-absolute richtext-left-2 richtext-flex richtext-h-3.5 richtext-w-3.5 richtext-items-center richtext-justify-center", children: /* @__PURE__ */ r(G.ItemIndicator, { children: /* @__PURE__ */ r(Jn, { className: "richtext-h-2 richtext-w-2 richtext-fill-current" }) }) }),
      t
    ]
  }
));
So.displayName = G.RadioItem.displayName;
const Mo = D.forwardRef(({ className: e, inset: t, ...i }, n) => /* @__PURE__ */ r(
  G.Label,
  {
    ref: n,
    className: O(
...
Mo.displayName = G.Label.displayName;
const Ht = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  G.Separator,
  {
    ref: i,
...
Ht.displayName = G.Separator.displayName;
function bn({
  className: e,
  ...t
}) {
...
const de = ct.Root, he = ct.Trigger, ae = D.forwardRef(({ className: e, align: t = "center", sideOffset: i = 4, ...n }, a) => /* @__PURE__ */ r(ct.Portal, { children: /* @__PURE__ */ r(
  ct.Content,
  {
    ref: a,
    align: t,
...
ae.displayName = ct.Content.displayName;
...
fi.displayName = Wt.Root.displayName;
const gi = Ie.Root, Et = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  Ie.List,
  {
    ref: i,
    className: O(
...
Et.displayName = Ie.List.displayName;
...
We.displayName = Ie.Trigger.displayName;
...
qe.displayName = Ie.Content.displayName;
const zo = ai(
...
), Ze = D.forwardRef(({ className: e, variant: t, size: i, ...n }, a) => /* @__PURE__ */ r(
  xn.Root,
  {
    ref: a,
    className: O(zo({ variant: t, size: i, className: e })),
    ...n
  }
));
Ze.displayName = xn.Root.displayName;
const Ho = dt.Provider, Je = dt.Root, Xe = dt.Trigger, He = D.forwardRef(({ className: e, sideOffset: t = 4, ...i }, n) => /* @__PURE__ */ r(
  dt.Content,
  {
    ref: n,
    sideOffset: t,
...
He.displayName = dt.Content.displayName;
const Eo = Z.Root, Ro = Z.Value, pn = D.forwardRef(({ className: e, children: t, ...i }, n) => /* @__PURE__ */ m(
  Z.Trigger,
  {
    ref: n,
    className: O(
...
const Oo = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  ...
  {
    ref: i,
    className: O("richtext-py-1.5 richtext-pl-8 richtext-pr-2 richtext-text-sm richtext-font-semibold", e),
    ...t
  }
));
Oo.displayName = Z.Label.displayName;
const Gt = D.forwardRef(({ className: e, children: t, ...i }, n) => /* @__PURE__ */ m(
  Z.Item,
  {
    ref: n,
    className: O(
    ...
    ...i,
    children: [
      /* @__PURE__ */ r("span", { className: "richtext-absolute richtext-left-2 richtext-flex richtext-h-3.5 richtext-w-3.5 richtext-items-center richtext-justify-center", children: /* @__PURE__ */ r(Z.ItemIndicator, { children: /* @__PURE__ */ r(ei, { className: "richtext-h-4 richtext-w-4" }) }) }),
      /* @__PURE__ */ r(Z.ItemText, { children: t })
    ]
  }
));
Gt.displayName = Z.Item.displayName;
const Po = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  Z.Separator,
  {
    ref: i,
    className: O("richtext--mx-1 richtext-my-1 richtext-h-px richtext-bg-muted", e),
...
Po.displayName = Z.Separator.displayName;
const yn = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  Ut.Root,
  {
    ...
    children: /* @__PURE__ */ r(
      Ut.Indicator,
      {
        className: O("!richtext-flex !richtext-p-0 !richtext-items-center !richtext-justify-center !richtext-text-current"),
        children: /* @__PURE__ */ r(ei, { className: "!richtext-h-4 !richtext-w-4" })
      }
    )
  }
));
yn.displayName = Ut.Root.displayName;
function Bo({ editor: e, ...t }) {
  const i = ut(e, je.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: n, defaultShowPicker: a } = i, [o, c] = p(""), [s, d] = p(!1), l = A(() => e.isActive(je.name), [e]), h = A(() => ht(je.name, e), [e]), u = A(() => {
  ...
  return /* @__PURE__ */ r(
    le,
    {
      ...
      children: t != null && t.disabled ? /* @__PURE__ */ r(K, {}) : /* @__PURE__ */ r("div", { className: "richtext-p-2 richtext-bg-white !richtext-border richtext-rounded-lg richtext-shadow-sm dark:richtext-bg-black richtext-border-neutral-200 dark:richtext-border-neutral-800", children: s ? /* @__PURE__ */ m(K, { children: [
        ...
        /* @__PURE__ */ r(_, { tooltip: "Edit", action: () => d(!s), children: /* @__PURE__ */ r(Yi, { size: 16 }) }),
        /* @__PURE__ */ r(_, { tooltip: "Delete", action: h, children: /* @__PURE__ */ r(Qi, { size: 16 }) })
      ] }) })
    }
  );
}
...
const Do = { padding: "0 12px 12px" }, kn = ({ width: e, maxWidth: t, height: i, onOk: n, children: a }) => {
  const { t: o } = F(), [c, s] = p({
    width: "",
    height: "",
    maxWidth: ""
  ...
  return /* @__PURE__ */ m(de, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r("div", { style: Do, children: /* @__PURE__ */ m("form", { className: "richtext-flex richtext-flex-col richtext-gap-2", onSubmit: d, children: [
...
}, jo = "_wrap_15k3c_1", Fo = "_renderWrap_15k3c_7", Vo = "_title_15k3c_14", Uo = "_icon_15k3c_20", Wo = "_handlerWrap_15k3c_30", et = {
  wrap: jo,
  renderWrap: Fo,
  title: Vo,
  icon: Uo,
...
const qo = (e) => typeof e == "number", Ko = (e) => typeof e == "string", Go = (e) => typeof e == "function";
function Zo(e, t = "px") {
  if (!e)
    return e;
...
const Jo = 10, Xo = 200, Mi = 15, Ii = { width: "100%", height: "100%", maxWidth: "100%" };
function Yo({ editor: e, node: t, updateAttributes: i }) {
  const n = X(null), a = e.isActive(Be.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [C, I] = p(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
  ...
  E(() => {
    ...
    return (async () => {
      if (N || h || f || !x || !o)
        return;
      const P = await n.current(o);
      N || (P.setAttribute("width", "100%"), P.setAttribute("height", "100%"), P.setAttribute("display", "block"), l(P));
    })(), () => {
      N = !0;
    };
  }, [o, h, f, x]);
  ...
  return /* @__PURE__ */ r(ce, { className: ee(et.wrap, a && et.isActive), children: /* @__PURE__ */ r(to, { onChange: v, children: /* @__PURE__ */ r(
    fn,
    {
      size: { width: Number.parseInt(c), height: Number.parseInt(s) },
      onResizeStop: (N, M, P, S) => {
        y({
      ...
      children: /* @__PURE__ */ m(
        "div",
        {
          className: ee(et.renderWrap, "render-wrapper"),
          ...
          children: [
            ...
            /* @__PURE__ */ r("div", { className: et.title }),
            /* @__PURE__ */ m("div", { className: et.handlerWrap, children: [
              /* @__PURE__ */ r(
                _,
                {
                  icon: "ZoomOut",
...
const Qo = Ae.memo(Yo, (e, t) => !!ri(e.node.attrs, t.node.attrs));
function ec(e, t = "{}") {
  try {
...
function ic(e) {
  ...
  return Object.keys(t).reduce((i, n) => {
    ...
    if (a == null)
      return i;
    let o = "";
    return typeof a == "object" ? o = tc(a) : o = a, i[n] = o, i;
  }, /* @__PURE__ */ Object.create(null));
}
const Ee = ne.Root, Re = ne.Trigger, nc = ne.Portal, Tn = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  ne.Overlay,
  {
    ref: i,
    className: O(
...
const _e = D.forwardRef(({ className: e, children: t, ...i }, n) => /* @__PURE__ */ m(nc, { children: [
  /* @__PURE__ */ r(Tn, {}),
  /* @__PURE__ */ m(
    ne.Content,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ m(ne.Close, { className: "richtext-absolute richtext-right-4 richtext-top-4 richtext-rounded-sm richtext-opacity-70 richtext-ring-offset-background richtext-transition-opacity hover:richtext-opacity-100 focus:richtext-outline-none focus:richtext-ring-2 focus:richtext-ring-ring focus:richtext-ring-offset-2 disabled:richtext-pointer-events-none data-[state=open]:richtext-bg-accent data-[state=open]:richtext-text-muted-foreground", children: [
          /* @__PURE__ */ r(Xn, { className: "richtext-h-4 richtext-w-4" }),
...
const rc = D.forwardRef(({ className: e, ...t }, i) => /* @__PURE__ */ r(
  ne.Description,
  {
    ref: i,
...
rc.displayName = ne.Description.displayName;
let Pt;
function xi() {
  try {
    return Pt || (Pt = $o()), Pt;
...
const Jt = "OPEN_EXCALIDRAW_SETTING_MODAL";
function ac(e, t) {
  xi().on(e, t);
}
function oc(e, t) {
...
const sc = ({ editor: e }) => {
  ...
  renderHTML({ HTMLAttributes: e, node: t }) {
    return ["div", re(this.options.HTMLAttributes, e, ic(t))];
  },
  addCommands() {
    return {
...
function dc({ editor: e }) {
  const { t } = F(), { width: i } = lc(e), n = ut(e, Be.name, {
    defaultShowPicker: !1,
    createUser: "",
    width: 0,
    height: 0
    ...
    (f) => {
      e.chain().updateAttributes(Be.name, f).setNodeSelection(e.state.selection.from).focus().run();
    },
    [e]
  ), l = A(() => {
    cc(n);
  }, [e, n]), h = A(() => e.isActive(Be.name), [e]), u = A(() => ht(Be.name, e), [e]);
  return E(() => {
    a && (l(), e.chain().updateAttributes(Be.name, { defaultShowPicker: !1 }).focus().run());
  }, [o, a, e, l]), /* @__PURE__ */ r(
    le,
    {
      ...
      children: /* @__PURE__ */ m("div", { className: "richtext-w-auto richtext-px-3 richtext-py-2 richtext-transition-all !richtext-border richtext-rounded-sm richtext-shadow-sm richtext-pointer-events-auto richtext-select-none richtext-border-neutral-200 dark:richtext-border-neutral-800 richtext-bg-background", children: [
        ...
        /* @__PURE__ */ r(kn, { width: c, maxWidth: i, height: s, onOk: d, children: /* @__PURE__ */ r(
          _,
          {
            icon: "Settings",
...
const hc = "_wrap_5y04w_1", uc = "_handlerWrap_5y04w_11", mc = "_innerWrap_5y04w_15", fc = "_emptyWrap_5y04w_23", Hi = {
  wrap: hc,
  handlerWrap: uc,
  innerWrap: mc,
  emptyWrap: fc
};
function gc({ editor: e, node: t, updateAttributes: i }) {
  const n = e.isEditable, { url: a, width: o, height: c } = t.attrs, [s, d] = p("");
  function l() {
...
function xc({ editor: e }) {
  ...
  const h = A(() => {
    ...
    [e]
  ), x = A(() => e.isActive($e.name) && !a, [e, a]), b = A(() => ht($e.name, e), [e]);
        ...
        children: [
          ...
          /* @__PURE__ */ m(_e, { children: [
            ...
            /* @__PURE__ */ m(Ye, { children: [
              ...
              /* @__PURE__ */ r(V, { onClick: h, children: "OK" })
            ] })
          ] })
        ]
      }
...
const Ei = `graph TB
a-->b`, yc = ({ editor: e, attrs: t, extension: i }) => {
  const { alt: n, align: a } = t, [o, c] = p(decodeURIComponent(n ?? Ei)), [s, d] = p(""), [l, h] = p(!1), u = X(null), f = i == null ? void 0 : i.options.upload, g = async (C) => {
    try {
...
function Nc({ item: e, disabled: t, editor: i }) {
  var a;
  const n = e.component;
  return n ? /* @__PURE__ */ r(lt, { children: e.type === "divider" ? /* @__PURE__ */ r(se, { orientation: "vertical", className: "!richtext-mx-1 !richtext-my-2 !richtext-h-[16px]" }) : /* @__PURE__ */ r(
    n,
    {
      ...e.componentProps,
      editor: i,
...
function Ac(e) {
  const { lang: t } = F(), i = ut(e.editor, Zi.name), n = kc(e.editor, Zi.name), a = ({ editor: c }) => {
...
function Lc({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    var o, c, s, d, l, h, u, f, g, x, b, C;
    return [
      ...
      n.includes("image") && !((d = i == null ? void 0 : i.imageConfig) != null && d.hidden) ? /* @__PURE__ */ r(Ss, { editor: e, disabled: t }, "image") : null,
      n.includes(qn.name) && !((l = i == null ? void 0 : i.imageGifConfig) != null && l.hidden) ? /* @__PURE__ */ r(Ms, { editor: e, disabled: t }, "imageGif") : null,
      n.includes("video") && !((h = i == null ? void 0 : i.videoConfig) != null && h.hidden) ? /* @__PURE__ */ r(Is, { editor: e, disabled: t }, "video") : null,
      n.includes("katex") && !((u = i == null ? void 0 : i.katexConfig) != null && u.hidden) ? /* @__PURE__ */ r(Bo, { editor: e, disabled: t }, "katex") : null,
      n.includes("excalidraw") && !((f = i == null ? void 0 : i.excalidrawConfig) != null && f.hidden) ? /* @__PURE__ */ r(dc, { editor: e, disabled: t }, "excalidraw") : null,
      n.includes("mermaid") && !((g = i == null ? void 0 : i.mermaidConfig) != null && g.hidden) ? /* @__PURE__ */ r(Ac, { editor: e, disabled: t }, "mermaid") : null,
      n.includes("iframe") && !((x = i == null ? void 0 : i.iframeConfig) != null && x.hidden) ? /* @__PURE__ */ r(xc, { editor: e, disabled: t }, "iframe") : null,
...
function Sn(e) {
  ...
  return /* @__PURE__ */ m(de, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(ae, { hideWhenDetached: !0, className: "richtext-w-full richtext-h-full richtext-p-2", align: "start", side: "bottom", children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col", children: [
      ...
      /* @__PURE__ */ r(Sc, { setColor: f })
    ] }) })
  ] });
}
function Sc({ setColor: e }) {
...
}, Oi = "data-rc-order", Pi = "data-rc-priority", Hc = "rc-util-key", Xt = /* @__PURE__ */ new Map();
function Ec(e, t) {
  if (!e)
    return !1;
  if (e.contains)
...
function zn(e) {
  return [...(Xt.get(e) || e).children].filter(
    (t) => t.tagName === "STYLE"
  );
}
function Hn(e, t = {}) {
  const { csp: i, prepend: n, priority: a = 0 } = t, o = Rc(n), c = o === "prependQueue", s = document.createElement("style");
  s.setAttribute(Oi, o), c && a && s.setAttribute(Pi, `${a}`), i != null && i.nonce && (s.nonce = i == null ? void 0 : i.nonce), s.innerHTML = e;
  const d = pi(t), { firstChild: l } = d;
  if (n) {
    if (c) {
      const h = zn(d).filter((u) => {
...
function $c(e, t) {
  ...
  At(t, () => ({
    ...
    document.documentElement.classList.toggle("dark", e.dark), zc.setTheme(e.dark ? "dark" : "light");
  }, [e.dark]), E(() => {
    s == null || s.setEditable(!(e != null && e.disabled));
  }, [s, e == null ? void 0 : e.disabled]), E(() => ((e == null ? void 0 : e.resetCSS) !== !1 && Bc(Mc, "react-tiptap-reset"), () => {
    Oc("react-tiptap-reset");
  ...
  }, []), Nn(s, "characterCount"), s ? /* @__PURE__ */ r("div", { className: "reactjs-tiptap-editor richtext-flex !richtext-bg-transparent richtext-w-full", children: /* @__PURE__ */ r(Ho, { delayDuration: 0, disableHoverableContent: !0, children: /* @__PURE__ */ r("div", { className: "rounded-lg richtext-bg-background richtext-shadow-lg richtext-overflow-hidden richtext-w-full", children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-w-full richtext-max-h-full", children: [
...
function ds(e) {
  ...
  return t.map((n, a) => ({
    ...
    componentProps: {
      tooltip: W.t(`editor.${n.replace("-", ".")}.tooltip`),
      icon: i[a],
      action: () => e.commands.updateVideo({ width: Vt[n] }),
      isActive: () => e.isActive("video", { width: Vt[n] })
    }
  }));
}
function hs(e) {
...
function bs(e, t, i, n) {
  ...
  if (!a || !o || !(o instanceof Se || o instanceof cn))
    return e;
  const { from: c, to: s } = o;
  return a.nodesBetween(c, s, (d, l) => {
    const h = d.type;
    return i.includes(h.name) ? (e = Yt(e, l, t), !1) : !ga(d.type.name, n.extensionManager.extensions);
  }), e;
}
function Yt(e, t, i) {
  if (!e.doc)
...
function ps(e) {
  var S, L, T;
  const { pluginKey: t = ro } = e, { t: i } = F(), [n, a] = p(null), [o, c] = p(-1), s = X(null), d = X(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((k) => k.name === "textAlign"), f = e.editor.extensionManager.extensions.some((k) => k.name === "indent"), g = e.editor.extensionManager.extensions.some((k) => k.name === "clear");
  E(() => {
    s.current && !e.editor.isDestroyed && (d.current = no({
      editor: e.editor,
      element: s.current,
  ...
  function v() {
    const k = Yt(e.editor.state.tr, o, 1);
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-gap-0.5 [transition-property:top,_left] richtext-ease-in-out richtext-duration-200", children: [
        ...
        /* @__PURE__ */ m(pe, { open: l, onOpenChange: P, children: [
          /* @__PURE__ */ m("div", { className: "richtext-relative richtext-flex richtext-flex-col", children: [
            /* @__PURE__ */ m(Je, { children: [
              /* @__PURE__ */ r(Xe, { asChild: !0, disabled: e == null ? void 0 : e.disabled, children: /* @__PURE__ */ r(
                V,
                {
                  variant: "ghost",
                  size: "icon",
          ...
          /* @__PURE__ */ m(be, { className: "richtext-w-48", align: "start", side: "bottom", sideOffset: 0, children: [
            ...
            u || f ? /* @__PURE__ */ r(Ht, {}) : null,
            u ? /* @__PURE__ */ m(Si, { children: [
              /* @__PURE__ */ m(qt, { className: "richtext-flex richtext-gap-3", children: [
                /* @__PURE__ */ r(j, { name: "AlignCenter" }),
                /* @__PURE__ */ r("span", { children: i("editor.textalign.tooltip") })
              ] }),
              /* @__PURE__ */ r(Li, { children: /* @__PURE__ */ m(Kt, { children: [
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    ...
    /* @__PURE__ */ r(
      Sn,
      {
        ...
        highlight: !0,
        disabled: e == null ? void 0 : e.disabled,
        children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", className: "!richtext-w-3 !richtext-h-[32px]", disabled: e == null ? void 0 : e.disabled, children: /* @__PURE__ */ r(j, { className: "!richtext-w-3 !richtext-h-3 richtext-text-zinc-500", name: "MenuDown" }) })
      }
    )
  ] });
}
function ks({ editor: e }) {
  var x, b, C, I, v, w, y, N, M, P, S, L, T, k, $, R, z, H;
  const t = ({ editor: q }) => xa(q.view.state, "table"), { t: i } = F();
  function n() {
      ...
      children: /* @__PURE__ */ m("div", { className: "richtext-min-w-32 richtext-flex richtext-flex-row richtext-h-full richtext-items-center richtext-leading-none richtext-gap-0.5 richtext-p-2 richtext-w-full richtext-bg-background richtext-rounded-lg richtext-shadow-sm !richtext-border richtext-border-border", children: [
        ...
        /* @__PURE__ */ r(
          _,
          {
            ...
            disabled: !((P = (M = e == null ? void 0 : e.can()) == null ? void 0 : M.addRowAfter) != null && P.call(M))
          }
        ),
        /* @__PURE__ */ r(
          _,
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-gap-2 richtext-p-2 richtext-bg-white !richtext-border richtext-rounded-lg richtext-shadow-sm dark:richtext-bg-black richtext-border-neutral-200 dark:richtext-border-neutral-800", children: [
    /* @__PURE__ */ r(
      "a",
      {
        ...
        children: ao(e == null ? void 0 : e.link, {
          length: 50,
          omission: "…"
        })
      }
...
function zs({ editor: e }) {
  const { t } = F(), i = A(() => e.isActive(st.name), [e]), n = A(() => ht(st.name, e), [e]), a = A(() => e.chain().focus().addColBefore().run(), [e]), o = A(() => e.chain().focus().addColAfter().run(), [e]), c = A(() => e.chain().focus().deleteCol().run(), [e]);
  return /* @__PURE__ */ r(
    le,
    {
...
let me, tt;
const Bt = /* @__PURE__ */ new Set(), $t = /* @__PURE__ */ new Set();
function Hs() {
  return me;
}
function Es(e) {
  if (!me && !tt) {
    ...
    return tt = so({ themes: t, langs: i }).then((n) => {
      me = n;
    }), tt;
  }
  if (tt)
...
async function Dn(e) {
  return me && !me.getLoadedThemes().includes(e) && !$t.has(e) && e in ln ? ($t.add(e), await me.loadTheme(e), $t.delete(e), !0) : !1;
}
async function jn(e) {
  return me && !me.getLoadedLanguages().includes(e) && !Bt.has(e) && e in dn ? (Bt.add(e), await me.loadLanguage(e), Bt.delete(e), !0) : !1;
}
async function Rs({
  doc: e,
  name: t,
  ...
  const a = rt(e, (s) => s.type.name === t), o = [
...
function $i({
  ...
  const a = [];
  return rt(e, (c) => c.type.name === t).forEach((c) => {
    let s = c.pos + 1, d = c.node.attrs.language || n;
    const l = c.node.attrs.theme || i, h = Hs();
    if (!h)
      return;
    ...
    for (const g of f) {
      for (const x of g) {
        const b = s + x.content.length, C = ot.inline(s, b, {
          style: `color: ${x.color}`
        });
        a.push(C), s = b;
      }
...
function Os({
  ...
  const n = new Ge({
      ...
      class o {
        ...
        async checkUndecoratedBlocks() {
          ...
          if ((await Promise.all(
            s.flatMap((h) => [
              Dn(h.node.attrs.theme),
              jn(h.node.attrs.language)
            ])
          )).includes(!0)) {
    ...
    state: {
      ...
      apply: (a, o, c, s) => {
        const d = c.selection.$head.parent.type.name, l = s.selection.$head.parent.type.name, h = rt(
          c.doc,
          (g) => g.type.name === e
        ), u = rt(
          s.doc,
...
function qs({ editor: e, node: { attrs: t }, updateAttributes: i, extension: n }) {
  ...
  }, [n.options.languages]), s = e.isEditable, d = (g = (f = e == null ? void 0 : e.options) == null ? void 0 : f.editorProps) == null ? void 0 : g.print, { language: l } = t, h = X(), u = A(() => ht(Ks.name, e), [e]);
  return /* @__PURE__ */ m(ce, { className: ee(Ce.wrap, !d && Ce.maxHeight, "render-wrapper"), children: [
    /* @__PURE__ */ m("div", { className: Ce.blockInfo, children: [
      /* @__PURE__ */ r(
        "span",
        {
          ...
          children: a ? /* @__PURE__ */ r(ra, { size: 16 }) : /* @__PURE__ */ r(tn, { size: 16 })
        }
      ),
      /* @__PURE__ */ r(
        "span",
      ...
      /* @__PURE__ */ r("div", { className: Ce.selectLang, children: /* @__PURE__ */ m(
        Eo,
        {
          ...
          children: [
            /* @__PURE__ */ r(pn, { children: /* @__PURE__ */ r(Ro, { placeholder: "Language" }) }),
            /* @__PURE__ */ m(vn, { className: "richtext-max-h-60 richtext-overflow-y-auto", children: [
              /* @__PURE__ */ r(Gt, { value: "auto", children: "Auto" }),
              c.map((x, b) => /* @__PURE__ */ r(Gt, { value: x, children: x.charAt(0).toUpperCase() + x.slice(1) }, `code-lang-${b}`))
            ] })
          ]
        }
      ) })
    ] }),
    /* @__PURE__ */ r("pre", { ref: h, children: /* @__PURE__ */ r(ya, { as: "code" }) })
  ] });
}
const Ks = ka.extend({
  addOptions() {
  ...
  return /* @__PURE__ */ m(pe, { children: [
    ...
    /* @__PURE__ */ r(be, { className: "richtext-w-full", children: (c = e == null ? void 0 : e.items) == null ? void 0 : c.map((s, d) => {
      ...
      return /* @__PURE__ */ m(lt, { children: [
        ...
        s.font === t("editor.fontFamily.default.tooltip") && /* @__PURE__ */ r(Ht, {})
      ] }, `font-family-${d}`);
    }) })
  ] });
}
  ...
  addOptions() {
    ...
    return {
      ...
      button({ editor: t, extension: i, t: n }) {
        var l;
        const { extensions: a = [] } = t.extensionManager ?? [], o = Zt(((l = i == null ? void 0 : i.options) == null ? void 0 : l.fontFamilyList) || []), c = a.find(
          (h) => h.name === "base-kit"
        ), s = o.map((h) => ({
          action: () => {
        ...
        /* @__PURE__ */ m(
          ze,
          {
            ...
            children: [
              ...
              !!((o = n == null ? void 0 : n.shortcutKeys) != null && o.length) && /* @__PURE__ */ r(bn, { className: "richtext-pl-4", children: (c = n == null ? void 0 : n.shortcutKeys) == null ? void 0 : c.map((s) => It(s)).join(" ") })
            ]
          }
        ),
        n.level === 0 && /* @__PURE__ */ r(Ht, {})
      ] }, `heading-k-${a}`);
    }) })
  ] });
}
        ...
        children: (i = e == null ? void 0 : e.items) == null ? void 0 : i.map((n, a) => {
          ...
          return /* @__PURE__ */ m(Je, { children: [
            ...
            /* @__PURE__ */ m(He, { className: "richtext-flex richtext-flex-col richtext-items-center", children: [
              ...
              !!((o = n.shortcutKeys) != null && o.length) && /* @__PURE__ */ r("span", { children: (c = n.shortcutKeys) == null ? void 0 : c.map((s) => It(s)).join(" ") })
            ] })
          ] }, `text-align-${a}`);
        })
      }
...
const Ih = J.create({
  ...
  addOptions() {
    ...
    return {
      ...
      button({ editor: t, extension: i, t: n }) {
        var d;
        const a = Zt(((d = i.options) == null ? void 0 : d.fontSizes) || Ai), o = Zt([Ai])[0], c = a.map((l) => ({
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    ...
    /* @__PURE__ */ r(
      Sn,
      {
        ...
        children: /* @__PURE__ */ r(V, { variant: "ghost", size: "icon", className: "r!ichtext-h-[32px] !richtext-w-3", disabled: e == null ? void 0 : e.disabled, children: /* @__PURE__ */ r(j, { className: "!richtext-w-3 !richtext-h-3 richtext-text-zinc-500", name: "MenuDown" }) })
      }
    )
  ] });
}
const zh = Aa.extend({
  ...
  addExtensions() {
    return [za.configure(this.options.taskItem)];
  }
}), Bh = Ha.extend({
  addOptions() {
    var e;
  ...
  addProseMirrorPlugins() {
    return [
      new Ge({
        props: {
          handleClick: (e, t) => {
            const { schema: i, doc: n, tr: a } = e.state, o = Ra(n.resolve(t), i.marks.link);
            if (!o)
              return !1;
...
function tl(e) {
  ...
  return /* @__PURE__ */ m(Je, { children: [
    ...
    i && /* @__PURE__ */ r(He, { ...a, children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-items-center richtext-text-center richtext-max-w-24", children: [
      ...
      !!((l = e == null ? void 0 : e.shortcutKeys) != null && l.length) && /* @__PURE__ */ r("span", { children: zt(e == null ? void 0 : e.shortcutKeys) })
    ] }) })
  ] });
}
const il = ["undo", "redo"], jh = Pa.extend({
  addOptions() {
    var e;
    return {
      ...(e = this.parent) == null ? void 0 : e.call(this),
...
function Dt({
  ...
  const n = yt((o) => o.type.name === st.name)(e.selection), a = yt((o) => o.type.name === vi.name)(e.selection);
  if (t && n && a) {
    ...
    const l = oo.fromJSON(e.schema, s);
    let h = n.pos;
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new Ge({
        ...
        props: {
          decorations(t) {
            return t.selection.empty || e.isFocused === !0 ? null : at.create(t.doc, [
              ot.inline(t.selection.from, t.selection.to, {
                class: "selection"
              })
            ]);
          }
...
const hl = J.create({
  ...
  addProseMirrorPlugins() {
    const e = new Me(this.name), t = Object.entries(this.editor.schema.nodes).map(([, i]) => i).filter((i) => this.options.notAfter.includes(i.name));
    return [
      new Ge({
        key: e,
  ...
  addExtensions() {
    ...
    return this.options.document !== !1 && e.push(nl.configure()), this.options.placeholder !== !1 && e.push(
      $a.configure({
        placeholder: ({ node: t, pos: i, editor: n }) => {
          var a, o, c, s, d;
          return ((a = t == null ? void 0 : t.type) == null ? void 0 : a.name) === "columns" || ((o = t == null ? void 0 : t.content) == null ? void 0 : o.size) !== 0 ? "" : ((c = t == null ? void 0 : t.type) == null ? void 0 : c.name) === "heading" ? `${W.t(`editor.heading.h${t.attrs.level}.tooltip`)}` : ((s = t == null ? void 0 : t.type) == null ? void 0 : s.name) === "codeBlock" || ((d = t == null ? void 0 : t.type) == null ? void 0 : d.name) === "table" ? "" : n.extensionManager.extensions.some((l) => l.name === "slashCommand") ? W.t("editor.slash") : i === 0 ? W.t("editor.content") : W.t("editor.content");
        },
    ...
    ), this.options.text !== !1 && e.push(ja.configure()), this.options.textBubble !== !1 && e.push(dl.configure()), this.options.gapcursor !== !1 && e.push(Fa.configure()), this.options.dropcursor !== !1 && e.push(
      Va.configure({
        ...this.options.dropcursor,
        width: 2,
        class: "ProseMirror-dropcursor border-black"
      })
    ), this.options.characterCount !== !1 && e.push(Ua.configure(this.options.characterCount)), this.options.paragraph !== !1 && e.push(Wa.configure(this.options.paragraph)), this.options.hardBreak !== !1 && e.push(qa.configure(this.options.hardBreak)), this.options.listItem !== !1 && e.push(Ka.configure(this.options.listItem)), this.options.textStyle !== !1 && e.push(Ga.configure(this.options.textStyle)), this.options.trailingNode !== !1 && e.push(hl.configure(this.options.trailingNode)), this.options.selection !== !1 && e.push(sl), this.options.multiColumn !== !1 && (e.push(vi), e.push(st)), e;
  }
}), Uh = J.create({
    ...
    /* @__PURE__ */ r(be, { className: "w-full", children: (i = e == null ? void 0 : e.items) == null ? void 0 : i.map((n, a) => /* @__PURE__ */ m(
      ze,
      {
        ...
        children: [
          ...
          !!(n != null && n.shortcutKeys) && /* @__PURE__ */ r("span", { className: "richtext-ml-auto richtext-text-xs richtext-tracking-widest richtext-opacity-60", children: zt(n.shortcutKeys) })
        ]
      },
      `more-mark-${a}`
    )) })
...
function xl(e, t) {
  ...
  if (!i || !n || !(i instanceof Se || i instanceof cn))
    return e;
  const { from: a, to: o } = i, c = [], s = t && t !== un ? t : null;
  if (n.nodesBetween(a, o, (d, l) => {
    const h = d.type;
    return gl.includes(h.name) ? ((d.attrs.lineHeight || null) !== s && c.push({
      node: d,
      pos: l,
      nodeType: h
...
function _l(e) {
  ...
  return e.forEach((i) => {
    i.name.toLowerCase() === "heading" && i.options.levels.forEach((n) => {
      ...
      shouldBeHidden: (n) => n.isActive("columns"),
      action: ({ editor: n, range: a }) => {
        n.chain().focus().deleteRange(a).run(), De.setOpen(!0);
      }
      ...
      shouldBeHidden: (n) => n.isActive("columns"),
      action: ({ editor: n, range: a }) => {
        n.chain().focus().deleteRange(a).run(), nt.setOpen(!0);
      }
...
function vl(e, t) {
  var C, I;
  const [i, n] = p(0), [a, o] = p(0), c = X(null), { t: s } = F(), d = X([]);
  At(t, () => ({
    onKeyDown: l
  })), E(() => {
    if (!c.current)
  ...
  return /* @__PURE__ */ r(
    "div",
    {
      ...
      ref: c,
      children: (C = e == null ? void 0 : e.items) != null && C.length ? /* @__PURE__ */ r("div", { className: "richtext-grid richtext-grid-cols-1 richtext-gap-0.5 richtext-min-w-48", children: (I = e == null ? void 0 : e.items) == null ? void 0 : I.map((v, w) => /* @__PURE__ */ m(lt, { children: [
        ...
        v.commands.map((y, N) => /* @__PURE__ */ m(
          "button",
          {
            ...
            children: [
              ...
              y.iconName && /* @__PURE__ */ r(j, { name: y.iconName, className: "!richtext-mr-1 !richtext-text-lg" }),
              y.label
            ]
          },
          `command-${N}`
...
function kl(e) {
  ...
  const [t, i] = p({
    ...
    h: 0,
    dir: ""
  }), { align: h, inline: u } = (P = e == null ? void 0 : e.node) == null ? void 0 : P.attrs, f = B(() => {
    var H;
  ...
  const v = A(
    Le((L) => {
      if (L.preventDefault(), L.stopPropagation(), !c)
        return;
      const { x: T, w: k, dir: $ } = d, R = (L.clientX - T) * (/l/.test($) ? -1 : 1), z = sn(k + R, ci, t.width);
      e.updateAttributes({
        width: z,
        height: null
      });
...
function Cl({ editor: e, imageInline: t, onClose: i }) {
  const { t: n } = F(), [a, o] = p(!1), c = Ae.useRef(null), [s, d] = Ae.useState(), [l, h] = Ae.useState(""), u = X(null), [f, g] = p({
    src: "",
    file: null
  });
  function x(w) {
  ...
  function b(w, y) {
    const N = document.createElement("canvas"), M = w.naturalWidth / w.width, P = w.naturalHeight / w.height;
    N.width = y.width * M, N.height = y.height * P;
  ...
  async function C() {
    ...
    try {
      ...
      let P = "";
      M.upload ? P = await M.upload(N) : P = URL.createObjectURL(N), e.chain().focus().setImageInline({ src: P, inline: t }).run(), o(!1), g({
        src: "",
        file: null
      }), i();
    } catch (N) {
  ...
  const v = async (w) => {
    var P;
    const y = (P = w == null ? void 0 : w.target) == null ? void 0 : P.files;
    if (!e || e.isDestroyed || y.length === 0)
      return;
    const N = y[0], M = await vc(N);
    o(!0), g({
      src: M.src,
      file: N
    });
...
function Nl(e) {
  const { t } = F(), i = pl(), [n, a] = p(""), o = X(null), [c, s] = p(!1);
  async function d(u) {
    var C, I;
    ...
    let b = "";
    x.upload ? b = await x.upload(g) : b = URL.createObjectURL(g), e.editor.chain().focus().setImageInline({ src: b, inline: c }).run(), De.setOpen(!1), s(!1);
  }
  function l(u) {
    u.preventDefault(), e.editor.chain().focus().setImageInline({ src: n, inline: c }).run(), De.setOpen(!1), s(!1);
  }
  function h(u) {
    var f;
    u.preventDefault(), (f = o.current) == null || f.click();
  }
  return /* @__PURE__ */ m(Ee, { open: i.isOpen, onOpenChange: De.setOpen, children: [
    /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(
      _,
      {
        icon: e.icon,
    ...
    /* @__PURE__ */ m(_e, { children: [
      ...
      /* @__PURE__ */ m(gi, { defaultValue: "upload", activationMode: "manual", children: [
        /* @__PURE__ */ m(Et, { className: "richtext-grid richtext-w-full richtext-grid-cols-2", children: [
        ...
        /* @__PURE__ */ m(qe, { value: "upload", children: [
          /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-gap-[10px]", children: [
            /* @__PURE__ */ r(V, { className: "richtext-w-full richtext-mt-1", size: "sm", onClick: h, children: t("editor.image.dialog.tab.upload") }),
            /* @__PURE__ */ r(
              Cl,
              {
                editor: e.editor,
                imageInline: c,
                onClose: () => De.setOpen(!1)
              }
            )
          ] }),
          /* @__PURE__ */ r(
...
function Tl(e) {
  ...
  return /* @__PURE__ */ m(Ee, { open: o.isOpen, onOpenChange: nt.setOpen, children: [
    /* @__PURE__ */ r(Re, { asChild: !0, children: /* @__PURE__ */ r(
      _,
      {
        icon: e.icon,
    ...
    /* @__PURE__ */ m(_e, { children: [
      ...
      /* @__PURE__ */ m(gi, { defaultValue: "upload", activationMode: "manual", children: [
        ...
        /* @__PURE__ */ m(qe, { value: "upload", children: [
          /* @__PURE__ */ r("div", { className: "richtext-flex richtext-items-center richtext-gap-[10px]", children: /* @__PURE__ */ r(V, { className: "richtext-w-full richtext-mt-1", size: "sm", onClick: d, children: t("editor.video.dialog.tab.upload") }) }),
          /* @__PURE__ */ r(
            "input",
            {
              type: "file",
...
function Sl(e, t, i) {
  ...
  return !n || !a || !(a instanceof co) || a.forEachCell((o, c) => {
    e = Ll(e, c, i);
  }), e;
}
function Fi(e, t) {
...
function El(e) {
  ...
  return /* @__PURE__ */ m(de, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(ae, { className: "richtext-w-full !richtext-p-2", align: "start", side: "bottom", children: /* @__PURE__ */ m("div", { className: "richtext-p-0 table-grid-size-editor", children: [
      /* @__PURE__ */ r("div", { className: "richtext-flex richtext-flex-col richtext-flex-wrap richtext-justify-between richtext-gap-1", children: (h = Ui(n == null ? void 0 : n.rows)) == null ? void 0 : h.map((u) => {
        var f;
...
const Xh = Za.extend({
  ...
  addExtensions() {
    return [
      Ja.configure(this.options.tableRow),
      Xa.configure(this.options.tableHeader),
      Ya.configure(this.options.tableCell),
...
function Ol({ editor: e, ...t }) {
  ...
  return E(() => {
    ...
    const C = () => {
      ...
      a((w) => w !== I ? I : w), c((w) => ri(w, v) ? w : v);
    };
    return window.addEventListener(Qt, C), () => {
      b && window.removeEventListener(Qt, C);
    };
  }, [u, e]), /* @__PURE__ */ m(
    de,
    {
          ...
          ae,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ m("div", { className: "richtext-flex richtext-w-full richtext-max-w-sm richtext-items-center richtext-gap-1.5 richtext-mb-[10px]", children: [
                ...
                /* @__PURE__ */ r(V, { disabled: !o.length, className: "richtext-flex-1", onClick: e.commands.goToPrevSearchResult, children: /* @__PURE__ */ r(j, { name: "ChevronUp" }) }),
                /* @__PURE__ */ r(V, { disabled: !o.length, className: "richtext-flex-1", onClick: e.commands.goToNextSearchResult, children: /* @__PURE__ */ r(j, { name: "ChevronDown" }) })
              ] }),
...
function Bl(e, t, i) {
  ...
  for (let s = 0; s < o.length; s += 1) {
    const d = o[s];
    n.push(ot.inline(d.from, d.to, { class: i }));
  }
  return {
...
const Qt = "ON_SEARCH_RESULTS", Oe = new CustomEvent(Qt), jl = J.create({
  name: "search",
  addOptions() {
    var e;
    return {
  ...
  addCommands() {
    return {
      setSearchTerm: (e) => ({ state: t, dispatch: i }) => (this.options.searchTerm = e, this.storage.results = [], this.storage.currentIndex = 0, window.dispatchEvent(Oe), it(t, i), !1),
      setReplaceTerm: (e) => ({ state: t, dispatch: i }) => (this.options.replaceTerm = e, it(t, i), !1),
      setCaseSensitive: (e) => ({ state: t, dispatch: i }) => (this.options.caseSensitive = e, it(t, i), !1),
      replace: () => ({ state: e, dispatch: t }) => {
        const { replaceTerm: i } = this.options, { currentIndex: n, results: a } = this.storage, o = a[n];
        return o ? (Wi(i, [o], { state: e, dispatch: t }), this.storage.results.splice(n, 1)) : (Wi(i, a, { state: e, dispatch: t }), this.storage.results.shift()), window.dispatchEvent(Oe), it(e, t), !1;
      },
      replaceAll: () => ({ state: e, tr: t, dispatch: i }) => {
        const { replaceTerm: n } = this.options, { results: a } = this.storage;
        return Dl(n, a, { tr: t, dispatch: i }), this.storage.currentIndex = -1, this.storage.results = [], window.dispatchEvent(Oe), it(e, i), !1;
      },
      goToPrevSearchResult: () => ({ view: e, tr: t }) => {
        ...
        return this.storage.currentIndex = o, window.dispatchEvent(Oe), qi({
          view: e,
          tr: t,
          searchResults: a,
      ...
      goToNextSearchResult: () => ({ view: e, tr: t }) => {
        ...
        return this.storage.currentIndex = o, this.options.onChange && this.options.onChange(), window.dispatchEvent(Oe), qi({
          view: e,
          tr: t,
          searchResults: a,
          searchResultCurrentClass: i,
      ...
      new Ge({
        ...
        state: {
          ...
          apply(t) {
            ...
            if (n || a) {
              const { decorationsToReturn: l, results: h } = Bl(
                i,
                Pl(a, s, d),
                o
              );
              if (e.storage.results = h, e.storage.currentIndex > h.length - 1 && (e.storage.currentIndex = 0), window.dispatchEvent(Oe), t.getMeta("directDecoration")) {
                ...
                l.push(ot.inline(u, f, g));
              } else
                h.length && (l[0] = ot.inline(h[0].from, h[0].to, {
                  class: c
                }));
              return at.create(i, l);
            }
            return at.empty;
          }
        },
...
const Un = Tt((e, t) => {
  ...
  return E(() => a(0), [e.items]), E(() => {
    ...
    h && hi(h, { behavior: "smooth", scrollMode: "if-needed" });
  }, [n]), At(t, () => ({
...
class cd {
  constructor(t) {
    ...
    ue(this, "tail");
    ue(this, "store");
    this.capacity = t || 20, this.usedCapacity = 0, this.store = {}, this.head = new jt("fakeHeadNode", "fakeHeadNode"), this.tail = new jt("fakeTailNode", "fakeTailNode"), this.head.next = this.tail, this.tail.prev = this.head;
  }
  removeNode(t) {
...
const Pe = sd("EMOJI_PICKER", 20), Ki = [
  {
...
function dd({ onSelectEmoji: e, children: t }) {
  const [i, n] = p([]), { t: a } = F(), o = B(
    () => i.length ? [{ title: "Frequently used", icon: aa, data: i }, ...Ki] : Ki,
    [i]
  ), c = A(
    (s) => {
  ...
  return E(() => {
    ...
    /* @__PURE__ */ r(ae, { hideWhenDetached: !0, className: "richtext-w-full richtext-h-full richtext-p-2", align: "start", side: "bottom", children: /* @__PURE__ */ m(gi, { defaultValue: "Frequently used", children: [
      /* @__PURE__ */ r(Et, { className: "richtext-flex richtext-items-center richtext-gap-[4px]", children: o.map((s) => /* @__PURE__ */ r(
        We,
        {
          value: s.title,
...
const ud = 200, md = new Me("emoji"), Qh = fe.create({
  name: "emoji",
  content: "text*",
  priority: ud,
  addOptions() {
  ...
  suggestion: {
    ...
    render: () => {
      ...
      return {
        onStart: (n) => {
          i = n.editor.isEditable, i && (e = new ii(Un, {
            props: n,
            editor: n.editor
          }), t = si("body", {
...
function fd({ editor: e, ...t }) {
  ...
  return /* @__PURE__ */ m(de, { modal: !0, children: [
    ...
    /* @__PURE__ */ m(ae, { hideWhenDetached: !0, className: "richtext-w-full richtext-h-full richtext-p-2", align: "start", side: "bottom", children: [
      ...
      /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-justify-between richtext-gap-[6px]", children: [
        /* @__PURE__ */ r(V, { onClick: d, className: "richtext-flex-1", children: "Submit" }),
        /* @__PURE__ */ r("a", { href: "https://katex.org/docs/supported", target: "_blank", rel: "noreferrer noopener", children: /* @__PURE__ */ r(Xi, { size: 16 }) })
      ] })
    ] })
  ] });
...
const je = fe.create({
  ...
  return /* @__PURE__ */ m(
    u ? Mt : Ze,
    {
      ...
      ...g,
      children: [
        n && /* @__PURE__ */ r("span", { className: "richtext-text-sm richtext-flex-none richtext-font-medium", children: n }),
        x && /* @__PURE__ */ r(x, { className: "richtext-w-4 richtext-h-4" }),
        h
      ]
    }
  ...
  async function d(u) {
    ...
    if (Nn(e.editor, "image")) {
      ...
      if (I && typeof I.upload == "function") {
        const v = [];
        for (const y of x) {
          const N = y.getAttribute("src"), M = _d(N, "image/jpeg"), P = vd(M, "image.jpeg");
          v.push(P);
        }
  ...
  addCommands() {
    return {
      exportToWord: () => async ({ editor: e }) => {
        ...
        return wo.toBlob(i).then(
          (n) => Cd(new Blob([n]), "export-document.docx")
        ), !0;
      }
    };
  }
...
function zd({ editor: e }) {
  const t = e.isEditable, [i, n] = p([]), { t: a } = F(), o = A(() => {
...
const nu = J.create({
  ...
  })), /* @__PURE__ */ r("div", { className: ee("listUsers", wt.listUsers), children: /* @__PURE__ */ r("div", { ref: i, children: e.items.length ? e.items.map((l, h) => /* @__PURE__ */ r(
    "span",
    {
      className: ee("itemUser", wt.itemUser, h === n ? wt.selectedUser : ""),
      onClick: () => o(h),
      children: l
    },
    h
...
const qd = "_wrap_gpqtf_1", Ft = {
  wrap: qd
};
function Kd({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var N;
  const o = X(), c = e.isEditable, { hasTrigger: s, fileName: d, fileSize: l, fileExt: h, fileType: u, url: f, error: g } = t.attrs, [x, b] = p(!1), { t: C } = F(), I = (N = a == null ? void 0 : a.options) == null ? void 0 : N.upload, v = A(() => {
  ...
  const y = A(() => n(), [e]);
  return c && !f ? /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ m("div", { className: ee(Ft.wrap, "render-wrapper"), children: [
  ...
  ] }) }) : f ? /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ m("div", { className: ee(Ft.wrap, "render-wrapper"), onClick: v, children: [
  ...
  ] }) }) : g !== "null" ? /* @__PURE__ */ r(ce, { children: /* @__PURE__ */ r("div", { className: ee(Ft.wrap, "render-wrapper"), onClick: v, children: /* @__PURE__ */ r("p", { children: g }) }) }) : /* @__PURE__ */ r(K, {});
}
const au = fe.create({
  name: "attachment",
  content: "",
...
function Gd(e) {
  ...
  const [t, i] = p({
    ...
    h: 0,
    dir: ""
  }), { align: h } = (M = e == null ? void 0 : e.node) == null ? void 0 : M.attrs, u = B(() => {
    var z;
  ...
  }, [(P = e == null ? void 0 : e.node) == null ? void 0 : P.attrs]), f = B(() => {
    const {
      style: { width: S }
    } = u;
  ...
  const I = A(
    Le((S) => {
      if (S.preventDefault(), S.stopPropagation(), !c)
        return;
      const { x: L, w: T, dir: k } = d, $ = (S.clientX - L) * (/l/.test(k) ? -1 : 1), R = sn(T + $, ci, t.width);
      e.updateAttributes({
        width: R,
        height: null
      });
  ...
  return E(() => (N.observe(e.editor.view.dom), () => {
    N.disconnect();
  }), [e.editor.view.dom, N]), /* @__PURE__ */ r(ce, { className: "image-view", style: { ...f, width: "100%", textAlign: h }, children: /* @__PURE__ */ m(
    "div",
    {
      draggable: "true",
      "data-drag-handle": !0,
...
function Zd({ selectImage: e, giphyApiKey: t, children: i }) {
  const [n, a] = p([]), [o] = p(15), c = X(null), s = (l, h = "search") => {
    if (!t)
      return;
...
a-->b`, Xd = ({ editor: e, upload: t }) => {
  const [i, n] = p(Gi), [a, o] = p(""), [c, s] = p(!1), d = X(null), l = async (f) => {
    try {
          ...
          /* @__PURE__ */ r(Ye, { children: /* @__PURE__ */ r(
            V,
            {
              ...
              onClick: async () => {
                if (i !== "") {
                  if (i) {
                    const f = d.current.querySelector("svg"), { width: g, height: x } = f.getBoundingClientRect(), b = `mermaid-${Ln()}.svg`;
  ...
  const N = A(
    Le((T) => {
      if (T.preventDefault(), T.stopPropagation(), !h)
        return;
      const { x: k, w: $, dir: R } = f, z = (T.clientX - k) * (/l/.test(R) ? -1 : 1), H = Cn($ + z, ci, o.width);
      i({
        width: H,
        height: null
      });
    ...
    (T) => {
      T.preventDefault(), T.stopPropagation(), h && (Ue(() => {
        g({
          x: 0,
          y: 0,
          w: 0,
  ...
  return E(() => (L.observe(e.view.dom), () => {
    ...
    "div",
    {
      ...
      children: [
        ...
        e.view.editable && (a || h) && /* @__PURE__ */ r("div", { className: "image-resizer", children: l == null ? void 0 : l.map((T) => /* @__PURE__ */ r(
          "span",
          {
