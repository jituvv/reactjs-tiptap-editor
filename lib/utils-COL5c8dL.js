...
import { u as F, C as so, E as lo, l as W, B as ho, I as Ct, V as Ft, M as uo, D as hn, a as mo, b as fo, c as Ai, d as un, e as go, f as Fe, g as Ve, h as oi, T as ft, i as gt, j as xt } from "./locales-DZ-ui9AU.js";
...
function dt(e, t, i, n) {
  ...
  return E(() => {
    const d = () => {
      ...
      const h = a(l);
      ni(s.current, h) || (c(h), s.current = h);
    };
...
function Po({ editor: e, ...t }) {
  const i = dt(e, De.name, {
    text: "",
    defaultShowPicker: !1
  }), { text: n, defaultShowPicker: a } = i, [o, c] = p(""), [s, d] = p(!1), l = A(() => e.isActive(De.name), [e]), h = A(() => lt(De.name, e), [e]), u = A(() => {
    e.chain().focus().setKatex({ text: o }).run(), d(!1);
  }, [e, o]);
  E(() => {
    a && (d(!0), e.chain().updateAttributes(De.name, { defaultShowPicker: !1 }).focus().run());
  }, [e, a, d]), E(() => {
    s && c(n || "");
  }, [s]);
  const f = B(() => {
...
const $o = { padding: "0 12px 12px" }, kn = ({ width: e, maxWidth: t, height: i, onOk: n, children: a }) => {
  ...
  return /* @__PURE__ */ m(de, { modal: !0, children: [
    ...
    /* @__PURE__ */ r(ae, { children: /* @__PURE__ */ r("div", { style: $o, children: /* @__PURE__ */ m("form", { className: "richtext-flex richtext-flex-col richtext-gap-2", onSubmit: d, children: [
...
function Xo({ editor: e, node: t, updateAttributes: i }) {
  const n = X(null), a = e.isActive(Pe.name), { data: o, width: c, height: s } = t.attrs, [d, l] = p(null), [h, u] = p(!0), [f, g] = p(null), [x, b] = p(!1), [C, I] = p(100), v = A(
    (N) => {
      N && b(!0);
    },
    [b]
...
function lc({ editor: e }) {
  const { t } = F(), { width: i } = sc(e), n = dt(e, Pe.name, {
    defaultShowPicker: !1,
    createUser: "",
    width: 0,
    height: 0
    ...
    oc(n);
  }, [e, n]), h = A(() => e.isActive(Pe.name), [e]), u = A(() => lt(Pe.name, e), [e]);
  return E(() => {
...
function Tc(e) {
  const { lang: t } = F(), i = dt(e.editor, Zi.name), n = yc(e.editor, Zi.name), a = ({ editor: c }) => {
  ...
  }, o = B(() => e.disabled ? [] : us(e.editor), [e.disabled, e.editor, t]);
...
function Ac({ editor: e, disabled: t, bubbleMenu: i }) {
  const n = e.extensionManager.extensions.map((o) => o.name), a = () => {
    ...
    return [
      n.includes("columns") && !((o = i == null ? void 0 : i.columnConfig) != null && o.hidden) ? /* @__PURE__ */ r(Is, { editor: e }, "columns") : null,
      n.includes("table") && !((c = i == null ? void 0 : i.tableConfig) != null && c.hidden) ? /* @__PURE__ */ r(ys, { editor: e }, "table") : null,
      n.includes("link") && !((s = i == null ? void 0 : i.linkConfig) != null && s.hidden) ? /* @__PURE__ */ r(Cs, { editor: e, disabled: t }, "link") : null,
      n.includes("image") && !((d = i == null ? void 0 : i.imageConfig) != null && d.hidden) ? /* @__PURE__ */ r(Ls, { editor: e, disabled: t }, "image") : null,
      n.includes(Wn.name) && !((l = i == null ? void 0 : i.imageGifConfig) != null && l.hidden) ? /* @__PURE__ */ r(Ss, { editor: e, disabled: t }, "imageGif") : null,
      n.includes("video") && !((h = i == null ? void 0 : i.videoConfig) != null && h.hidden) ? /* @__PURE__ */ r(Ms, { editor: e, disabled: t }, "video") : null,
      ...
      (b = i == null ? void 0 : i.floatingMenuConfig) != null && b.hidden ? null : /* @__PURE__ */ r(bs, { editor: e, disabled: t }, "content"),
      (C = i == null ? void 0 : i.textConfig) != null && C.hidden ? null : /* @__PURE__ */ r(_s, { editor: e, disabled: t }, "text")
    ];
  };
...
function Bc(e, t) {
  ...
  }, []), Nn(s, "characterCount"), s ? /* @__PURE__ */ r("div", { className: "reactjs-tiptap-editor flex bg-transparent", children: /* @__PURE__ */ r(zo, { delayDuration: 0, disableHoverableContent: !0, children: /* @__PURE__ */ r("div", { className: "rounded-lg richtext-bg-background shadow-lg richtext-overflow-hidden", children: /* @__PURE__ */ m("div", { className: "richtext-flex richtext-flex-col richtext-w-full richtext-max-h-full", children: [
    !(e != null && e.hideToolbar) && /* @__PURE__ */ r($c, { editor: s, disabled: !!(e != null && e.disabled) }),
    /* @__PURE__ */ r(
      ma,
      {
...
function xs(e, t, i, n) {
  ...
  return a.nodesBetween(c, s, (d, l) => {
    const h = d.type;
    return i.includes(h.name) ? (e = Xt(e, l, t), !1) : !fa(d.type.name, n.extensionManager.extensions);
  }), e;
}
function Xt(e, t, i) {
  if (!e.doc)
  ...
  if (!n)
    return e;
  const c = gs((n.attrs.indent || 0) + i, 0, 7);
  if (c === n.attrs.indent)
    return e;
  const s = {
    ...n.attrs,
...
function Bi({ delta: e, types: t }) {
  return ({ state: i, dispatch: n, editor: a }) => {
    const { selection: o } = i;
    let { tr: c } = i;
    return c = c.setSelection(o), c = xs(c, e, t, a), c.docChanged ? (n && n(c), !0) : !1;
  };
}
function bs(e) {
  var S, L, T;
  const { pluginKey: t = no } = e, { t: i } = F(), [n, a] = p(null), [o, c] = p(-1), s = X(null), d = X(null), [l, h] = p(!1), u = e.editor.extensionManager.extensions.some((k) => k.name === "textAlign"), f = e.editor.extensionManager.extensions.some((k) => k.name === "indent"), g = e.editor.extensionManager.extensions.some((k) => k.name === "clear");
  E(() => {
    s.current && !e.editor.isDestroyed && (d.current = io({
      editor: e.editor,
      element: s.current,
...
function ws({ item: e, disabled: t, editor: i }) {
  var a;
  const n = e.component;
  return n ? /* @__PURE__ */ r(
    n,
...
function _s(e) {
  const { t, lang: i } = F(), n = ({ editor: o }) => {
    ...
    return s.pos === d ? !1 : c instanceof Le;
  }, a = B(() => e.disabled || !(e != null && e.editor) ? [] : fs(e.editor, t), [e.disabled, e.editor, i, t]);
  return /* @__PURE__ */ r(le, { shouldShow: n, editor: e == null ? void 0 : e.editor, tippyOptions: ps, children: a != null && a.length ? /* @__PURE__ */ r("div", { className: "richtext-w-auto richtext-px-3 richtext-py-2 richtext-transition-all !richtext-border richtext-rounded-sm richtext-shadow-sm richtext-pointer-events-auto richtext-select-none richtext-border-neutral-200 dark:richtext-border-neutral-800 richtext-bg-background", children: /* @__PURE__ */ r("div", { className: "richtext-flex richtext-items-center richtext-gap-[4px] richtext-flex-nowrap richtext-whitespace-nowrap richtext-h-[26px] richtext-justify-start richtext-relative", children: a == null ? void 0 : a.map((o, c) => (o == null ? void 0 : o.type) === "divider" ? /* @__PURE__ */ r(
    se,
    {
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ r(
      _,
      {
        ...
        children: /* @__PURE__ */ r("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ r(vs, { fill: t }) })
      }
    ),
    /* @__PURE__ */ r(
      Sn,
...
function ys({ editor: e }) {
  ...
  const t = ({ editor: q }) => ga(q.view.state, "table"), { t: i } = F();
  function n() {
...
function Cs({ editor: e, disabled: t }) {
  const [i, n] = p(!1), a = B(() => {
...
function Ls(e) {
  ...
  }, n = B(() => e.disabled ? [] : ds(e.editor), [e.disabled, e.editor, t]);
  return /* @__PURE__ */ r(K, { children: /* @__PURE__ */ r(
    le,
    {
      shouldShow: i,
...
function Ms(e) {
  ...
  }, n = B(() => e.disabled ? [] : ms(e.editor), [e.editor, e.disabled, t]);
  return /* @__PURE__ */ r(K, { children: /* @__PURE__ */ r(
    le,
    {
      shouldShow: i,
...
function Is({ editor: e }) {
  const { t } = F(), i = A(() => e.isActive(ot.name), [e]), n = A(() => lt(ot.name, e), [e]), a = A(() => e.chain().focus().addColBefore().run(), [e]), o = A(() => e.chain().focus().addColAfter().run(), [e]), c = A(() => e.chain().focus().deleteCol().run(), [e]);
  return /* @__PURE__ */ r(
    le,
    {
...
function Rs({
  ...
  const n = new Ge({
    ...
    view(a) {
      class o {
        ...
        async initDecorations() {
          const s = a.state.doc;
          await Es({ doc: s, name: e, defaultLanguage: t, defaultTheme: i });
    ...
    state: {
      ...
      apply: (a, o, c, s) => {
        const d = c.selection.$head.parent.type.name, l = s.selection.$head.parent.type.name, h = it(
          c.doc,
          (g) => g.type.name === e
        ), u = it(
          s.doc,
...
const Ps = "_wrap_17npv_1", Bs = "_maxHeight_17npv_10", $s = "_btnCopy_17npv_13", Ds = "_btnDelete_17npv_14", js = "_blockInfo_17npv_18", Fs = "_selectLang_17npv_28", Vs = "_copied_17npv_54", Ce = {
  wrap: Ps,
  maxHeight: Bs,
  btnCopy: $s,
  btnDelete: Ds,
...
function Ws({ editor: e, node: { attrs: t }, updateAttributes: i, extension: n }) {
  var f, g;
  const { isCopied: a, copyToClipboard: o } = Us(), c = B(() => {
    var x;
    return (x = n.options.languages) != null && x.length ? n.options.languages : hn;
  }, [n.options.languages]), s = e.isEditable, d = (g = (f = e == null ? void 0 : e.options) == null ? void 0 : f.editorProps) == null ? void 0 : g.print, { language: l } = t, h = X(), u = A(() => lt(qs.name, e), [e]);
  return /* @__PURE__ */ m(ce, { className: ee(Ce.wrap, !d && Ce.maxHeight, "render-wrapper"), children: [
    ...
    /* @__PURE__ */ r("pre", { ref: h, children: /* @__PURE__ */ r(va, { as: "code" }) })
  ] });
}
const qs = ya.extend({
  addOptions() {
...
const Mh = J.create({
  ...
  addOptions() {
    ...
    return {
      ...
      button({ editor: t, extension: i, t: n }) {
        var d;
        const a = Gt(((d = i.options) == null ? void 0 : d.fontSizes) || Ai), o = Gt([Ai])[0], c = a.map((l) => ({
...
function Ys(e) {
  ...
  return /* @__PURE__ */ m("div", { className: "richtext-flex richtext-items-center richtext-h-[32px]", children: [
    /* @__PURE__ */ r(_, { tooltip: e == null ? void 0 : e.tooltip, disabled: e == null ? void 0 : e.disabled, action: a, children: /* @__PURE__ */ r("span", { className: "richtext-flex richtext-items-center richtext-justify-center richtext-text-sm", children: /* @__PURE__ */ r(Xs, { fill: t }) }) }),
    /* @__PURE__ */ r(
      Sn,
      {
        selectedColor: t,
      ...
      new Ge({
        props: {
          handleClick: (e, t) => {
            ...
            if (!o)
              return !1;
            const c = n.resolve(o.from), s = n.resolve(o.to), d = a.setSelection(new Le(c, s));
            e.dispatch(d);
          }
        }
      })
...
const tl = ["undo", "redo"], Dh = Oa.extend({
  addOptions() {
    var e;
    return {
      ...(e = this.parent) == null ? void 0 : e.call(this),
...
function al(e, t, i = null) {
  const n = rl(e), a = [];
  for (let o = 0; o < t; o += 1) {
    const c = nl(n.column, o, i);
    c && a.push(c);
  }
...
function Di({ state: e, dispatch: t, type: i }) {
  ...
  if (t && n && a) {
    ...
    return l.setSelection(Le.near(l.doc.resolve(d))), t(l), !0;
  }
  return !1;
}
const ol = 200, ot = fe.create({
  name: "columns",
  group: "block",
  defining: !0,
  isolating: !0,
  ...
  addCommands() {
    return {
      insertColumns: (e) => ({ tr: t, dispatch: i, editor: n }) => {
        const a = al(n.schema, e && e.cols || 3);
        if (i) {
...
const dl = J.create({
  ...
  addExtensions() {
    const e = [];
    return this.options.document !== !1 && e.push(il.configure()), this.options.placeholder !== !1 && e.push(
      Ba.configure({
    ...
    ), this.options.text !== !1 && e.push(Da.configure()), this.options.textBubble !== !1 && e.push(ll.configure()), this.options.gapcursor !== !1 && e.push(ja.configure()), this.options.dropcursor !== !1 && e.push(
      Fa.configure({
        ...this.options.dropcursor,
        width: 2,
        class: "ProseMirror-dropcursor border-black"
      })
    ), this.options.characterCount !== !1 && e.push(Va.configure(this.options.characterCount)), this.options.paragraph !== !1 && e.push(Ua.configure(this.options.paragraph)), this.options.hardBreak !== !1 && e.push(Wa.configure(this.options.hardBreak)), this.options.listItem !== !1 && e.push(qa.configure(this.options.listItem)), this.options.textStyle !== !1 && e.push(Ka.configure(this.options.textStyle)), this.options.trailingNode !== !1 && e.push(dl.configure(this.options.trailingNode)), this.options.selection !== !1 && e.push(cl), this.options.multiColumn !== !1 && (e.push(vi), e.push(ot)), e;
  }
}), Vh = J.create({
...
const fl = ["paragraph", "heading", "list_item", "todo_item"];
function gl(e, t) {
  ...
  if (n.nodesBetween(a, o, (d, l) => {
    const h = d.type;
    return fl.includes(h.name) ? ((d.attrs.lineHeight || null) !== s && c.push({
      node: d,
      pos: l,
      nodeType: h
...
function xl(e) {
  return ({ state: t, dispatch: i }) => {
    const { selection: n } = t;
    let { tr: a } = t;
    return a = a.setSelection(n), a = gl(a, e), a.docChanged ? (i && i(a), !0) : !1;
  };
}
const qh = J.create({
  name: "lineHeight",
...
const vl = Tt(_l), Ne = "slashCommand";
let U;
const Kh = J.create({
  name: Ne,
  priority: 200,
  ...
  addProseMirrorPlugins() {
    return [
      an({
        ...
        items: ({ query: e, editor: t }) => wl(t.extensionManager.extensions).map((c) => ({
          ...c,
  ...
  const v = A(
    Ae((L) => {
      if (L.preventDefault(), L.stopPropagation(), !c)
        return;
      const { x: T, w: k, dir: $ } = d, R = (L.clientX - T) * (/l/.test($) ? -1 : 1), z = sn(k + R, oi, t.width);
      e.updateAttributes({
        width: z,
        height: null
      });
...
function kl({ editor: e, imageInline: t, onClose: i }) {
  const { t: n } = F(), [a, o] = p(!1), c = je.useRef(null), [s, d] = je.useState(), [l, h] = je.useState(""), u = X(null), [f, g] = p({
    src: "",
    file: null
  });
  function x(w) {
...
function Cl(e) {
  const { t } = F(), i = bl(), [n, a] = p(""), o = X(null), [c, s] = p(!1);
  async function d(u) {
    var C, I;
...
function Fi(e, t) {
  return ({ tr: i, state: n, dispatch: a }) => {
    const { selection: o } = n;
    return i = i.setSelection(o), i = Ll(i, t, e), i.docChanged ? (a == null || a(i), !0) : !1;
  };
}
const Sl = J.create({
...
}), Ml = /(android|bb\d+|meego).+mobile|armv7l|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series[46]0|samsungbrowser.*mobile|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i, Il = /CrOS/, zl = /android|ipad|playbook|silk/i;
function Vi(e = {}) {
  let t = e.ua || typeof navigator < "u" && navigator.userAgent;
  return t && typeof t == "object" && t.headers && typeof t.headers["user-agent"] == "string" && (t = t.headers["user-agent"]), typeof t != "string" ? !1 : !!(Ml.test(t) && !Il.test(t) || e.tablet && zl.test(t) || e.tablet && e.featureDetect && navigator && navigator.maxTouchPoints > 1 && t.includes("Macintosh") && t.includes("Safari"));
}
...
function El(e) {
  ...
  return /* @__PURE__ */ r(Hl, { createTable: t, children: /* @__PURE__ */ r(
    _,
    {
      icon: e == null ? void 0 : e.icon,
      tooltip: e == null ? void 0 : e.tooltip,
...
const Jh = Ga.extend({
  ...
  addExtensions() {
    return [
      ...
      Sl.configure(this.options.tableCellBackground)
    ];
  }
}), Xh = J.create({
  name: "painter",
...
function Rl({ editor: e, ...t }) {
  ...
  return E(() => {
    ...
    if (!e)
      return;
    const b = e.extensionManager.extensions.find((I) => I.name === Dl.name);
    if (!b)
      return;
    const C = () => {
      if (!u)
...
function Pl(e, t, i) {
  ...
  for (let s = 0; s < o.length; s += 1) {
    const d = o[s];
    n.push(rt.inline(d.from, d.to, { class: i }));
  }
  return {
...
function $l(e, t, { tr: i, dispatch: n }) {
  let a = 0, o = t.slice();
  if (!o.length)
    return !1;
...
const Yt = "ON_SEARCH_RESULTS", Re = new CustomEvent(Yt), Dl = J.create({
  name: "search",
  addOptions() {
    var e;
    return {
  ...
  addCommands() {
    return {
      ...
      replaceAll: () => ({ state: e, tr: t, dispatch: i }) => {
        ...
        return $l(n, a, { tr: t, dispatch: i }), this.storage.currentIndex = -1, this.storage.results = [], window.dispatchEvent(Re), et(e, i), !1;
      },
      ...
      new Ge({
        ...
        state: {
          ...
          apply(t) {
            ...
            if (n || a) {
              const { decorationsToReturn: l, results: h } = Pl(
                i,
                Ol(a, s, d),
                o
              );
              if (e.storage.results = h, e.storage.currentIndex > h.length - 1 && (e.storage.currentIndex = 0), window.dispatchEvent(Re), t.getMeta("directDecoration")) {
                ...
                h.length && (l[0] = rt.inline(h[0].from, h[0].to, {
                  class: c
                }));
...
const jl = Object.keys(Ke).map((e) => e);
Object.keys(Ke).map((e) => Ke[e]);
function Fl(e) {
  return jl.filter((t) => t.startsWith(e)).map((t) => ({
    name: t,
    emoji: Ke[t]
  }));
}
...
const Oe = cd("EMOJI_PICKER", 20), Ki = [
  {
...
function ld({ onSelectEmoji: e, children: t }) {
...
function dd({ editor: e, icon: t, ...i }) {
  ...
  return /* @__PURE__ */ r(ld, { onSelectEmoji: n, children: /* @__PURE__ */ r(
    _,
    {
      tooltip: i == null ? void 0 : i.tooltip,
      icon: t
...
const hd = 200, ud = new Se("emoji"), Yh = fe.create({
  name: "emoji",
  content: "text*",
  priority: hd,
  addOptions() {
  ...
  async function d(u) {
    ...
    if (Nn(e.editor, "image")) {
      ...
      if (I && typeof I.upload == "function") {
        const v = [];
        for (const y of x) {
          const N = y.getAttribute("src"), M = wd(N, "image/jpeg"), O = _d(M, "image.jpeg");
          v.push(O);
        }
  ...
  addCommands() {
    return {
      exportToWord: () => async ({ editor: e }) => {
        ...
        }, i = Nd.serialize(e.state.doc, t);
        return _o.toBlob(i).then((n) => kd(new Blob([n]), "export-document.docx")), !0;
      }
    };
  }
}), Td = "_toc_aag8a_1", Ad = "_visible_aag8a_7", Ld = "_list_aag8a_11", Sd = "_item_aag8a_16", pt = {
  toc: Td,
  visible: Ad,
  list: Ld,
  item: Sd,
...
function Id({ editor: e }) {
  const t = e.isEditable, [i, n] = p([]), { t: a } = F(), o = A(() => {
    ...
    }), s.setMeta("addToHistory", !1), s.setMeta("preventUpdate", !0), e.view.dispatch(s), n(c), e.eventEmitter && e.eventEmitter.emit("TableOfContents", Md(c));
  }, [e]);
  return E(() => {
    if (e) {
...
function Rd({ editor: e, icon: t, tooltip: i }) {
  const n = Ed(e, Od.name), a = A(() => {
    if (n) {
...
const iu = J.create({
...
}), Bd = "_listUsers_en3pm_1", $d = "_itemUser_en3pm_10", Dd = "_selectedUser_en3pm_31", wt = {
  listUsers: Bd,
  itemUser: $d,
  selectedUser: Dd
}, jd = Tt((e, t) => {
  ...
  items: async ({ query: e }) => Fd.map((i) => i.name).filter((i) => i.toLowerCase().startsWith(e.toLowerCase())),
  render: () => {
    let e, t;
    return {
      onStart: (i) => {
...
const Wd = "_wrap_gpqtf_1", jt = {
  wrap: Wd
};
function qd({ editor: e, node: t, updateAttributes: i, deleteNode: n, extension: a }) {
  var N;
  ...
  const I = A(
    Ae((S) => {
      if (S.preventDefault(), S.stopPropagation(), !c)
        return;
      const { x: L, w: T, dir: k } = d, $ = (S.clientX - L) * (/l/.test(k) ? -1 : 1), R = sn(T + $, oi, t.width);
      e.updateAttributes({
        width: R,
        height: null
      });
...
function Gd({ selectImage: e, giphyApiKey: t, children: i }) {
...
function Zd({ editor: e, icon: t, giphyApiKey: i, ...n }) {
  return /* @__PURE__ */ r(
    Gd,
    {
      selectImage: (o) => {
...
function Xd({ editor: e, node: t, updateAttributes: i, getPos: n, selected: a }) {
  const [o, c] = p({
    width: Fe,
    height: Fe
  }), [s, d] = p({
