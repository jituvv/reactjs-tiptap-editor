...
var p = (e, t, o) => t in e ? n(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : e[t] = o;
var r = (e, t, o) => p(e, typeof t != "symbol" ? t + "" : t, o);
import { useMemo as s } from "react";
import { proxy as g, useSnapshot as m } from "valtio";
import { m as u } from "./utils-BvFIvTrz.js";
const c = "en", h = 200, v = h - 80, E = 10, y = 10, L = 2, S = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
  ...
  "48px",
  "72px"
], R = "default", w = ["100%", "115%", "150%", "200%", "250%", "300%"], P = "1", U = [
  "bold",
  "italic",
  "underline",
  "strike",
  ...
  "editor.exportPdf.tooltip": "Export to PDF",
  "editor.exportWord.tooltip": "Export to Word",
...
function N() {
  const e = m(a), t = s(() => d.buildLocalesHandler(e.lang), [e.lang]);
  return {
    lang: e.lang,
    t
  };
...
const M = {
  t: (e) => d.buildLocalesHandler(a.lang)(e)
};
export {
  U as B,
  S as C,
