...
import { m as h } from "./utils-BpaWZ_gm.js";
const b = {
  ...
  "editor.mermaid.tooltip": "Mermaid"
}, T = "en", F = 200, y = F - 80, S = 20, I = 1e5, B = 16, R = 10, w = 10, z = 2, P = [
  "#000000",
  "#262626",
  "#595959",
  "#8C8C8C",
...
var _ = /* @__PURE__ */ ((e) => (e[e["size-small"] = 200] = "size-small", e[e["size-medium"] = 500] = "size-medium", e["size-large"] = "100%", e))(_ || {}), x = /* @__PURE__ */ ((e) => (e[e["size-small"] = 480] = "size-small", e[e["size-medium"] = 640] = "size-medium", e["size-large"] = "100%", e))(x || {});
const q = ["100%", "115%", "150%", "200%", "250%", "300%"], G = "1", O = [
  "bold",
  "italic",
  "underline",
  "strike",
