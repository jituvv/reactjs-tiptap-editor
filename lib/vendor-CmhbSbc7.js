...
var Yy = (n, e, t) => e in n ? qy(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var fi = (n, e, t) => Yy(n, typeof e != "symbol" ? e + "" : e, t);
import Xy from "tippy.js";
function Z(n) {
  this.content = n;
}
Z.prototype = {
...
function Fd(n, e, t) {
  for (let r = 0; ; r++) {
    ...
    if (i.content.size || o.content.size) {
      let s = Fd(i.content, o.content, t + 1);
      if (s != null)
        return s;
    }
    t += i.nodeSize;
...
class S {
  ...
  */
  insertAt(e, t) {
    let r = Wd(this.content, e + this.openStart, t);
  ...
  */
  removeBetween(e, t) {
    return new S(Vd(this.content, e + this.openStart, t + this.openStart), this.openStart, this.openEnd);
  }
  /**
...
function Ud(n, e, t, r) {
  ...
  if (i == e.index(r) && r < n.depth - t.openStart) {
    ...
    if (!t.openStart && !t.openEnd && n.depth == r && e.depth == r) {
      ...
      let { start: s, end: l } = Zy(t, n);
      return sn(o, Jd(n, s, l, e, r));
    }
  else return sn(o, Zi(n, e, r));
}
function Hd(n, e) {
...
function Jd(n, e, t, r, i) {
  ...
  return vr(null, n, i, l), o && s && e.index(i) == t.index(i) ? (Hd(o, s), on(sn(o, Jd(n, e, t, r, i + 1)), l)) : (o && on(sn(o, Zi(n, e, i + 1)), l), vr(e, t, i, l), s && on(sn(s, Zi(t, r, i + 1)), l)), vr(r, null, i, l), new b(l);
}
function Zi(n, e, t) {
  let r = [];
  if (vr(null, n, t, r), n.depth > t) {
    let i = Dl(n, e, t + 1);
    on(sn(i, Zi(n, e, t + 1)), r);
  }
...
const t0 = 12, ef = /* @__PURE__ */ new WeakMap();
class Pr {
  /**
...
const n0 = /* @__PURE__ */ Object.create(null);
class Ge {
  /**
  @internal
  */
  ...
  */
  hasMarkup(e, t, r) {
    return this.type == e && Xi(this.attrs, t || e.defaultAttrs || n0) && _.sameSet(this.marks, r || _.none);
  }
  /**
  ...
  */
  toString() {
    ...
    return this.content.size && (e += "(" + this.content.toStringInner() + ")"), Gd(this.marks, e);
  }
  /**
...
class eo extends Ge {
  ...
  */
  ...
  toString() {
    return this.type.spec.toDebugString ? this.type.spec.toDebugString(this) : Gd(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
  ...
  mark(e) {
    return e == this.marks ? this : new eo(this.type, this.attrs, this.text, e);
  }
  withText(e) {
    return e == this.text ? this : new eo(this.type, this.attrs, e, this.marks);
  }
...
function a0(n) {
  if (n.eat("(")) {
    ...
    let e = l0(n, n.next).map((t) => (n.inline == null ? n.inline = t.isInline : n.inline != t.isInline && n.err("Mixing inline and block content"), { type: "name", value: t }));
...
let rf = class ep {
  ...
  */
  constructor(e, t, r) {
    this.name = e, this.schema = t, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Zd(e, r.attrs), this.defaultAttrs = Yd(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  static compile(e, t) {
    ...
    e.forEach((o, s) => r[o] = new ep(o, t, s));
...
class d0 {
  constructor(e, t, r) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default"), this.default = r.default, this.validate = typeof r.validate == "string" ? h0(e, t, r.validate) : r.validate;
  }
  get isRequired() {
...
class us {
  ...
  */
  constructor(e, t, r, i) {
    this.name = e, this.rank = t, this.schema = r, this.spec = i, this.attrs = Zd(e, i.attrs), this.excluded = null;
    let o = Yd(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new _(this, Xd(this.attrs, e));
  }
  /**
  @internal
  */
  static compile(e, t) {
    ...
    return e.forEach((o, s) => r[o] = new us(o, i++, t, s)), r;
  }
  /**
...
class iR {
  ...
  */
  constructor(e) {
    ...
    for (let i in e)
      t[i] = e[i];
    t.nodes = Z.from(e.nodes), t.marks = Z.from(e.marks || {}), this.nodes = rf.compile(this.spec.nodes, this), this.marks = us.compile(this.spec.marks, this);
    let r = /* @__PURE__ */ Object.create(null);
  ...
  */
  text(e, t) {
    ...
    return new eo(r, r.defaultAttrs, e, _.setFrom(t));
  }
  /**
  ...
  */
  matchTag(e, t, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (b0(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || t.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
const np = {
  ...
  style: !0,
  title: !0
}, rp = { ol: !0, ul: !0 }, to = 1, no = 2, xr = 4;
function sf(n, e, t) {
  return e != null ? (e ? to : 0) | (e === "full" ? no : 0) : n && n.whitespace == "pre" ? to | no : t & ~xr;
}
class hi {
...
class lf {
  ...
  addTextNode(e, t) {
    ...
    if (i.options & no || i.inlineContext(e) || /[^ \t\r\n\u000c]/.test(r)) {
      if (i.options & to)
        i.options & no ? r = r.replace(/\r\n?/g, `
`) : r = r.replace(/\r?\n|\r/g, " ");
...
function y0(n) {
  for (let e = n.firstChild, t = null; e; e = e.nextSibling) {
    ...
    r && rp.hasOwnProperty(r) && t ? (t.appendChild(e), e = t) : r == "li" ? t = e : r && (t = null);
  }
}
function b0(n, e) {
...
class er {
  ...
  */
  serializeNodeInner(e, t) {
    let { dom: r, contentDOM: i } = Ii(Is(t), this.nodes[e.type.name](e), null, e.attrs);
    if (i) {
      if (e.isLeaf)
  ...
  */
  serializeMark(e, t, r = {}) {
    ...
    return i && Ii(Is(r), i(e, t), null, e.attrs);
  }
...
function w0(n) {
  let e = uf.get(n);
  return e === void 0 && uf.set(n, e = S0(n)), e;
}
function S0(n) {
  let e = null;
  function t(r) {
...
const ip = 65535, op = Math.pow(2, 16);
function v0(n, e) {
  return n + e * op;
}
function hf(n) {
  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        if (r)
          return d;
        let p = e == (t < 0 ? a : u) ? null : v0(l / 3, e - a), g = e == a ? lp : e == u ? sp : Ri;
        return (t < 0 ? e != a : e != u) && (g |= ap), new Pl(d, g, p);
      }
      i += f - c;
    }
...
function ni(n) {
  ...
  for (let r = n.depth; ; --r) {
    ...
    if (r < n.depth && i.canReplace(o, s, t))
      return r;
    if (r == 0 || i.type.spec.isolating || !E0(i, o, s))
      break;
  }
  return null;
}
...
function cp(n, e, t = null, r = n) {
  let i = O0(n, e), o = i && T0(r, e);
...
function N0(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && I0(n.doc, n.mapping.slice(o).map(l), r)) {
      let c = null;
      if (r.schema.linebreakReplacement) {
        let d = r.whitespace == "pre", p = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        d && !p ? c = !1 : !d && p && (c = !0);
      }
      c === !1 && up(n, s, l, o), Ja(n, n.mapping.slice(o).map(l, 1), r, void 0, c === null);
      let f = n.mapping.slice(o), u = f.map(l, 1), h = f.map(l + s.nodeSize, 1);
      return n.step(new re(u, h, u + 1, h - 1, new S(b.from(r.create(a, null, s.marks)), 0, 0), 1, !0)), c === !0 && fp(n, s, l, o), !1;
    }
  });
}
function fp(n, e, t, r) {
...
function ri(n, e) {
  ...
  return dp(t.nodeBefore, t.nodeAfter) && t.parent.canReplace(r, r + 1);
}
function $0(n, e) {
...
function dp(n, e) {
  return !!(n && e && !n.isLeaf && $0(n, e));
}
function pp(n, e, t = -1) {
  let r = n.resolve(e);
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : t > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && dp(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function P0(n, e, t) {
  ...
  if (n.step(new ee(c, a.map(e + t, -1), S.empty, !0)), r === !0) {
    ...
    fp(n, f.node(), f.before(), n.steps.length);
  }
  return n;
}
function _0(n, e, t) {
...
function hs(n, e, t = e, r = S.empty) {
  if (e == t && !r.size)
    return null;
  let i = n.resolve(e), o = n.resolve(t);
  return mp(i, o, r) ? new ee(e, t, r) : new L0(i, o, r).fit();
}
function mp(n, e, t) {
...
class L0 {
  ...
  placeNodes({ sliceDepth: e, frontierDepth: t, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!m)
        break;
      c++, (c > 1 || a == 0 || g.content.size) && (u = m, f.push(yp(g.mark(h.allowedMarks(g.marks)), c == 1 ? a : 0, c == l.childCount ? d : -1)));
    }
  ...
  mustMoveInline() {
    ...
    if (!e.type.isTextblock || !$s(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: r, type: i } = this.frontier[t], o = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), s = $s(e, t, i, r, o);
      if (s) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], f = $s(e, l, c, a, !0);
          if (!f || f.childCount)
            continue e;
        }
...
function yp(n, e, t) {
  if (e <= 0)
    return n;
  let r = n.content;
  return e > 1 && (r = r.replaceChild(0, yp(r.firstChild, e - 1, r.childCount == 1 ? t - 1 : 0))), e > 0 && (r = n.type.contentMatch.fillBefore(r).append(r), t <= 0 && (r = r.append(n.type.contentMatch.matchFragment(r).fillBefore(b.empty, !0)))), n.copy(r);
}
function $s(n, e, t, r, i) {
  ...
  return l && !B0(t, o.content, s) ? l : null;
}
function B0(n, e, t) {
    ...
    if (p)
      for (let g = 0; g < s.length; g++) {
        ...
        if (v.canReplaceWith(k, k, p.type, p.marks))
          return n.replace(i.before(m), y ? o.after(m) : t, new S(bp(r.content, 0, r.openStart, d), d, r.openEnd));
      }
  }
...
function bp(n, e, t, r, i) {
  if (e < t) {
    let o = n.firstChild;
    n = n.replaceChild(0, o.copy(bp(o.content, e + 1, t, r, o)));
  }
  if (e > r) {
...
function j0(n, e, t, r) {
  if (!r.isInline && e == t && n.doc.resolve(e).parent.content.size) {
    let i = _0(n.doc, e, r.type);
    i != null && (e = t = i);
  }
  n.replaceRange(e, t, new S(b.from(r), 0, 0));
}
function V0(n, e, t) {
  let r = n.doc.resolve(e), i = n.doc.resolve(t), o = wp(r, i);
  for (let s = 0; s < o.length; s++) {
...
class _s {
  constructor(e, t) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = H0.slice(), t && t.forEach((r) => {
...
class Sr {
  ...
  */
  static create(e) {
    let t = new _s(e.doc ? e.doc.type.schema : e.schema, e.plugins), r = new Sr(t);
  ...
  */
  reconfigure(e) {
    let t = new _s(this.schema, e.plugins), r = t.fields, i = new Sr(t);
    for (let o = 0; o < r.length; o++) {
      let s = r[o].name;
  ...
  */
  static fromJSON(e, t, r) {
    ...
    let i = new _s(e.schema, e.plugins), o = new Sr(i);
...
function vp(n, e, t) {
  for (let r in n) {
    let i = n[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = vp(i, e, {})), t[r] = i;
  }
  return t;
}
class bn {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && vp(e.props, this, this.props), this.key = e.key ? e.key.key : xp("plugin");
  }
  /**
...
function Sf(n, e, t, r, i) {
  for (; ; ) {
    ...
    if (e == (i < 0 ? 0 : Me(n))) {
      let o = n.parentNode;
      if (!o || o.nodeType != 1 || ii(n) || G0.test(n.nodeName) || n.contentEditable == "false")
        return !1;
      e = te(n) + (i < 0 ? 0 : 1), n = o;
...
const Ye = typeof navigator < "u" ? navigator : null, vf = typeof document < "u" ? document : null, Yt = Ye && Ye.userAgent || "", Bl = /Edge\/(\d+)/.exec(Yt), Cp = /MSIE \d/.exec(Yt), zl = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Yt), be = !!(Cp || zl || Bl), Vt = Cp ? document.documentMode : zl ? +zl[1] : Bl ? +Bl[1] : 0, Le = !be && /gecko\/(\d+)/i.test(Yt);
Le && +(/Firefox\/(\d+)/.exec(Yt) || [0, 0])[1];
const Fl = !be && /Chrome\/(\d+)/.exec(Yt), se = !!Fl, kp = Fl ? +Fl[1] : 0, he = !be && !!Ye && /Apple Computer/.test(Ye.vendor), Wn = he && (/Mobile\/\w+/.test(Yt) || !!Ye && Ye.maxTouchPoints > 2), Te = Wn || (Ye ? /Mac/.test(Ye.platform) : !1), Z0 = Ye ? /Win/.test(Ye.platform) : !1, De = /Android \d/.test(Yt), oi = !!vf && "webkitFontSmoothing" in vf.documentElement.style, eb = oi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function tb(n) {
...
function xf(n, e, t) {
  ...
  for (let s = t || n.dom; s; s = Lr(s)) {
    if (s.nodeType != 1)
      continue;
    let l = s, a = l == o.body, c = a ? tb(o) : nb(l), f = 0, u = 0;
...
function rb(n) {
  ...
  return { refDOM: r, refTop: i, stack: Ep(n.dom) };
}
function Ep(n) {
...
function ib({ refDOM: n, refTop: e, stack: t }) {
...
function Op(n, e) {
  ...
  return !t && a && (t = a, i = c, r = 0), t && t.nodeType == 3 ? sb(t, i) : !t || r && t.nodeType == 1 ? { node: n, offset: o } : Op(t, i);
}
function sb(n, e) {
...
function ab(n, e, t) {
  let { node: r, offset: i } = Op(e, t), o = -1;
...
function fb(n, e) {
  let t = n.dom.ownerDocument, r, i = 0, o = Q0(t, e.left, e.top);
  o && ({ node: r, offset: i } = o);
  ...
  if (s = lb(s, e), r) {
    ...
    let c;
    oi && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == n.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = n.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = cb(n, r, i, e));
  }
  l == null && (l = ab(n, s, e));
...
function Mp(n, e, t) {
  ...
  if (r.nodeType == 3)
    if (s && (ub.test(r.nodeValue) || (t < 0 ? !i : i == r.nodeValue.length))) {
      let a = Ot(pt(r, i, i), t);
  ...
  if (!n.state.doc.resolve(e - (o || 0)).parent.inlineContent) {
    ...
    return Bs(r.getBoundingClientRect(), t >= 0);
  }
  if (o == null && i && (t < 0 || i == Me(r))) {
...
function pb(n, e, t) {
  ...
  return l ? !db.test(r.parent.textContent) || !l.modify ? t == "left" || t == "backward" ? o : s : Np(n, e, () => {
...
function gb(n, e, t) {
  return kf == e && Ef == t ? Af : (kf = e, Ef = t, Af = t == "up" || t == "down" ? hb(n, e, t) : pb(n, e, t));
}
...
class si {
  ...
  domFromPos(e, t) {
    ...
    for (let o; r && !(o = this.children[r - 1]).size && o instanceof Ip && o.side >= 0; r--)
      ;
    if (t <= 0) {
      let o, s = !0;
...
class Wt extends si {
  ...
  static create(e, t, r, i, o, s) {
    ...
    let h = f;
    return f = Pp(f, r, t), c ? a = new yb(e, t, r, i, f, u || null, h, c, o, s + 1) : t.isText ? new gs(e, t, r, i, f, h, o) : new Wt(e, t, r, i, f, u || null, h, o, s + 1);
  }
  parseRule() {
  ...
  matchesNode(e, t, r) {
    return this.dirty == Ne && e.eq(this.node) && ro(t, this.outerDeco) && r.eq(this.innerDeco);
  }
  get size() {
  ...
  // `this.children`.
  updateChildren(e, t) {
    let r = this.node.inlineContent, i = t, o = e.composing ? this.localCompositionInfo(e, t) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new wb(this, s && s.node, e);
    xb(this.node, this.innerDeco, (c, f, u) => {
    ...
    }), a.syncToMarks([], r, e), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == tn) && (s && this.protectLocalComposition(e, s), Dp(this.contentDOM, this.children, e), Wn && Cb(this.dom));
  }
  localCompositionInfo(e, t) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = kb(this.node.content, s, r - t, i - t);
  ...
  updateOuterDeco(e) {
    if (ro(e, this.outerDeco))
      return;
    let t = this.nodeDOM.nodeType != 1, r = this.dom;
    this.dom = $p(this.dom, this.nodeDOM, jl(this.outerDeco, this.node, t), jl(e, this.node, t)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
class gs extends Wt {
  ...
  slice(e, t, r) {
    ...
    return new gs(this.parent, i, this.outerDeco, this.innerDeco, o, o, r);
  }
  markDirty(e, t) {
...
function Dp(n, e, t) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof pn) {
      ...
      Dp(s.contentDOM, s.children, t), r = a ? a.nextSibling : n.firstChild;
    }
  }
  for (; r; )
    r = Mf(r), i = !0;
...
function Pp(n, e, t) {
  return $p(n, n, nn, jl(e, t, n.nodeType != 1));
}
function ro(n, e) {
  if (n.length != e.length)
    return !1;
...
class wb {
  constructor(e, t, r) {
    this.lock = t, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = Sb(e.node.content, e);
  }
  ...
  updateNextNode(e, t, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Wt) {
        ...
        if (c != null && c != o)
          return !1;
        let f = a.dom, u, h = this.isLocked(f) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != Xe && ro(t, a.outerDeco));
  ...
  recreateWrapper(e, t, r, i, o, s) {
    if (e.dirty || t.isAtom || !e.children.length || !e.node.content.eq(t.content) || !ro(r, e.outerDeco) || !i.eq(e.innerDeco))
      return null;
...
function Ya(n, e = null) {
  ...
  if (ps(t)) {
    for (a = s; i && !i.node; )
      i = i.parent;
    let u = i.node;
    if (i && u.isAtom && E.isSelectable(u) && i.parent && !(u.isInline && Y0(t.focusNode, t.focusOffset, i.dom))) {
      let h = i.posBefore;
...
function mt(n, e = !1) {
  ...
  if (Lp(n, t), !!_p(n)) {
    ...
    if (n.domObserver.disconnectSelection(), n.cursorWrapper)
      ...
      Nf && !(t instanceof R) && (t.$from.parent.inlineContent || (o = If(n, t.from)), !t.empty && !t.$from.parent.inlineContent && (s = If(n, t.to))), n.docView.setSelection(r, i, n.root, e), Nf && (o && Rf(o), s && Rf(s)), t.visible ? n.dom.classList.remove("ProseMirror-hideselection") : (n.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && Eb(n));
    }
    n.domObserver.setCurSelection(), n.domObserver.connectSelection();
  }
}
const Nf = he || se && kp < 63;
function If(n, e) {
...
function $f(n) {
  return n.editable && !n.hasFocus() ? !1 : Bp(n);
}
function Bp(n) {
...
function Tb(n) {
  ...
  if (!t)
    return;
  let i, o, s = !1;
  for (Le && t.nodeType == 1 && r < io(t) && kr(t.childNodes[r], -1) && (s = !0); ; )
    if (r > 0) {
      if (t.nodeType != 1)
        break;
      {
...
function Ul(n, e, t) {
  if (e.nodeType != 3) {
    let o, s;
    (s = Nb(e, t)) ? (e = s, t = 0) : (o = Ib(e, t)) && (e = o, t = o.nodeValue.length);
  }
...
function _f(n, e) {
  ...
  if (!(se || Z0) && t.parent.inlineContent) {
...
function Fp(n, e) {
  ...
  let s = n.someProp("clipboardSerializer") || er.fromSchema(n.state.schema), l = Jp(), a = l.createElement("div");
  a.appendChild(s.serializeFragment(r, { document: l }));
  let c = a.firstChild, f, u = 0;
  for (; c && c.nodeType == 1 && (f = Hp[c.nodeName.toLowerCase()]); ) {
...
`))), 0, 0) : S.empty;
  ...
  if (l || (l = (n.someProp("clipboardParser") || n.someProp("domParser") || tp.fromSchema(n.state.schema)).parseSlice(s, {
    preserveWhitespace: !!(a || f),
    context: i,
    ruleFromNode(h) {
      return h.nodeName == "BR" && !h.nextSibling && h.parentNode && !Pb.test(h.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), f)
    l = Fb(Ff(l, +f[1], +f[2]), f[4]);
  else if (l = S.maxOpen(_b(l.content, i), !0), l.openStart || l.openEnd) {
    let u = 0, h = 0;
...
const Pb = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function _b(n, e) {
  if (n.childCount < 2)
    return n;
  for (let t = e.depth; t >= 0; t--) {
    ...
    if (n.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Wp(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Up(s[s.length - 1], o.length));
        let f = Vp(l, a);
...
function Wp(n, e, t, r, i) {
  if (i < n.length && i < e.length && n[i] == e[i]) {
    let o = Wp(n, e, t, r.lastChild, i + 1);
    if (o)
      return r.copy(r.content.replaceChild(r.childCount - 1, o));
    if (r.contentMatchAt(r.childCount).matchType(i == n.length - 1 ? t.type : n[i + 1]))
      return r.copy(r.content.append(b.from(Vp(t, n, i + 1))));
  }
}
function Up(n, e) {
  if (e == 0)
    return n;
  let t = n.content.replaceChild(n.childCount - 1, Up(n.lastChild, e - 1)), r = n.contentMatchAt(n.childCount).fillBefore(b.empty, !0);
...
function Bb(n) {
  ...
  let t = Jp().createElement("div"), r = /<([a-z][^>\s]+)/i.exec(n), i;
  if ((i = r && Hp[r[1].toLowerCase()]) && (n = i.map((o) => "<" + o + ">").join("") + n + i.map((o) => "</" + o + ">").reverse().join("")), t.innerHTML = Lb(n), i)
    for (let o = 0; o < i.length; o++)
...
const de = {}, pe = {}, jb = { touchstart: !0, touchmove: !0 };
class Vb {
  constructor() {
...
function Wb(n) {
  for (let e in de) {
    ...
    n.dom.addEventListener(e, n.input.eventHandlers[e] = (r) => {
      Hb(n, r) && !Qa(n, r) && (n.editable || !(r.type in pe)) && t(n, r);
    }, jb[e] ? { passive: !0 } : void 0);
  }
...
pe.keydown = (n, e) => {
  let t = e;
  if (n.input.shiftKey = t.keyCode == 16 || t.shiftKey, !Kp(n, t) && (n.input.lastKeyCode = t.keyCode, n.input.lastKeyCodeTime = Date.now(), !(De && se && t.keyCode == 13)))
    ...
    } else n.someProp("handleKeyDown", (r) => r(n, t)) || $b(n, t) ? t.preventDefault() : zt(n, "key");
};
pe.keyup = (n, e) => {
...
pe.keypress = (n, e) => {
  let t = e;
  if (Kp(n, t) || !t.charCode || t.ctrlKey && !t.altKey || Te && t.metaKey)
    return;
...
function Yb(n, e, t, r, i) {
  return Za(n, "handleClickOn", e, t, r) || n.someProp("handleClick", (o) => o(n, e, r)) || (i ? qb(n, t) : Kb(n, t));
}
function Xb(n, e, t, r) {
  return Za(n, "handleDoubleClickOn", e, t, r) || n.someProp("handleDoubleClick", (i) => i(n, e, r));
}
function Qb(n, e, t, r) {
  return Za(n, "handleTripleClickOn", e, t, r) || n.someProp("handleTripleClick", (i) => i(n, e, r)) || Zb(n, t, r);
}
function Zb(n, e, t) {
  if (t.button != 0)
    return !1;
...
const Gp = Te ? "metaKey" : "ctrlKey";
de.mousedown = (n, e) => {
  let t = e;
  n.input.shiftKey = t.shiftKey;
  let r = ec(n), i = Date.now(), o = "singleClick";
  i - n.input.lastClick.time < 500 && Gb(t, n.input.lastClick) && !t[Gp] && (n.input.lastClick.type == "singleClick" ? o = "doubleClick" : n.input.lastClick.type == "doubleClick" && (o = "tripleClick")), n.input.lastClick = { time: i, x: t.clientX, y: t.clientY, type: o };
  let s = n.posAtCoords(ms(t));
  s && (o == "singleClick" ? (n.input.mouseDown && n.input.mouseDown.done(), n.input.mouseDown = new e1(n, s, t, !!r)) : (o == "doubleClick" ? Xb : Qb)(n, s.pos, s.inside, t) ? t.preventDefault() : zt(n, "pointer"));
};
class e1 {
  constructor(e, t, r, i) {
    this.view = e, this.pos = t, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.mightDrag = null, this.startDoc = e.state.doc, this.selectNode = !!r[Gp], this.allowDefault = r.shiftKey;
    let o, s;
    if (t.inside > -1)
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let t = this.pos;
    this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(ms(e))), this.updateAllowDefault(e), this.allowDefault || !t ? zt(this.view, "pointer") : Yb(this.view, t.pos, t.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
pe.compositionstart = pe.compositionupdate = (n) => {
  if (!n.composing) {
    ...
    if (e.selection instanceof R && (e.storedMarks || !t.textOffset && t.parentOffset && t.nodeBefore.marks.some((r) => r.type.spec.inclusive === !1)))
      n.markCursor = n.state.storedMarks || t.marks(), oo(n, !0), n.markCursor = null;
    else if (oo(n, !e.selection.empty), Le && e.selection.empty && t.parentOffset && !t.textOffset && t.nodeBefore.marks.length) {
...
pe.compositionend = (n, e) => {
  n.composing && (n.input.composing = !1, n.input.compositionEndedAt = e.timeStamp, n.input.compositionPendingChanges = n.domObserver.pendingRecords().length ? n.input.compositionID : 0, n.input.compositionNode = null, n.input.compositionPendingChanges && Promise.resolve().then(() => n.domObserver.flush()), n.input.compositionID++, qp(n, 20));
};
function qp(n, e) {
  clearTimeout(n.input.composingTimeout), e > -1 && (n.input.composingTimeout = setTimeout(() => oo(n), e));
}
function Yp(n) {
  for (n.composing && (n.input.composing = !1, n.input.compositionEndedAt = r1()); n.input.compositionNodes.length > 0; )
...
function n1(n) {
  ...
  if (!e.focusNode)
    return null;
  let t = K0(e.focusNode, e.focusOffset), r = q0(e.focusNode, e.focusOffset);
  if (t && r && t != r) {
...
function oo(n, e = !1) {
  if (!(De && n.domObserver.flushingSoon >= 0)) {
    if (n.domObserver.forceFlush(), Yp(n), e || n.docView && n.docView.dirty) {
      let t = Ya(n);
...
const Br = be && Vt < 15 || Wn && eb < 604;
de.copy = pe.cut = (n, e) => {
  let t = e, r = n.state.selection, i = t.type == "cut";
  if (r.empty)
    return;
  let o = Br ? null : t.clipboardData, s = r.content(), { dom: l, text: a } = Fp(n, s);
  o ? (t.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : i1(n, l), i && n.dispatch(n.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function o1(n) {
...
function zr(n, e, t, r, i) {
  ...
  if (!o)
    return !1;
  let s = o1(o), l = s ? n.state.tr.replaceSelectionWith(s, r) : n.state.tr.replaceSelection(o);
...
pe.paste = (n, e) => {
  ...
  r && zr(n, Xp(r), r.getData("text/html"), i, t) ? t.preventDefault() : s1(n, t);
};
class Qp {
  constructor(e, t, r) {
...
de.dragstart = (n, e) => {
  ...
  let l = (s || n.state.selection).content(), { dom: a, text: c, slice: f } = Fp(n, l);
  (!t.dataTransfer.files.length || !se || kp > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Br ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Br || t.dataTransfer.setData("text/plain", c), n.dragging = new Qp(f, !t[Zp], s);
};
de.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
pe.drop = (n, e) => {
  ...
  s ? n.someProp("transformPasted", (p) => {
    s = p(s, n);
  }) : s = jp(n, Xp(t.dataTransfer), Br ? null : t.dataTransfer.getData("text/html"), !1, o);
  let l = !!(r && !t[Zp]);
  ...
  if (!s)
    return;
  t.preventDefault();
  let a = s ? gp(n.state.doc, o.pos, s) : o.pos;
  a == null && (a = o.pos);
  let c = n.state.tr;
  if (l) {
    let { node: p } = r;
...
class so {
  ...
  eq(e) {
    return this == e || e instanceof so && (this.spec.key && this.spec.key == e.spec.key || this.toDOM == e.toDOM && Fr(this.spec, e.spec));
  }
  destroy(e) {
...
class H {
  ...
  */
  static create(e, t) {
    return t.length ? lo(t, e, 0, ln) : oe;
  }
  /**
  ...
  */
  mapInner(e, t, r, i, o) {
    ...
    return this.children.length ? l1(this.children, s || [], e, t, r, i, o) : s ? new H(s.sort(an), Nn) : oe;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (f = tg(t, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, f, c + 1) : i.splice(o, 0, a, a + l.nodeSize, lo(f, l, c + 1, ln)), o += 3;
      }
    });
    let s = eg(o ? ng(t) : t, -r);
    for (let l = 0; l < s.length; l++)
...
function l1(n, e, t, r, i, o, s) {
  ...
  if (a) {
    let c = a1(l, n, e, t, i, o, s), f = lo(c, r, 0, s);
    e = f.local;
...
function lo(n, e, t, r) {
  ...
  e.forEach((l, a) => {
    ...
    if (c) {
      o = !0;
      let f = lo(c, l, t + a + 1, r);
      f != oe && i.push(a, a + l.nodeSize, f);
    }
  });
  let s = eg(o ? ng(n) : n, -t).sort(an);
  for (let l = 0; l < s.length; l++)
...
class h1 {
  constructor(e, t) {
    this.view = e, this.handleDOMChange = t, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new u1(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, c1)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  flush() {
    ...
    if (Le && a.length) {
      ...
      if (f.length == 2) {
        ...
        for (let h of f) {
          let d = h.parentNode;
          d && d.nodeName == "LI" && (!u || g1(e, u) != d) && h.remove();
        }
      }
    }
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && ps(r) && (c = Ya(e)) && c.eq(T.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, mt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), d1(e)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || mt(e), this.currentSelection.set(r));
  }
...
function m1(n, e, t) {
  ...
  if (f && n.dom.contains(f.nodeType == 1 ? f : f.parentNode) && (c = [{ node: f, offset: a.anchorOffset }], ps(a) || c.push({ node: a.focusNode, offset: a.focusOffset })), se && n.input.lastKeyCode === 8)
    for (let m = o; m > i; m--) {
  ...
  let u = n.state.doc, h = n.someProp("domParser") || tp.fromSchema(n.state.schema), d = u.resolve(s), p = null, g = h.parse(r, {
    topNode: d.parent,
...
function w1(n, e, t, r, i) {
  ...
  let a = n.state.selection, c = m1(n, e, t), f = n.state.doc, u = f.slice(c.from, c.to), h, d;
  ...
  let p = x1(u.content, c.doc.content, c.from, h, d);
  if (p && n.input.domChangeCount++, (Wn && n.input.lastIOSEnter > Date.now() - 225 || De) && i.some((C) => C.nodeType == 1 && !b1.test(C.nodeName)) && (!p || p.endA >= p.endB) && n.someProp("handleKeyDown", (C) => C(n, en(13, "Enter")))) {
  ...
  if (n.state.selection.anchor > p.start && v1(f, p.start, p.endA, g, m) && n.someProp("handleKeyDown", (C) => C(n, en(8, "Backspace")))) {
  ...
  if (v) {
    if (g.pos == m.pos)
      ...
      p.endA == p.endB && ($ = S1(g.parent.content.cut(g.parentOffset, m.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    )
...
function v1(n, e, t, r, i) {
  ...
  if (o.parentOffset < o.parent.content.size || !o.parent.isTextblock)
    return !1;
  let s = n.resolve(js(o, !0, !0));
  return !s.parent.isTextblock || s.pos > t || js(s, !0, !1) < t ? !1 : r.parent.content.cut(r.parentOffset).eq(s.parent.content);
}
function js(n, e, t) {
...
class sR {
  ...
  */
  ...
  updateStateInner(e, t) {
    ...
    if (l || this._props.plugins != t.plugins || this._props.nodeViews != t.nodeViews) {
      let d = Xf(this);
      k1(d, this.nodeViews) && (this.nodeViews = d, o = !0);
    }
    (l || t.handleDOMEvents != this._props.handleDOMEvents) && Jl(this), this.editable = Yf(this), qf(this);
    let a = Fs(this), c = Kf(this), f = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", u = o || !this.docView.matchesNode(e.doc, c, a);
    (u || !e.selection.eq(i.selection)) && (s = !0);
    let h = f == "preserve" && s && this.dom.style.overflowAnchor == null && rb(this);
    if (s) {
      this.domObserver.stop();
      let d = u && (be || se) && !this.composing && !i.selection.empty && !e.selection.empty && C1(i.selection, e.selection);
      if (u) {
        let p = se ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = n1(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = Tf(e.doc, c, a, this.dom, this)), p && !this.trackWrites && (d = !0);
      }
      d || !(this.input.mouseDown && this.domObserver.currentSelection.eq(this.domSelectionRange()) && Ob(this)) ? mt(this, d) : (Lp(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), f == "reset" ? this.dom.scrollTop = 0 : f == "to selection" ? this.scrollToSelection() : h && ib(h);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, t) {
    ...
    this.dragging = new Qp(e.slice, e.move, i < 0 ? void 0 : E.create(this.state.doc, i));
  }
  someProp(e, t) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && ob(this.dom), mt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (Ub(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], Fs(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, J0());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? he && this.root.nodeType === 11 && X0(this.dom.ownerDocument) == this.dom && p1(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
var Ht = {
  ...
  221: "}",
  222: '"'
}, E1 = typeof navigator < "u" && /Mac/.test(navigator.platform), A1 = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var ne = 0; ne < 10; ne++) Ht[48 + ne] = Ht[96 + ne] = String(ne);
for (var ne = 1; ne <= 24; ne++) Ht[ne + 111] = "F" + ne;
for (var ne = 65; ne <= 90; ne++)
  Ht[ne] = String.fromCharCode(ne + 32), ao[ne] = String.fromCharCode(ne);
for (var Vs in Ht) ao.hasOwnProperty(Vs) || (ao[Vs] = Ht[Vs]);
function O1(n) {
  var e = E1 && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || A1 && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", t = !e && n.key || (n.shiftKey ? ao : Ht)[n.keyCode] || n.key || "Unidentified";
  return t == "Esc" && (t = "Escape"), t == "Del" && (t = "Delete"), t == "Left" && (t = "ArrowLeft"), t == "Up" && (t = "ArrowUp"), t == "Right" && (t = "ArrowRight"), t == "Down" && (t = "ArrowDown"), t;
}
const T1 = typeof navigator < "u" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : !1;
function M1(n) {
...
const cR = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (Un(o, "end") || E.isSelectable(o)))
    for (let s = r.depth; ; s--) {
      let l = hs(n.doc, r.before(s), r.after(s), S.empty);
...
const dR = (n, e, t) => {
  ...
  if (r.parent.content.size == 0 && (Un(o, "start") || E.isSelectable(o))) {
    let s = hs(n.doc, r.before(), r.after(), S.empty);
...
const gR = (n, e) => {
  ...
  if (r) {
    if (t.node.isTextblock || !ri(n.doc, t.from))
      return !1;
    i = t.from;
  } else if (i = pp(n.doc, t.from, -1), i == null)
    return !1;
  if (e) {
    let o = n.tr.join(i);
  ...
  if (t instanceof E) {
    if (t.node.isTextblock || !ri(n.doc, t.to))
      return !1;
    r = t.to;
  } else if (r = pp(n.doc, t.to, 1), r == null)
    return !1;
...
const wR = (n, e) => {
  ...
  if (!t.parent.type.spec.code || !t.sameParent(r))
    return !1;
  let i = t.node(-1), o = t.indexAfter(-1), s = sg(i.contentMatchAt(o));
  ...
  if (t instanceof Pe || r.parent.inlineContent || i.parent.inlineContent)
    return !1;
  let o = sg(i.parent.contentMatchAt(i.indexAfter()));
  if (!o || !o.isTextblock)
    return !1;
  if (e) {
...
const CR = ag(-1), kR = ag(1);
function ER(n, e = null) {
  return function(t, r) {
    let { $from: i, $to: o } = t.selection, s = i.blockRange(o), l = s && cp(s, n, e);
...
function OR(n, e = null) {
  return function(t, r) {
    ...
    let c = cp(a, n, e, s);
    return c ? (r && r(R1(t.tr, s, c, l, n).scrollIntoView()), !0) : !1;
  };
}
function R1(n, e, t, r, i) {
  ...
  for (let f = e.startIndex, u = e.endIndex, h = !0; f < u; f++, h = !1)
    !h && hp(n.doc, a, l) && (n.split(a, l), a += 2 * l), a += c.child(f).nodeSize;
  return n;
}
function TR(n) {
  return function(e, t) {
    let { $from: r, $to: i } = e.selection, o = r.blockRange(i, (s) => s.childCount > 0 && s.firstChild.type == n);
    return o ? t ? r.node(o.depth - 1).type == n ? D1(e, t, n, o) : $1(e, t, o) : !0 : !1;
  };
}
function D1(n, e, t, r) {
...
function cg(n) {
  ...
  if (typeof n == "string" || typeof n == "number") r += n;
    ...
    var i = n.length;
    for (e = 0; e < i; e++) n[e] && (t = cg(n[e])) && (r && (r += " "), r += t);
  } else for (t in n) n[t] && (r && (r += " "), r += t);
  return r;
}
function NR() {
  for (var n, e, t = 0, r = "", i = arguments.length; t < i; t++) (n = arguments[t]) && (e = cg(n)) && (r && (r += " "), r += e);
  return r;
}
const sc = "-", P1 = (n) => {
  const e = L1(n), {
  ...
  return {
    getClassGroupId: (s) => {
      const l = s.split(sc);
      return l[0] === "" && l.length !== 1 && l.shift(), fg(l, e) || _1(s);
    },
  ...
  const t = n[0], r = e.nextPart.get(t), i = r ? fg(n.slice(1), r) : void 0;
  if (i)
    return i;
  ...
  return z1(Object.entries(n.classGroups), t).forEach(([o, s]) => {
    Gl(s, r, o, e);
  }), r;
}, Gl = (n, e, t, r) => {
  n.forEach((i) => {
...
}, B1 = (n) => n.isThemeGetter, z1 = (n, e) => e ? n.map(([t, r]) => {
  ...
  const {
    ...
    const h = a.length === 0 ? l : l.substring(f), d = h.startsWith(ug), p = d ? h.substring(1) : h, g = u && u > f ? u - f : void 0;
    return {
      modifiers: a,
  ...
  for (let a = s.length - 1; a >= 0; a -= 1) {
    ...
    const m = V1(f).join(":"), y = u ? m + ug : m, v = y + g;
    if (o.includes(v))
      continue;
    o.push(v);
    const k = i(g, p);
...
function G1(n, ...e) {
  ...
  function s(a) {
    ...
    return t = W1(c), r = t.cache.get, i = t.cache.set, o = l, l(a);
  }
  function l(a) {
    const c = r(a);
    if (c)
...
const B = (n) => {
...
}, dg = /^\[(?:([a-z-]+):)?(.+)\]$/i, K1 = /^\d+\/\d+$/, q1 = /* @__PURE__ */ new Set(["px", "full", "screen"]), Y1 = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, X1 = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Q1 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch))\(.+\)$/, Z1 = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, ew = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, ct = (n) => Bn(n) || q1.has(n) || K1.test(n), kt = (n) => tr(n, "length", aw), Bn = (n) => !!n && !Number.isNaN(Number(n)), Us = (n) => tr(n, "number", Bn), ur = (n) => !!n && Number.isInteger(Number(n)), tw = (n) => n.endsWith("%") && Bn(n.slice(0, -1)), M = (n) => dg.test(n), Et = (n) => Y1.test(n), nw = /* @__PURE__ */ new Set(["length", "size", "percentage"]), rw = (n) => tr(n, nw, pg), iw = (n) => tr(n, "position", pg), ow = /* @__PURE__ */ new Set(["image", "url"]), sw = (n) => tr(n, ow, fw), lw = (n) => tr(n, "", cw), hr = () => !0, tr = (n, e, t) => {
  const r = dg.exec(n);
  ...
  X1.test(n) && !Q1.test(n)
), pg = () => !1, cw = (n) => Z1.test(n), fw = (n) => ew.test(n), uw = () => {
  ...
  return {
    ...
    theme: {
      ...
      gradientColorStopPositions: [tw, kt],
      inset: ge(),
      margin: ge(),
      opacity: lt(),
      padding: P(),
    ...
    classGroups: {
       ...
       */
      "font-weight": [{
        font: ["thin", "extralight", "light", "normal", "medium", "semibold", "bold", "extrabold", "black", Us]
      }],
      /**
       * Font Family
...
var gg = typeof global == "object" && global && global.Object === Object && global, hw = typeof self == "object" && self && self.Object === Object && self, tt = gg || hw || Function("return this")(), Qe = tt.Symbol, mg = Object.prototype, dw = mg.hasOwnProperty, pw = mg.toString, dr = Qe ? Qe.toStringTag : void 0;
function gw(n) {
  var e = dw.call(n, dr), t = n[dr];
  try {
    n[dr] = void 0;
    var r = !0;
  } catch {
...
var mw = Object.prototype, yw = mw.toString;
function bw(n) {
  return yw.call(n);
}
var ww = "[object Null]", Sw = "[object Undefined]", tu = Qe ? Qe.toStringTag : void 0;
function wn(n) {
  return n == null ? n === void 0 ? Sw : ww : tu && tu in Object(n) ? gw(n) : bw(n);
}
function Jt(n) {
...
function ys(n) {
  return typeof n == "symbol" || Jt(n) && wn(n) == vw;
}
function yg(n, e) {
...
var Ze = Array.isArray, xw = 1 / 0, nu = Qe ? Qe.prototype : void 0, ru = nu ? nu.toString : void 0;
function co(n) {
  if (typeof n == "string")
    return n;
  if (Ze(n))
  ...
  if (ys(n))
    return ru ? ru.call(n) : "";
  var e = n + "";
  return e == "0" && 1 / n == -xw ? "-0" : e;
}
var Cw = /\s/;
function kw(n) {
  for (var e = n.length; e-- && Cw.test(n.charAt(e)); )
    ;
  return e;
}
var Ew = /^\s+/;
function Aw(n) {
  return n && n.slice(0, kw(n) + 1).replace(Ew, "");
}
function Gt(n) {
  var e = typeof n;
  return n != null && (e == "object" || e == "function");
}
var iu = NaN, Ow = /^[-+]0x[0-9a-f]+$/i, Tw = /^0b[01]+$/i, Mw = /^0o[0-7]+$/i, Nw = parseInt;
function Kl(n) {
  if (typeof n == "number")
    return n;
  if (ys(n))
  ...
  n = Aw(n);
  var t = Tw.test(n);
  return t || Mw.test(n) ? Nw(n.slice(2), t ? 2 : 8) : Ow.test(n) ? iu : +n;
}
var ou = 1 / 0, Iw = 17976931348623157e292;
function Rw(n) {
  if (!n)
    return n === 0 ? n : 0;
  if (n = Kl(n), n === ou || n === -ou) {
...
var $w = "[object AsyncFunction]", Pw = "[object Function]", _w = "[object GeneratorFunction]", Lw = "[object Proxy]";
function bg(n) {
  if (!Gt(n))
    return !1;
  var e = wn(n);
  return e == Pw || e == _w || e == $w || e == Lw;
}
var Hs = tt["__core-js_shared__"], su = function() {
...
var zw = Function.prototype, Fw = zw.toString;
function Sn(n) {
  if (n != null) {
    try {
      return Fw.call(n);
...
var jw = /[\\^$.*+?()[\]{}|]/g, Vw = /^\[object .+?Constructor\]$/, Ww = Function.prototype, Uw = Object.prototype, Hw = Ww.toString, Jw = Uw.hasOwnProperty, Gw = RegExp(
  "^" + Hw.call(Jw).replace(jw, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Kw(n) {
  if (!Gt(n) || Bw(n))
    return !1;
...
function wg(n, e) {
  var t = typeof n;
  return e = e ?? cS, !!e && (t == "number" || t != "symbol" && fS.test(n)) && n > -1 && n % 1 == 0 && n < e;
}
function Sg(n, e) {
  return n === e || n !== n && e !== e;
}
...
function uS(n, e, t) {
  return e = au(e === void 0 ? n.length - 1 : e, 0), function() {
    ...
    for (var l = Array(e + 1); ++i < e; )
      l[i] = r[i];
    return l[e] = t(s), Yw(n, this, l);
  };
}
function hS(n, e) {
  return rS(uS(n, e, lc), n + "");
}
var dS = 9007199254740991;
function ac(n) {
  return typeof n == "number" && n > -1 && n % 1 == 0 && n <= dS;
}
function vg(n) {
  return n != null && ac(n.length) && !bg(n);
}
var pS = Object.prototype;
function gS(n) {
  var e = n && n.constructor, t = typeof e == "function" && e.prototype || pS;
  return n === t;
}
function mS(n, e) {
...
var xg = Object.prototype, bS = xg.hasOwnProperty, wS = xg.propertyIsEnumerable, cc = cu(/* @__PURE__ */ function() {
  return arguments;
}()) ? cu : function(n) {
  return Jt(n) && bS.call(n, "callee") && !wS.call(n, "callee");
};
function SS() {
  return !1;
}
var Cg = typeof exports == "object" && exports && !exports.nodeType && exports, fu = Cg && typeof module == "object" && module && !module.nodeType && module, vS = fu && fu.exports === Cg, uu = vS ? tt.Buffer : void 0, xS = uu ? uu.isBuffer : void 0, Yl = xS || SS, CS = "[object Arguments]", kS = "[object Array]", ES = "[object Boolean]", AS = "[object Date]", OS = "[object Error]", TS = "[object Function]", MS = "[object Map]", NS = "[object Number]", IS = "[object Object]", RS = "[object RegExp]", DS = "[object Set]", $S = "[object String]", PS = "[object WeakMap]", _S = "[object ArrayBuffer]", LS = "[object DataView]", BS = "[object Float32Array]", zS = "[object Float64Array]", FS = "[object Int8Array]", jS = "[object Int16Array]", VS = "[object Int32Array]", WS = "[object Uint8Array]", US = "[object Uint8ClampedArray]", HS = "[object Uint16Array]", JS = "[object Uint32Array]", z = {};
z[BS] = z[zS] = z[FS] = z[jS] = z[VS] = z[WS] = z[US] = z[HS] = z[JS] = !0;
z[CS] = z[kS] = z[_S] = z[ES] = z[LS] = z[AS] = z[OS] = z[TS] = z[MS] = z[NS] = z[IS] = z[RS] = z[DS] = z[$S] = z[PS] = !1;
function GS(n) {
...
var kg = typeof exports == "object" && exports && !exports.nodeType && exports, Er = kg && typeof module == "object" && module && !module.nodeType && module, KS = Er && Er.exports === kg, Js = KS && gg.process, fo = function() {
  try {
    var n = Er && Er.require && Er.require("util").types;
    return n || Js && Js.binding && Js.binding("util");
  } catch {
  }
}(), hu = fo && fo.isTypedArray, Eg = hu ? fc(hu) : GS, qS = Object.prototype, YS = qS.hasOwnProperty;
function XS(n, e) {
  var t = Ze(n), r = !t && cc(n), i = !t && !r && Yl(n), o = !t && !r && !i && Eg(n), s = t || r || i || o, l = s ? mS(n.length, String) : [], a = l.length;
  for (var c in n)
    YS.call(n, c) && !(s && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var ZS = QS(Object.keys, Object), ev = Object.prototype, tv = ev.hasOwnProperty;
function nv(n) {
  if (!gS(n))
    return ZS(n);
  var e = [];
  for (var t in Object(n))
    tv.call(n, t) && t != "constructor" && e.push(t);
  return e;
}
function Ag(n) {
  return vg(n) ? XS(n) : nv(n);
}
var rv = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, iv = /^\w*$/;
function uc(n, e) {
  if (Ze(n))
    return !1;
  var t = typeof n;
  return t == "number" || t == "symbol" || t == "boolean" || n == null || ys(n) ? !0 : iv.test(n) || !rv.test(n) || e != null && n in Object(e);
}
...
var lv = "__lodash_hash_undefined__", av = Object.prototype, cv = av.hasOwnProperty;
function fv(n) {
  var e = this.__data__;
  if (jr) {
    var t = e[n];
  ...
  return cv.call(e, n) ? e[n] : void 0;
}
var uv = Object.prototype, hv = uv.hasOwnProperty;
function dv(n) {
  var e = this.__data__;
  return jr ? e[n] !== void 0 : hv.call(e, n);
}
var pv = "__lodash_hash_undefined__";
function gv(n, e) {
  var t = this.__data__;
  return this.size += this.has(n) ? 0 : 1, t[n] = jr && e === void 0 ? pv : e, this;
}
function gn(n) {
...
var yv = Array.prototype, bv = yv.splice;
function wv(n) {
  var e = this.__data__, t = bs(e, n);
  if (t < 0)
    return !1;
  var r = e.length - 1;
  return t == r ? e.pop() : bv.call(e, t, 1), --this.size, !0;
}
function Sv(n) {
  var e = this.__data__, t = bs(e, n);
...
St.prototype.clear = mv;
St.prototype.delete = wv;
St.prototype.get = Sv;
St.prototype.has = vv;
St.prototype.set = xv;
var Vr = vn(tt, "Map");
...
function ws(n, e) {
  var t = n.__data__;
  return kv(e) ? t[typeof e == "string" ? "string" : "hash"] : t.map;
}
function Ev(n) {
  var e = ws(this, n).delete(n);
  return this.size -= e ? 1 : 0, e;
}
function Av(n) {
...
function Iv(n) {
  var e = hc(n, function(r) {
    return t.size === Nv && t.clear(), r;
  }), t = e.cache;
  return e;
}
var Rv = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, Dv = /\\(\\)?/g, $v = Iv(function(n) {
  var e = [];
  return n.charCodeAt(0) === 46 && e.push(""), n.replace(Rv, function(t, r, i, o) {
    e.push(i ? o.replace(Dv, "$1") : r || t);
  }), e;
});
function Xl(n) {
  return n == null ? "" : co(n);
...
function Fv(n, e, t) {
  var r = n.length;
  return t = t === void 0 ? r : t, !e && t >= r ? n : zv(n, e, t);
}
var jv = "\\ud800-\\udfff", Vv = "\\u0300-\\u036f", Wv = "\\ufe20-\\ufe2f", Uv = "\\u20d0-\\u20ff", Hv = Vv + Wv + Uv, Jv = "\\ufe0e\\ufe0f", Gv = "\\u200d", Kv = RegExp("[" + Gv + jv + Hv + Jv + "]");
function dc(n) {
  return Kv.test(n);
}
function qv(n) {
...
var Ng = "\\ud800-\\udfff", Yv = "\\u0300-\\u036f", Xv = "\\ufe20-\\ufe2f", Qv = "\\u20d0-\\u20ff", Zv = Yv + Xv + Qv, ex = "\\ufe0e\\ufe0f", tx = "[" + Ng + "]", Ql = "[" + Zv + "]", Zl = "\\ud83c[\\udffb-\\udfff]", nx = "(?:" + Ql + "|" + Zl + ")", Ig = "[^" + Ng + "]", Rg = "(?:\\ud83c[\\udde6-\\uddff]){2}", Dg = "[\\ud800-\\udbff][\\udc00-\\udfff]", rx = "\\u200d", $g = nx + "?", Pg = "[" + ex + "]?", ix = "(?:" + rx + "(?:" + [Ig, Rg, Dg].join("|") + ")" + Pg + $g + ")*", ox = Pg + $g + ix, sx = "(?:" + [Ig + Ql + "?", Ql, Rg, Dg, tx].join("|") + ")", lx = RegExp(Zl + "(?=" + Zl + ")|" + sx + ox, "g");
function ax(n) {
  return n.match(lx) || [];
}
function cx(n) {
  return dc(n) ? ax(n) : qv(n);
}
function fx() {
...
yt.prototype.clear = fx;
yt.prototype.delete = ux;
yt.prototype.get = hx;
yt.prototype.has = dx;
yt.prototype.set = gx;
function mx(n, e) {
...
var bx = Object.prototype, wx = bx.propertyIsEnumerable, pu = Object.getOwnPropertySymbols, Sx = pu ? function(n) {
  return n == null ? [] : (n = Object(n), mx(pu(n), function(e) {
    return wx.call(n, e);
  }));
} : yx;
function vx(n, e, t) {
  var r = e(n);
  return Ze(n) ? r : Mg(r, t(n));
}
function gu(n) {
  return vx(n, Ag, Sx);
}
var ea = vn(tt, "DataView"), ta = vn(tt, "Promise"), na = vn(tt, "Set"), mu = "[object Map]", xx = "[object Object]", yu = "[object Promise]", bu = "[object Set]", wu = "[object WeakMap]", Su = "[object DataView]", Cx = Sn(ea), kx = Sn(Vr), Ex = Sn(ta), Ax = Sn(na), Ox = Sn(ql), Mt = wn;
(ea && Mt(new ea(new ArrayBuffer(1))) != Su || Vr && Mt(new Vr()) != mu || ta && Mt(ta.resolve()) != yu || na && Mt(new na()) != bu || ql && Mt(new ql()) != wu) && (Mt = function(n) {
  var e = wn(n), t = e == xx ? n.constructor : void 0, r = t ? Sn(t) : "";
  if (r)
    switch (r) {
      case Cx:
        return Su;
...
var vu = tt.Uint8Array, Tx = "__lodash_hash_undefined__";
function Mx(n) {
  return this.__data__.set(n, Tx), this;
}
function Nx(n) {
  return this.__data__.has(n);
}
...
Wr.prototype.add = Wr.prototype.push = Mx;
Wr.prototype.has = Nx;
function Ix(n, e) {
...
var Rx = 1, Dx = 2;
function Lg(n, e, t, r, i, o) {
  var s = t & Rx, l = n.length, a = e.length;
  if (l != a && !(s && a > l))
    return !1;
  var c = o.get(n), f = o.get(e);
  if (c && f)
    return c == e && f == n;
  var u = -1, h = !0, d = t & Dx ? new Wr() : void 0;
  for (o.set(n, e), o.set(e, n); ++u < l; ) {
    ...
    if (d) {
      if (!Ix(e, function(y, v) {
        if (!_g(d, v) && (p === y || i(p, y, t, r, o)))
          return d.push(v);
      })) {
        h = !1;
        break;
...
var _x = 1, Lx = 2, Bx = "[object Boolean]", zx = "[object Date]", Fx = "[object Error]", jx = "[object Map]", Vx = "[object Number]", Wx = "[object RegExp]", Ux = "[object Set]", Hx = "[object String]", Jx = "[object Symbol]", Gx = "[object ArrayBuffer]", Kx = "[object DataView]", xu = Qe ? Qe.prototype : void 0, Gs = xu ? xu.valueOf : void 0;
function qx(n, e, t, r, i, o, s) {
  switch (t) {
    case Kx:
    ...
    case Ux:
      var a = r & _x;
      if (l || (l = Px), n.size != e.size && !a)
        return !1;
      var c = s.get(n);
      if (c)
        return c == e;
      r |= Lx, s.set(n, e);
      var f = Lg(l(n), l(e), r, i, o, s);
      return s.delete(n), f;
    case Jx:
      if (Gs)
        return Gs.call(n) == Gs.call(e);
  }
  return !1;
}
var Yx = 1, Xx = Object.prototype, Qx = Xx.hasOwnProperty;
function Zx(n, e, t, r, i, o) {
  var s = t & Yx, l = gu(n), a = l.length, c = gu(e), f = c.length;
  if (a != f && !s)
    return !1;
  for (var u = a; u--; ) {
    var h = l[u];
    if (!(s ? h in e : Qx.call(e, h)))
      return !1;
  }
...
var eC = 1, Cu = "[object Arguments]", ku = "[object Array]", pi = "[object Object]", tC = Object.prototype, Eu = tC.hasOwnProperty;
function nC(n, e, t, r, i, o) {
  ...
  if (h && !f)
    return o || (o = new yt()), s || Eg(n) ? Lg(n, e, t, r, i, o) : qx(n, e, a, t, r, i, o);
  if (!(t & eC)) {
  ...
  return h ? (o || (o = new yt()), Zx(n, e, t, r, i, o)) : !1;
}
function pc(n, e, t, r, i) {
  return n === e ? !0 : n == null || e == null || !Jt(n) && !Jt(e) ? n !== n && e !== e : nC(n, e, t, r, pc, i);
}
var rC = 1, iC = 2;
function oC(n, e, t, r) {
  var i = t.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (s[2]) {
      ...
      var f = new yt(), u;
      if (!(u === void 0 ? pc(c, a, rC | iC, r, f) : u))
        return !1;
    }
  }
  return !0;
...
function lC(n) {
  var e = sC(n);
  return e.length == 1 && e[0][2] ? zg(e[0][0], e[0][1]) : function(t) {
    return t === n || oC(t, n, e);
  };
}
function aC(n, e) {
...
function cC(n, e, t) {
  ...
  return o || ++r != i ? o : (i = n == null ? 0 : n.length, !!i && ac(i) && wg(s, i) && (Ze(n) || cc(n)));
}
function fC(n, e) {
  return n != null && cC(n, e, aC);
}
var uC = 1, hC = 2;
function dC(n, e) {
  return uc(n) && Bg(e) ? zg(Ss(n), e) : function(t) {
    var r = _v(t, n);
    return r === void 0 && r === e ? fC(t, n) : pc(e, r, uC | hC);
  };
}
function Fg(n) {
  return function(e) {
...
function gC(n) {
  return uc(n) ? Fg(Ss(n)) : pC(n);
}
function mC(n) {
  return typeof n == "function" ? n : n == null ? lc : typeof n == "object" ? Ze(n) ? dC(n[0], n[1]) : lC(n) : gC(n);
}
var Ks = function() {
  return tt.Date.now();
}, yC = "Expected a function", bC = Math.max, wC = Math.min;
function SC(n, e, t) {
  var r, i, o, s, l, a, c = 0, f = !1, u = !1, h = !0;
  if (typeof n != "function")
    throw new TypeError(yC);
  e = Kl(e) || 0, Gt(t) && (f = !!t.leading, u = "maxWait" in t, o = u ? bC(Kl(t.maxWait) || 0, e) : o, h = "trailing" in t ? !!t.trailing : h);
  function d(x) {
    var N = r, $ = i;
...
var vC = 200;
function xC(n, e, t, r) {
  var i = -1, o = aS, s = !0, l = n.length, a = [], c = e.length;
  if (!l)
    return a;
  t && (e = yg(e, fc(t))), e.length >= vC && (o = _g, s = !1, e = new Wr(e));
  e:
    for (; ++i < l; ) {
...
var RR = hS(function(n, e) {
  var t = CC(e);
  return qs(t) && (t = void 0), qs(n) ? xC(n, Bv(e, 1, qs), mC(t)) : [];
}), kC = "[object RegExp]";
function EC(n) {
  return Jt(n) && wn(n) == kC;
}
var Au = fo && fo.isRegExp, AC = Au ? fc(Au) : EC, OC = Fg("length"), jg = "\\ud800-\\udfff", TC = "\\u0300-\\u036f", MC = "\\ufe20-\\ufe2f", NC = "\\u20d0-\\u20ff", IC = TC + MC + NC, RC = "\\ufe0e\\ufe0f", DC = "[" + jg + "]", ra = "[" + IC + "]", ia = "\\ud83c[\\udffb-\\udfff]", $C = "(?:" + ra + "|" + ia + ")", Vg = "[^" + jg + "]", Wg = "(?:\\ud83c[\\udde6-\\uddff]){2}", Ug = "[\\ud800-\\udbff][\\udc00-\\udfff]", PC = "\\u200d", Hg = $C + "?", Jg = "[" + RC + "]?", _C = "(?:" + PC + "(?:" + [Vg, Wg, Ug].join("|") + ")" + Jg + Hg + ")*", LC = Jg + Hg + _C, BC = "(?:" + [Vg + ra + "?", ra, Wg, Ug, DC].join("|") + ")", Ou = RegExp(ia + "(?=" + ia + ")|" + BC + LC, "g");
function zC(n) {
...
function DR(n, e, t) {
  ...
  return Gt(t) && (r = "leading" in t ? !!t.leading : r, i = "trailing" in t ? !!t.trailing : i), SC(n, e, {
    leading: r,
    maxWait: e,
    trailing: i
  });
...
function $R(n, e) {
  ...
  if (Gt(e)) {
    ...
    t = "length" in e ? Dw(e.length) : t, r = "omission" in e ? co(e.omission) : r;
  }
  n = Xl(n);
  var o = n.length;
  if (dc(n)) {
  ...
  if (l < 1)
    return r;
  var a = s ? Fv(s, 0, l).join("") : n.slice(0, l);
  if (i === void 0)
    return a + r;
  if (s && (l += a.length - l), AC(i)) {
    if (n.slice(l).search(i)) {
      var c, f = a;
      for (i.global || (i = RegExp(i.source, Xl(UC.exec(i)) + "g")), i.lastIndex = 0; c = i.exec(f); )
        var u = c.index;
      a = a.slice(0, u === void 0 ? l : u);
    }
  } else if (n.indexOf(co(i), l) != l) {
...
const Ke = () => /* @__PURE__ */ new Map(), oa = (n) => {
  ...
  for (const [t, r] of n)
    if (e(r, t))
      return !0;
  return !1;
}, Hn = () => /* @__PURE__ */ new Set(), Ys = (n) => n[n.length - 1], Jn = Array.from, GC = Array.isArray;
class KC {
  constructor() {
    this._observers = Ke();
  }
...
const mn = Math.floor, Di = Math.abs, Gg = (n, e) => n < e ? n : e, rr = (n, e) => n > e ? n : e, qC = (n) => n !== 0 ? n < 0 : 1 / n < 0, Tu = 1, Mu = 2, Xs = 4, Qs = 8, YC = 32, Kg = 64, uo = 128, XC = 31, Nu = 63, Ar = 127, QC = 2147483647, ZC = Number.isInteger || ((n) => typeof n == "number" && isFinite(n) && mn(n) === n), ek = (n) => n.toLowerCase(), tk = /^\s*/g, nk = (n) => n.replace(tk, ""), rk = /([A-Z])/g, Iu = (n, e) => nk(n.replace(rk, (t) => `${e}${ek(t)}`)), ik = (n) => {
...
const gc = () => new li(), lk = (n) => {
  let e = n.cpos;
  for (let t = 0; t < n.bufs.length; t++)
    e += n.bufs[t].length;
  return e;
}, gt = (n) => {
  const e = new Uint8Array(lk(n));
  let t = 0;
  ...
  for (; e > Ar; )
    q(n, uo | Ar & e), e = mn(e / 128);
  q(n, Ar & e);
}, mc = (n, e) => {
  const t = qC(e);
  for (t && (e = -e), q(n, (e > Nu ? uo : 0) | (t ? Kg : 0) | Nu & e), e = mn(e / 64); e > 0; )
    q(n, (e > Ar ? uo : 0) | Ar & e), e = mn(e / 128);
}, la = new Uint8Array(3e4), ck = la.length / 3, fk = (n, e) => {
  if (e.length < ck) {
...
Ur.encodeInto ? fk : uk, yc = (n, e) => {
  const t = n.cbuf.length, r = n.cpos, i = Gg(t - r, e.length), o = e.length - i;
  ...
  return n.cpos += e, t;
}, hk = (n, e) => bc(n, 4).setFloat32(0, e, !1), dk = (n, e) => bc(n, 8).setFloat64(0, e, !1), pk = (n, e) => (
  /** @type {any} */
  bc(n, 8).setBigInt64(0, e, !1)
), Ru = new DataView(new ArrayBuffer(4)), gk = (n) => (Ru.setFloat32(0, n), Ru.getFloat32(0) === n), Hr = (n, e) => {
  switch (typeof e) {
    case "string":
      q(n, 119), zn(n, e);
      break;
    case "number":
      ZC(e) && Di(e) <= QC ? (q(n, 125), mc(n, e)) : gk(e) ? (q(n, 124), hk(n, e)) : (q(n, 123), dk(n, e));
      break;
    case "bigint":
      q(n, 122), pk(n, e);
      break;
...
}, yk = crypto.getRandomValues.bind(crypto), qg = () => yk(new Uint32Array(1))[0], bk = "10000000-1000-4000-8000" + -1e11, wk = () => bk.replace(
  /[018]/g,
  /** @param {number} c */
  (n) => (n ^ qg() & 15 >> n / 4).toString(16)
), _u = (n) => (
  /** @type {Promise<T>} */
  new Promise(n)
);
...
let Yg = new Sk(), vk = !0;
try {
  typeof localStorage < "u" && localStorage && (Yg = localStorage, vk = !1);
} catch {
}
const xk = Yg, Ck = Object.assign, kk = Object.keys, Ek = (n, e) => {
  for (const t in n)
    e(n[t], t);
}, Bu = (n) => kk(n).length, Ak = (n) => {
  for (const e in n)
    return !1;
  return !0;
}, Ok = (n, e) => {
  for (const t in n)
    if (!e(n[t], t))
      return !1;
  return !0;
}, Tk = (n, e) => Object.prototype.hasOwnProperty.call(n, e), Mk = (n, e) => n === e || Bu(n) === Bu(e) && Ok(n, (t, r) => (t !== void 0 || Tk(e, r)) && e[r] === t), Nk = Object.freeze, Xg = (n) => {
  for (const e in n) {
    const t = n[e];
    (typeof t == "object" || typeof t == "function") && Xg(n[e]);
  }
  return Nk(n);
}, wc = (n, e, t = 0) => {
  try {
...
}, Ik = (n, e) => e.includes(n), Jr = typeof process < "u" && process.release && /node|io\.js/.test(process.release.name) && Object.prototype.toString.call(typeof process < "u" ? process : 0) === "[object process]";
let ze;
const Rk = () => {
  if (ze === void 0)
    if (Jr) {
  ...
  return ze;
}, aa = (n) => Rk().has(n), ho = (n) => Lu(Jr ? process.env[n.toUpperCase().replaceAll("-", "_")] : xk.getItem(n)), Qg = (n) => aa("--" + n) || ho(n) !== null;
Qg("production");
const Dk = Jr && Ik(process.env.FORCE_COLOR, ["true", "1", "2"]), $k = Dk || !aa("--no-colors") && // @todo deprecate --no-colors
!Qg("no-color") && (!Jr || process.stdout.isTTY) && (!Jr || aa("--color") || ho("COLORTERM") !== null || (ho("TERM") || "").includes("color"));
class Pk {
  /**
   * @param {L} left
   * @param {R} right
...
const ft = (n, e) => new Pk(n, e);
typeof DOMParser < "u" && new DOMParser();
const _k = (n) => HC(n, (e, t) => `${t}:${e};`).join(""), xt = Symbol, Zg = xt(), em = xt(), Lk = xt(), Bk = xt(), zk = xt(), tm = xt(), Fk = xt(), Sc = xt(), jk = xt(), Vk = (n) => {
  var i;
  ...
  [Zg]: ft("font-weight", "bold"),
  [em]: ft("font-weight", "normal"),
  [Lk]: ft("color", "blue"),
  [zk]: ft("color", "green"),
  [Bk]: ft("color", "grey"),
  [tm]: ft("color", "red"),
  ...
  console.log(...nm(n)), rm.forEach((e) => e.print(n));
}, Jk = (...n) => {
  console.warn(...nm(n)), n.unshift(Sc), rm.forEach((e) => e.print(n));
}, rm = Hn(), im = (n) => ({
  /**
...
const om = (n, e, t) => e.clients.forEach((r, i) => {
  const o = (
    /** @type {Array<GC|Item>} */
  ...
  return t !== void 0 && Yk(t, e.clock) !== null;
}, lm = (n) => {
  n.clients.forEach((e) => {
...
class ai extends KC {
   ...
   */
  constructor({ guid: e = wk(), collectionid: t = null, gc: r = !0, gcFilter: i = () => !0, meta: o = null, autoLoad: s = !1, shouldLoad: l = !0 } = {}) {
    super(), this.gc = r, this.gcFilter = i, this.clientID = cm(), this.guid = e, this.collectionid = t, this.share = /* @__PURE__ */ new Map(), this.store = new sE(), this._transaction = null, this._transactionCleanups = [], this.subdocs = /* @__PURE__ */ new Set(), this._item = null, this.shouldLoad = l, this.autoLoad = s, this.meta = o, this.isLoaded = !1, this.isSynced = !1, this.isDestroyed = !1, this.whenLoaded = _u((c) => {
      this.on("load", () => {
...
class tE extends eE {
  constructor() {
    super(), this.keyMap = /* @__PURE__ */ new Map(), this.keyClock = 0, this.keyClockEncoder = new el(), this.clientEncoder = new $i(), this.leftClockEncoder = new el(), this.rightClockEncoder = new el(), this.infoEncoder = new Du(sa), this.stringEncoder = new mk(), this.parentInfoEncoder = new Du(sa), this.typeRefEncoder = new $i(), this.lenEncoder = new $i();
  }
  toUint8Array() {
    const e = gc();
...
}, iE = (n, e) => rE(n, e.doc.store, e.beforeState);
class oE {
  constructor() {
    this.l = [];
  }
}
const zu = () => new oE(), Fu = (n, e) => n.l.push(e), ju = (n, e) => {
...
const mi = (n, e, t) => {
  let r = null, i = null;
  return n._item === null ? i = Gr(n) : r = j(n._item.id.client, n._item.id.clock), new po(r, i, e, t);
}, nl = (n, e, t = 0) => {
  let r = n._start;
  if (t < 0) {
    if (e === 0)
  ...
  return mi(n, null, t);
}, In = (n, e) => e === void 0 ? !n.deleted : e.sv.has(n.id.client) && (e.sv.get(n.id.client) || 0) > n.id.clock && !sm(e.ds, n.id), ca = (n, e) => {
...
const vc = (n) => {
  ...
  return i.id.clock < t && i instanceof Ce ? (e.splice(r + 1, 0, Nm(n, i, t - i.id.clock)), r + 1) : r;
}, qt = (n, e) => {
  const t = (
    /** @type {Array<Item>} */
  ...
  return t.clock !== o.id.clock + o.length - 1 && o.constructor !== $t && r.splice(i + 1, 0, Nm(n, o, t.clock - o.id.clock + 1)), o;
}, aE = (n, e, t) => {
  const r = (
    /** @type {Array<GC|Item>} */
...
class cE {
   ...
   */
  constructor(e, t, r) {
    this.doc = e, this.deleteSet = new qk(), this.beforeState = vc(e.store), this.afterState = /* @__PURE__ */ new Map(), this.changed = /* @__PURE__ */ new Map(), this.changedParentTypes = /* @__PURE__ */ new Map(), this._mergeStructs = [], this.origin = t, this.meta = /* @__PURE__ */ new Map(), this.local = r, this.subdocsAdded = /* @__PURE__ */ new Set(), this.subdocsRemoved = /* @__PURE__ */ new Set(), this.subdocsLoaded = /* @__PURE__ */ new Set(), this._needFormattingCleanup = !1;
  }
}
const Wu = (n, e) => e.deleteSet.clients.size === 0 && !JC(e.afterState, (t, r) => e.beforeState.get(r) !== t) ? !1 : (lm(e.deleteSet), iE(n, e), Xk(n, e.deleteSet), !0), Uu = (n, e, t) => {
  const r = e._item;
  ...
  n.clients.forEach((t, r) => {
    ...
    for (let o = t.length - 1; o >= 0; o--) {
      const s = t[o], l = Gg(i.length - 1, 1 + bt(i, s.clock + s.len - 1));
  ...
  if (e < n.length) {
    ...
    try {
      lm(o), t.afterState = vc(t.doc.store), r.emit("beforeObserverCalls", [t, r]);
      const l = [];
      t.changed.forEach(
        (a, c) => l.push(() => {
        ...
        t.changedParentTypes.forEach((a, c) => {
          ...
          }), a.sort((f, u) => f.path.length - u.path.length), fm(c._dEH, a, t));
        });
      }), l.push(() => r.emit("afterTransaction", [t, r])), wc(l, []), t._needFormattingCleanup && CE(t);
    } finally {
      r.gc && fE(o, i, r.gcFilter), uE(o, i), t.afterState.forEach((f, u) => {
      ...
      if (!t.local && t.afterState.get(r.clientID) !== t.beforeState.get(r.clientID) && (Hk(Sc, Zg, "[yjs] ", em, tm, "Changed the client-id because another client seems to be using it."), r.clientID = cm()), r.emit("afterTransactionCleanup", [t, r]), r._observers.has("update")) {
        const f = new Zk();
      ...
      }), c.forEach((f) => r.subdocs.delete(f)), r.emit("subdocs", [{ loaded: a, added: l, removed: c }, r, t]), c.forEach((f) => f.destroy())), n.length <= e + 1 ? (r._transactionCleanups = [], r.emit("afterAllTransactions", [r, n])) : dm(n, e + 1);
    }
  }
}, F = (n, e, t = null, r = !0) => {
  const i = n._transactionCleanups;
  let o = !1, s = null;
  n._transaction === null && (o = !0, n._transaction = new cE(n, t, r), i.push(n._transaction), i.length === 1 && n.emit("beforeAllTransactions", [n]), n.emit("beforeTransaction", [n._transaction, n]));
  try {
    s = e(n._transaction);
  } finally {
    if (o) {
      const l = n._transaction === i[0];
      n._transaction = null, l && dm(i, 0);
    }
  }
  return s;
...
class vs {
   ...
   */
  get path() {
    return this._path || (this._path = hE(this.currentTarget, this.target));
  }
  /**
   ...
   */
  deletes(e) {
    return sm(this.transaction.deleteSet, e.id);
  }
  /**
          ...
          if (this.adds(o)) {
            ...
            if (this.deletes(o))
              if (a !== null && this.deletes(a))
                s = "delete", l = Ys(a.content.getContent());
              else
                return;
            else
              a !== null && this.deletes(a) ? (s = "update", l = Ys(a.content.getContent())) : (s = "add", l = void 0);
...
const hE = (n, e) => {
  ...
  Jk("Invalid access: Add Yjs type to a document before reading data.");
}, pm = 80;
let xc = 0;
class dE {
  /**
...
const pE = (n) => {
  ...
  let r = n._start, i = 0;
  for (t !== null && (r = t.p, i = t.index, pE(t)); r.right !== null && i < e; ) {
    if (!r.deleted && r.countable) {
      if (e < i + r.length)
        break;
      i += r.length;
  ...
  r.parent.length / pm ? (gm(t, r, i), t) : gE(n._searchMarker, r, i);
}, Kr = (n, e, t) => {
...
const mm = (n, e, t) => {
      ...
      switch (u.constructor) {
        ...
        default:
          switch (f(), u.constructor) {
            case Uint8Array:
            case ArrayBuffer:
              i = new Ce(j(s, ye(l, s)), i, i && i.lastId, a, a && a.id, e, null, new ks(new Uint8Array(
                /** @type {Uint8Array} */
                u
              ))), i.integrate(n, 0);
              break;
            case ai:
              i = new Ce(j(s, ye(l, s)), i, i && i.lastId, a, a && a.id, e, null, new Es(
                /** @type {Doc} */
                u
              )), i.integrate(n, 0);
              break;
...
}, Sm = () => Gn("Length exceeded!"), vm = (n, e, t, r) => {
  if (t > e._length)
    throw Sm();
  if (t === 0)
    return e._searchMarker && Kr(e._searchMarker, t, r.length), go(n, e, null, r);
  const i = t, o = xs(e, t);
  let s = e._start;
  ...
  return e._searchMarker && Kr(e._searchMarker, i, r.length), go(n, e, s, r);
}, yE = (n, e, t) => {
...
class Or extends ie {
   ...
   */
  _callObserver(e, t) {
    super._callObserver(e, t), Cs(this, e, new wE(this, e));
  }
  /**
...
const Ft = (n, e) => n === e || typeof n == "object" && typeof e == "object" && n && e && Mk(n, e);
class ua {
  /**
...
const Ju = (n, e, t) => {
  ...
  const i = /* @__PURE__ */ new Map(), o = r ? xs(e, t) : null;
  if (o) {
  ...
  Am(t, i);
  const l = Om(n, e, t, i), a = r.constructor === String ? new wt(
    /** @type {string} */
    r
  ) : r instanceof ie ? new Xt(r) : new or(r);
  let { left: c, right: f, index: u } = t;
  e._searchMarker && Kr(e._searchMarker, t.index, a.getLength()), f = new Ce(j(s, ye(o.store, s)), c, c && c.lastId, f, f && f.id, e, null, a), f.integrate(n, 0), t.right = f, t.index = u, t.forward(), Em(n, e, t, l);
}, Gu = (n, e, t, r, i) => {
  const o = n.doc, s = o.clientID;
  Am(t, i);
  const l = Om(n, e, t, i);
...
`;
  ...
  F(t, (r) => {
    om(n, n.deleteSet, (i) => {
      ...
      i.content.constructor === Q ? e.add(o) : vE(r, i);
    });
    for (const i of e)
      xE(i);
  });
  ...
  o && Tm(n, o, e.right, i, e.currentAttributes);
  const s = (
    /** @type {AbstractType<any>} */
    /** @type {Item} */
          ...
          if (l !== null) {
            ...
            switch (l) {
              ...
              case "insert":
                ...
                break;
              case "retain":
                f > 0 && (d = { retain: f }, Ak(a) || (d.attributes = Ck({}, a))), f = 0;
                break;
            }
            d && t.push(d), l = null;
          }
...
class Yr extends ie {
  ...
  _callObserver(e, t) {
    ...
    const r = new kE(this, e, t);
    Cs(this, e, r), !e.local && this._hasFormatting && (e._needFormattingCleanup = !0);
  }
  /**
...
` ? s.insert.slice(0, -1) : s.insert;
          (typeof l != "string" || l.length > 0) && il(r, this, i, l, s.attributes || {});
...
class Kn extends ie {
  ...
  querySelector(e) {
    e = e.toUpperCase();
    const r = new ol(this, (i) => i.nodeName && i.nodeName.toUpperCase() === e).next();
   ...
   */
  querySelectorAll(e) {
    return e = e.toUpperCase(), Jn(new ol(this, (t) => t.nodeName && t.nodeName.toUpperCase() === e));
  }
  /**
   ...
   */
  toString() {
    return bm(this, (e) => e.toString()).join("");
  }
  /**
   * @return {string}
   */
...
class Xr extends Kn {
   ...
   */
  _write(e) {
    e.writeTypeRef(RE), e.writeKey(this.nodeName);
  }
}
class EE extends vs {
  /**
...
class $t extends Mm {
   ...
   */
  integrate(e, t) {
    t > 0 && (this.id.clock += t, this.length -= t), um(e.doc.store, this);
  }
  /**
   * @param {UpdateEncoderV1 | UpdateEncoderV2} encoder
   * @param {number} offset
   */
  write(e, t) {
    e.writeInfo(AE), e.writeLen(this.length - t);
  }
  /**
   * @param {Transaction} transaction
...
class bo {
   ...
   */
  integrate(e, t) {
    am(e.deleteSet, t.id.client, t.id.clock, this.len), t.markDeleted();
  }
  /**
   * @param {Transaction} transaction
   */
...
const OE = (n, e) => new ai({ guid: n, ...e, shouldLoad: e.shouldLoad || e.autoLoad || !1 });
class Es {
  /**
   * @param {Doc} doc
   */
   ...
   */
  copy() {
    return new Es(OE(this.doc.guid, this.opts));
  }
  /**
   * @param {number} offset
   * @return {ContentDoc}
...
const TE = ho("node_env") === "development";
class qn {
  /**
   * @param {Array<any>} arr
   */
...
const ME = 0, NE = 1, IE = 2, RE = 3, DE = 4, $E = 6;
class Xt {
  /**
...
let Ce = class ha extends Mm {
  ...
  integrate(e, t) {
    if (t > 0 && (this.id.clock += t, this.left = Vu(e, e.doc.store, j(this.id.client, this.id.clock - 1)), this.origin = this.left.lastId, this.content = this.content.splice(t), this.length -= t), this.parent) {
        ...
        for (; i !== null && i !== this.right; ) {
          if (s.add(i), o.add(i), gi(this.origin, i.origin)) {
            if (i.id.client < this.id.client)
              ...
              break;
          } else if (i.origin !== null && s.has(rl(e.doc.store, i.origin)))
            o.has(rl(e.doc.store, i.origin)) || (r = i, o.clear());
          else
            break;
          i = i.right;
        }
      ...
      this.right !== null ? this.right.left = this : this.parentSub !== null && (this.parent._map.set(this.parentSub, this), this.left !== null && this.left.delete(e)), this.parentSub === null && this.countable && !this.deleted && (this.parent._length += this.length), um(e.doc.store, this), this.content.integrate(e, this), Uu(
        e,
        /** @type {AbstractType<any>} */
        this.parent,
        this.parentSub
  ...
  delete(e) {
    if (!this.deleted) {
      ...
      this.countable && this.parentSub === null && (t._length -= this.length), this.markDeleted(), am(e.deleteSet, this.id.client, this.id.clock, this.length), Uu(e, t, this.parentSub), this.content.delete(e);
    }
  }
  /**
   * @param {StructStore} store
  ...
  gc(e, t) {
    if (!this.deleted)
      throw Kt();
    this.content.gc(e), t ? aE(e, this, new $t(this.id, this.length)) : this.content = new bo(this.length);
  }
  /**
   * Transform the properties of this type to binary and write it to an
   * BinaryEncoder.
   ...
   */
  write(e, t) {
    const r = t > 0 ? j(this.id.client, this.id.clock + t - 1) : this.origin, i = this.rightOrigin, o = this.parentSub, s = this.content.getRef() & XC | (r === null ? 0 : uo) | // origin is defined
    (i === null ? 0 : Kg) | // right origin is defined
    (o === null ? 0 : YC);
...
Im[Rm] === !0 && console.error("Yjs was already imported. This breaks constructor checks and will lead to issues! - https://github.com/yjs/yjs/issues/438");
Im[Rm] = !0;
const PE = new et("y-sync");
new et("y-undo");
new et("yjs-cursor");
const _E = (n, e, t) => {
  if (n === 0)
  ...
  for (; r !== null && e !== r; ) {
    if (r instanceof Qr) {
      ...
      if (r._first !== null && n < i)
        ...
        if (n === 1 && r._length === 0 && i > 1)
          return new po(r._item === null ? null : r._item.id, r._item === null ? Gr(r) : null, null);
        if (n -= i, r._item !== null && r._item.next !== null)
          r = /** @type {Y.ContentType} */
          r._item.next.content.type;
        else {
          if (n === 0)
            return r = r._item === null ? r : r._item.parent, new po(r._item === null ? null : r._item.id, r._item === null ? Gr(r) : null, null);
          do
            r = /** @type {Y.Item} */
            r._item.parent, n--;
    ...
    if (n === 0 && r.constructor !== Qr && r !== e)
      return LE(r._item.parent, r._item);
  }
  return nl(e, e._length, -1);
}, LE = (n, e) => {
  let t = null, r = null;
  return n._item === null ? r = Gr(n) : t = j(n._item.id.client, n._item.id.clock), new po(t, r, e.id);
};
function Ec(n, e, t) {
  const r = [], i = n.node(0);
...
function FE(n, e) {
  const { doc: t } = e.view.state, r = Dm({ editor: e, x: n.clientX, y: n.clientY, direction: "right" });
  ...
  const i = n.clientX, o = function(f, u, h) {
    ...
    return { left: zE(u, y.left + d + g, y.right - p - m), top: h };
...
const Yu = (n, e) => {
  ...
  const t = PE.getState(n);
  return t ? _E(e, t.type, t.binding.mapping) : null;
}, Qu = (n, e) => {
  let t = e;
  for (; t && t.parentNode && t.parentNode !== n.dom; )
    t = t.parentNode;
  return t;
}, jE = new et("dragHandle"), PR = ({ pluginKey: n = jE, element: e, editor: t, tippyOptions: r, onNodeChange: i }) => {
  ...
  return e.addEventListener("dragstart", (f) => {
    ...
    if (!f.dataTransfer)
      return;
    const { empty: h, $from: d, $to: p } = u.state.selection, g = FE(f, t), m = Ec(d, p, 0), y = m.some((C) => g.find((U) => U.$from === C.$from && U.$to === C.$to)), v = h || !y ? g : m;
    if (!v.length)
      return;
    ...
    v.forEach((C) => {
      const U = BE(u.nodeDOM(C.$from.pos));
      A.append(U);
    ...
    view: (f) => {
      var u;
      return e.draggable = !0, e.style.pointerEvents = "auto", (u = t.view.dom.parentElement) === null || u === void 0 || u.appendChild(o), o.appendChild(e), o.style.pointerEvents = "none", o.style.position = "absolute", o.style.top = "0", o.style.left = "0", s = Xy(f.dom, {
        ...
        update(h, d) {
          ...
          if (m !== a) {
            ...
            a = m, c = y, sl(f.state, c), i == null || i({ editor: t, node: a, pos: c }), s.setProps({ getReferenceClientRect: () => p.getBoundingClientRect() }), s.show();
          }
        },
        destroy() {
    ...
    props: {
      handleDOMEvents: {
        ...
        mousemove(f, u) {
          if (!e || !s || l)
            return !1;
          const h = Dm({ x: u.clientX, y: u.clientY, direction: "right", editor: t });
          if (!h.resultElement)
            return !1;
          ...
          if (g !== a) {
            ...
            a = g, c = m, sl(f.state, c), i == null || i({ editor: t, node: a, pos: c }), s.setProps({ getReferenceClientRect: () => d.getBoundingClientRect() }), s.show();
          }
          return !1;
        }
      }
...
function $m(n) {
  var e, t, r = "";
  if (typeof n == "string" || typeof n == "number") r += n;
  else if (typeof n == "object") if (Array.isArray(n)) for (e = 0; e < n.length; e++) n[e] && (t = $m(n[e])) && (r && (r += " "), r += t);
  else for (e in n) n[e] && (r && (r += " "), r += e);
  return r;
}
function VE() {
  for (var n, e, t = 0, r = ""; t < arguments.length; ) (n = arguments[t++]) && (e = $m(n)) && (r && (r += " "), r += e);
  return r;
}
const Zu = (n) => typeof n == "boolean" ? "".concat(n) : n === 0 ? "0" : n, eh = VE, _R = (n, e) => (t) => {
  var r;
...
}, WE = "ö", UE = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", Yn = (n, e) => {
  for (const t in e)
    n[t] = e[t];
  return n;
}, da = "numeric", pa = "ascii", ga = "alpha", Li = "asciinumeric", Si = "alphanumeric", ma = "domain", Pm = "emoji", HE = "scheme", JE = "slashscheme", th = "whitespace";
function GE(n, e) {
  return n in e || (e[n] = []), e[n];
}
function rn(n, e, t) {
  e[da] && (e[Li] = !0, e[Si] = !0), e[pa] && (e[Li] = !0, e[ga] = !0), e[Li] && (e[Si] = !0), e[ga] && (e[Si] = !0), e[Si] && (e[ma] = !0), e[Pm] && (e[ma] = !0);
  for (const r in e) {
    const i = GE(r, t);
...
const I = (n, e, t, r, i) => n.ta(e, t, r, i), Ae = (n, e, t, r, i) => n.tr(e, t, r, i), nh = (n, e, t, r, i) => n.ts(e, t, r, i), w = (n, e, t, r, i) => n.tt(e, t, r, i), ht = "WORD", ya = "UWORD", Zr = "LOCALHOST", ba = "TLD", wa = "UTLD", Bi = "SCHEME", Rn = "SLASH_SCHEME", Oc = "NUM", _m = "WS", Tc = "NL", Tr = "OPENBRACE", Mr = "CLOSEBRACE", wo = "OPENBRACKET", So = "CLOSEBRACKET", vo = "OPENPAREN", xo = "CLOSEPAREN", Co = "OPENANGLEBRACKET", ko = "CLOSEANGLEBRACKET", Eo = "FULLWIDTHLEFTPAREN", Ao = "FULLWIDTHRIGHTPAREN", Oo = "LEFTCORNERBRACKET", To = "RIGHTCORNERBRACKET", Mo = "LEFTWHITECORNERBRACKET", No = "RIGHTWHITECORNERBRACKET", Io = "FULLWIDTHLESSTHAN", Ro = "FULLWIDTHGREATERTHAN", Do = "AMPERSAND", $o = "APOSTROPHE", Po = "ASTERISK", Nt = "AT", _o = "BACKSLASH", Lo = "BACKTICK", Bo = "CARET", Pt = "COLON", Mc = "COMMA", zo = "DOLLAR", Fe = "DOT", Fo = "EQUALS", Nc = "EXCLAMATION", je = "HYPHEN", jo = "PERCENT", Vo = "PIPE", Wo = "PLUS", Uo = "POUND", Ho = "QUERY", Ic = "QUOTE", Rc = "SEMI", Ve = "SLASH", Nr = "TILDE", Jo = "UNDERSCORE", Lm = "EMOJI", Go = "SYM";
...
const An = /[a-z]/, ll = new RegExp("\\p{L}", "u"), al = new RegExp("\\p{Emoji}", "u"), cl = /\d/, rh = /\s/, ih = `
`, qE = "️", YE = "‍";
let vi = null, xi = null;
function XE(n) {
  n === void 0 && (n = []);
  ...
  me.groups = e;
  const t = new me();
  vi == null && (vi = oh(WE)), xi == null && (xi = oh(UE)), w(t, "'", $o), w(t, "{", Tr), w(t, "}", Mr), w(t, "[", wo), w(t, "]", So), w(t, "(", vo), w(t, ")", xo), w(t, "<", Co), w(t, ">", ko), w(t, "（", Eo), w(t, "）", Ao), w(t, "「", Oo), w(t, "」", To), w(t, "『", Mo), w(t, "』", No), w(t, "＜", Io), w(t, "＞", Ro), w(t, "&", Do), w(t, "*", Po), w(t, "@", Nt), w(t, "`", Lo), w(t, "^", Bo), w(t, ":", Pt), w(t, ",", Mc), w(t, "$", zo), w(t, ".", Fe), w(t, "=", Fo), w(t, "!", Nc), w(t, "-", je), w(t, "%", jo), w(t, "|", Vo), w(t, "+", Wo), w(t, "#", Uo), w(t, "?", Ho), w(t, '"', Ic), w(t, "/", Ve), w(t, ";", Rc), w(t, "~", Nr), w(t, "_", Jo), w(t, "\\", _o);
  const r = Ae(t, cl, Oc, {
    [da]: !0
  });
  Ae(r, cl, r);
  ...
  for (let u = 0; u < n.length; u++) {
    ...
    h.indexOf("-") >= 0 ? p[ma] = !0 : An.test(h) ? cl.test(h) ? p[Li] = !0 : p[pa] = !0 : p[da] = !0, nh(t, h, h, p);
  }
...
function QE(n, e) {
  const t = ZE(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = t.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
...
function tA(n) {
  ...
  const t = e.domain.concat([Do, Po, Nt, _o, Lo, Bo, zo, Fo, je, Oc, jo, Vo, Wo, Uo, Ve, Go, Nr, Jo]), r = [$o, Pt, Mc, Fe, Nc, Ho, Ic, Rc, Co, ko, Tr, Mr, So, wo, vo, xo, Eo, Ao, Oo, To, Mo, No, Io, Ro], i = [Do, $o, Po, _o, Lo, Bo, zo, Fo, je, Tr, Mr, jo, Vo, Wo, Uo, Ho, Ve, Go, Nr, Jo], o = Oe(), s = w(o, Nr);
...
function nA(n, e, t) {
  ...
  for (; i < r; ) {
    ...
    if (h < 0)
      ...
      s.length > 0 && (o.push(fl(ah, e, s)), s = []), i -= h, f -= h;
      const d = u.t, p = t.slice(i - f, i);
      o.push(fl(d, e, p));
    }
  }
  return s.length > 0 && o.push(fl(ah, e, s)), o;
}
function fl(n, e, t) {
  const r = t[0].s, i = t[t.length - 1].e, o = e.slice(r, i);
  return new n(o, t);
}
const rA = typeof console < "u" && console && console.warn || (() => {
}), iA = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", W = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function BR(n, e) {
  if (e === void 0 && (e = !1), W.initialized && rA(`linkifyjs: already initialized - will not register custom scheme "${n}" ${iA}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(n))
...
function oA() {
  W.scanner = XE(W.customSchemes);
  for (let n = 0; n < W.tokenQueue.length; n++)
    W.tokenQueue[n][1]({
      scanner: W.scanner
    });
  W.parser = tA(W.scanner.tokens);
...
function sA(n) {
  return W.initialized || oA(), nA(W.parser.start, n, QE(W.scanner.start, n));
}
function zR(n, e, t) {
...
var Ko = 200, X = function() {
};
X.prototype.append = function(e) {
  return e.length ? (e = X.from(e), !this.length && e || e.length < Ko && this.leafAppend(e) || this.length < Ko && e.leafPrepend(this) || this.appendInner(e)) : this;
};
...
X.from = function(e) {
  return e instanceof X ? e : e && e.length ? new Fm(e) : X.empty;
};
...
class $e {
  ...
  addTransform(e, t, r, i) {
    ...
    let c = s - r.depth;
    return c > fA && (l = cA(l, c), s -= c), new $e(l.append(o), s);
  }
  remapping(e, t) {
    let r = new Pn();
  ...
  rebased(e, t) {
    ...
    return u.emptyItemCount() > aA && (u = u.compress(this.items.length - r.length)), u;
  }
  emptyItemCount() {
    let e = 0;
...
function uA(n, e, t, r) {
  ...
  t.getMeta(pA) && (n = new It(n.done, n.undone, null, 0, -1));
  ...
  if (t.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = t.getMeta("composition"), a = n.prevTime == 0 || !s && n.prevComposition != l && (n.prevTime < (t.time || 0) - r.newGroupDelay || !hA(t, n.prevRanges)), c = s ? ul(n.prevRanges, t.mapping) : ch(t.mapping.maps);
    return new It(n.done.addTransform(t, a ? e.selection.getBookmark() : void 0, r, zi(e)), $e.empty, c, t.time, l ?? n.prevComposition);
  } else return (o = t.getMeta("rebased")) ? new It(n.done.rebased(t, o), n.undone.rebased(t, o), ul(n.prevRanges, t.mapping), n.prevTime, n.prevComposition) : new It(n.done.addMaps(t.mapping.maps), n.undone.addMaps(t.mapping.maps), ul(n.prevRanges, t.mapping), n.prevTime, n.prevComposition);
}
function hA(n, e) {
  if (!e)
    return !1;
...
const cn = new et("history"), pA = new et("closeHistory");
function FR(n = {}) {
  return n = {
    depth: n.depth || 100,
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, t) {
          let r = t.inputType, i = r == "historyUndo" ? gA : r == "historyRedo" ? mA : null;
  ...
  dragover(e) {
    ...
    if (t && !o) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = gp(this.editorView.state.doc, s, this.editorView.dragging.slice);
        l != null && (s = l);
      }
...
function AA(n, e, t) {
  ...
  for (let i = 0; i < n.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      u != null && (!a.colwidth || a.colwidth[c] != u) && ((l || (l = OA(a)))[c] = u);
    }
...
var V = class dt extends T {
  ...
  getBookmark() {
    return new RA(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
function _A(n, e, t) {
  ...
  } else r instanceof R && $A(r) ? o = R.create(i, r.from) : r instanceof R && PA(r) && (o = R.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = n.tr)).setSelection(o), e;
}
var LA = new et("fix-tables");
function Hm(n, e, t, r) {
  ...
  e:
    for (let s = 0, l = 0; s < o; s++) {
      ...
      r(a, t), l < i && n.child(l).sameMarkup(a) ? Hm(n.child(l), a, t + 1, r) : a.nodesBetween(0, a.content.size, r, t + 1), t += a.nodeSize;
    }
}
function BA(n, e) {
  let t;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (t = zA(n, i, o, t));
  };
  return e ? e.doc != n.doc && Hm(e.doc, n.doc, 0, r) : n.doc.descendants(r), t;
}
function zA(n, e, t, r) {
  const i = G.get(e);
  if (!i.problems)
  ...
  return r.setMeta(LA, { fixTables: !0 });
}
function nt(n) {
  const e = n.selection, t = Os(n), r = t.node(-1), i = t.start(-1), o = G.get(r);
  return { ...e instanceof V ? o.rectBetween(
    e.$anchorCell.pos - i,
    e.$headCell.pos - i
  ) : o.findCell(t.pos - i), tableStart: i, map: o, table: r };
}
function Jm(n, { map: e, tableStart: t, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  IA(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
...
function FA(n, { map: e, table: t, tableStart: r }, i) {
...
function HR(n, e) {
  ...
  if (e) {
    ...
    if (t.left == 0 && t.right == t.map.width)
      return !1;
    for (let i = t.right - 1; FA(r, t, i), i != t.left; i--) {
...
function Gm(n, { map: e, tableStart: t, table: r }, i) {
  ...
  const l = [];
  let a = i > 0 ? -1 : 0;
  jA(e, r, i + a) && (a = i == 0 || i == e.height ? null : 0);
...
function GR(n, e) {
  ...
  if (e) {
    const t = nt(n);
    e(Gm(n.tr, t, t.bottom));
  }
  return !0;
}
function VA(n, { map: e, table: t, tableStart: r }, i) {
  let o = 0;
  for (let c = 0; c < i; c++)
...
function KR(n, e) {
  ...
  if (e) {
    ...
    if (t.top == 0 && t.bottom == t.map.height)
      return !1;
    for (let i = t.bottom - 1; VA(r, t, i), i != t.top; i--) {
      const o = t.tableStart ? r.doc.nodeAt(t.tableStart - 1) : r.doc;
      if (!o)
        throw RangeError("No table found");
...
function WA({ width: n, height: e, map: t }, r) {
...
function YR(n, e) {
  const t = ae(n.schema);
  return UA(({ node: r }) => t[r.type.spec.tableRole])(n, e);
}
function UA(n) {
  return (e, t) => {
    var r;
...
function _c(n, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? HA(n) : function(t, r) {
    if (!Be(t))
      return !1;
    if (r) {
...
function ZR(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(
        e.tr.setSelection(R.between(i, NA(i))).scrollIntoView()
      );
    }
    return !0;
  };
...
function Ca(n, e) {
  ...
  return new Sp(t).replace(0, t.content.size, e).doc;
}
function qA({ width: n, height: e, rows: t }, r, i) {
  if (n != r) {
    const o = [], s = [];
...
function gh(n, e, t, r, i) {
  ...
  YA(u, s, o, t, c, f, h) && d(), dh(u, s, o, t, a, c, l, h) && d(), dh(u, s, o, t, a, c, f, h) && d(), ph(u, s, o, t, l, f, a, h) && d(), ph(u, s, o, t, l, f, c, h) && d();
  for (let p = l; p < f; p++) {
...
function Ai(n, e) {
  return (t, r, i) => {
    ...
    {
      const l = t.doc.resolve(s), a = Vm(l, n, e);
      let c;
...
function ZA(n, e, t) {
  ...
  if (i instanceof V) {
    ...
    return r = qA(r, l.right - l.left, l.bottom - l.top), gh(n.state, n.dispatch, s, l, r), !0;
  } else if (r) {
    const o = Os(n.state), s = o.start(-1);
    return gh(
      n.state,
      n.dispatch,
      s,
...
function eO(n, e) {
  ...
  else if (e.shiftKey && r && (i = sr(n.state.selection.$anchor)) != null && ((t = dl(n, e)) == null ? void 0 : t.pos) != i.pos)
  ...
  function l(a) {
    ...
    else if (mh(n, c.target) != r && (u = dl(n, e), !u))
      return s();
    u && o(u, c);
  }
  ...
  const o = new bn({
    ...
    state: {
      init(s, l) {
        ...
        return r && f && (f[u] = (h, d) => new r(h, t, d)), new nO(-1, !1);
      },
      apply(s, l) {
        return l.apply(s);
      }
...
function iO(n) {
  ...
  e && e.activeHandle > -1 && !e.dragging && qm(n, -1);
}
function oO(n, e, t, r) {
  var i;
  ...
  if (!s || s.activeHandle == -1 || s.dragging)
    return !1;
  const l = n.state.doc.nodeAt(s.activeHandle), a = sO(n, s.activeHandle, l.attrs);
  n.dispatch(
...
function sO(n, e, { colspan: t, colwidth: r }) {
...
function aO(n, e, t) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if (h.colwidth && h.colwidth[d] == t)
      continue;
    const p = h.colwidth ? h.colwidth.slice() : cO(h.colspan);
...
var Sh = Object.prototype.toString, Ym = function(e) {
...
function dO() {
  ...
  var n;
  if (!Object.keys) {
    var e = Object.prototype.hasOwnProperty, t = Object.prototype.toString, r = Ym, i = Object.prototype.propertyIsEnumerable, o = !i.call({ toString: null }, "toString"), s = i.call(function() {
    }, "prototype"), l = [
      "toString",
      "toLocaleString",
      "valueOf",
...
var pO = Array.prototype.slice, gO = Ym, xh = Object.keys, Vi = xh ? function(e) {
  return xh(e);
} : dO(), Ch = Object.keys;
Vi.shim = function() {
  if (Object.keys) {
    ...
    e || (Object.keys = function(r) {
      return gO(r) ? Ch(pO.call(r)) : Ch(r);
    });
  } else
    Object.keys = Vi;
  return Object.keys || Vi;
};
var Lc = Vi, mO = Error, yO = EvalError, bO = RangeError, wO = ReferenceError, Xm = SyntaxError, Qt = TypeError, SO = URIError, Ts = function() {
  ...
  return !0;
}, kh = typeof Symbol < "u" && Symbol, vO = Ts, Bc = function() {
  return typeof kh != "function" || typeof Symbol != "function" || typeof kh("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : vO();
}, gl = {
  __proto__: null,
  foo: {}
}, xO = Object, CO = function() {
  return { __proto__: gl }.foo === gl.foo && !(gl instanceof xO);
}, kO = "Function.prototype.bind called on incompatible ", EO = Object.prototype.toString, AO = Math.max, OO = "[object Function]", Eh = function(e, t) {
  ...
  var t = this;
  if (typeof t != "function" || EO.apply(t) !== OO)
    throw new TypeError(kO + t);
  for (var r = TO(arguments, 1), i, o = function() {
  ...
  }, s = AO(0, t.length - r.length), l = [], a = 0; a < s; a++)
    l[a] = "$" + a;
  if (i = Function("binder", "return function (" + MO(l, ",") + "){ return binder.apply(this,arguments); }")(o), t.prototype) {
    var c = function() {
    };
    c.prototype = t.prototype, i.prototype = new c(), c.prototype = null;
  }
  return i;
}, IO = NO, zc = Function.prototype.bind || IO, RO = Function.prototype.call, DO = Object.prototype.hasOwnProperty, $O = zc, Qm = $O.call(RO, DO), D, PO = mO, _O = yO, LO = bO, BO = wO, Xn = Xm, Fn = Qt, zO = SO, Zm = Function, ml = function(n) {
  try {
    return Zm('"use strict"; return (' + n + ").constructor;")();
  } catch {
  }
...
}() : yl, On = Bc(), jO = CO(), Y = Object.getPrototypeOf || (jO ? function(n) {
  return n.__proto__;
} : null), Dn = {}, VO = typeof Uint8Array > "u" || !Y ? D : Y(Uint8Array), un = {
  __proto__: null,
...
var UO = function n(e) {
...
}, ci = zc, Yo = Qm, HO = ci.call(Function.call, Array.prototype.concat), JO = ci.call(Function.apply, Array.prototype.splice), Oh = ci.call(Function.call, String.prototype.replace), Xo = ci.call(Function.call, String.prototype.slice), GO = ci.call(Function.call, RegExp.prototype.exec), KO = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, qO = /\\(\\)?/g, YO = function(e) {
  var t = Xo(e, 0, 1), r = Xo(e, -1);
  if (t === "%" && r !== "%")
    throw new Xn("invalid intrinsic syntax, expected closing `%`");
  if (r === "%" && t !== "%")
    throw new Xn("invalid intrinsic syntax, expected opening `%`");
  var i = [];
  return Oh(e, KO, function(o, s, l, a) {
    i[i.length] = l ? Oh(a, qO, "$1") : s || o;
  }), i;
}, XO = function(e, t) {
  var r = e, i;
  if (Yo(Ah, r) && (i = Ah[r], r = "%" + i[0] + "%"), Yo(un, r)) {
    var o = un[r];
    if (o === Dn && (o = UO(r)), typeof o > "u" && !t)
  ...
  var r = YO(e), i = r.length > 0 ? r[0] : "", o = XO("%" + i + "%", t), s = o.name, l = o.value, a = !1, c = o.alias;
  c && (i = c[0], JO(r, HO([0, 1], c)));
  for (var f = 1, u = !0; f < r.length; f += 1) {
    var h = r[f], d = Xo(h, 0, 1), p = Xo(h, -1);
    if ((d === '"' || d === "'" || d === "`" || p === '"' || p === "'" || p === "`") && d !== p)
      throw new Xn("property names with quotes must have matching quotes");
    if ((h === "constructor" || !u) && (a = !0), i += "." + h, s = "%" + i + "%", Yo(un, s))
      l = un[s];
    else if (l != null) {
      if (!(h in l)) {
        if (!t)
  ...
  return l;
}, QO = rt, Wi = QO("%Object.defineProperty%", !0) || !1;
if (Wi)
  try {
    Wi({}, "a", { value: 1 });
  } catch {
...
var Fc = Wi, ZO = rt, Ui = ZO("%Object.getOwnPropertyDescriptor%", !0);
if (Ui)
  try {
    Ui([], "length");
  } catch {
...
var jc = Ui, Th = Fc, eT = Xm, Tn = Qt, Mh = jc, Vc = function(e, t, r) {
  ...
  var i = arguments.length > 3 ? arguments[3] : null, o = arguments.length > 4 ? arguments[4] : null, s = arguments.length > 5 ? arguments[5] : null, l = arguments.length > 6 ? arguments[6] : !1, a = !!Mh && Mh(e, t);
  if (Th)
    Th(e, t, {
...
ey.hasArrayLengthDefineBug = function() {
  if (!Ea)
    return null;
  try {
...
var Wc = ey, tT = Lc, nT = typeof Symbol == "function" && typeof Symbol("foo") == "symbol", rT = Object.prototype.toString, iT = Array.prototype.concat, Nh = Vc, oT = function(n) {
  return typeof n == "function" && rT.call(n) === "[object Function]";
}, ty = Wc(), sT = function(n, e, t, r) {
  if (e in n) {
    if (r === !0) {
      if (n[e] === t)
        return;
...
ny.supportsDescriptors = !!ty;
var xn = ny, ry = { exports: {} }, lT = rt, Ih = Vc, aT = Wc(), Rh = jc, Dh = Qt, cT = lT("%Math.floor%"), fT = function(e, t) {
  if (typeof e != "function")
    throw new Dh("`fn` is not a function");
  if (typeof t != "number" || t < 0 || t > 4294967295 || cT(t) !== t)
    throw new Dh("`length` must be a positive 32-bit integer");
...
var lr = ry.exports, iy = rt, oy = lr, uT = oy(iy("String.prototype.indexOf")), Ie = function(e, t) {
  var r = iy(e, !!t);
  return typeof r == "function" && uT(e, ".prototype.") > -1 ? oy(r) : r;
}, hT = Lc, sy = Ts(), ly = Ie, $h = Object, dT = ly("Array.prototype.push"), Ph = ly("Object.prototype.propertyIsEnumerable"), pT = sy ? Object.getOwnPropertySymbols : null, ay = function(e, t) {
  if (e == null)
  ...
  for (var i = 1; i < arguments.length; ++i) {
    var o = $h(arguments[i]), s = hT(o), l = sy && (Object.getOwnPropertySymbols || pT);
    if (l)
...
}, ST = xn, vT = lr, xT = ay, fy = cy, CT = wT, kT = vT.apply(fy()), uy = function(e, t) {
...
var OT = ti, _h = Vc, TT = Wc(), MT = OT.functionsHaveConfigurableNames(), NT = Qt, IT = function(e, t) {
  if (typeof e != "function")
...
}, RT = IT, DT = Qt, $T = Object, hy = RT(function() {
...
}, "get flags", !0), PT = hy, _T = xn.supportsDescriptors, LT = Object.getOwnPropertyDescriptor, dy = function() {
  ...
  return PT;
}, BT = xn.supportsDescriptors, zT = dy, FT = Object.getOwnPropertyDescriptor, jT = Object.defineProperty, VT = TypeError, Lh = Object.getPrototypeOf, WT = /a/, UT = function() {
  if (!BT || !Lh)
    throw new VT("RegExp.prototype.flags requires a true ES5 environment that supports property descriptors");
  var e = zT(), t = Lh(WT), r = FT(t, "flags");
  return (!r || r.get !== e) && jT(t, "flags", {
    configurable: !0,
    enumerable: !1,
    get: e
  }), e;
}, HT = xn, JT = lr, GT = hy, py = dy, KT = UT, gy = JT(py());
HT(gy, {
  getPolyfill: py,
  implementation: GT,
  shim: KT
});
var qT = gy, Hi = { exports: {} }, YT = Ts, Cn = function() {
  return YT() && !!Symbol.toStringTag;
}, XT = Cn(), QT = Ie, Aa = QT("Object.prototype.toString"), Ms = function(e) {
  return XT && e && typeof e == "object" && Symbol.toStringTag in e ? !1 : Aa(e) === "[object Arguments]";
}, my = function(e) {
  return Ms(e) ? !0 : e !== null && typeof e == "object" && typeof e.length == "number" && e.length >= 0 && Aa(e) !== "[object Array]" && Aa(e.callee) === "[object Function]";
}, ZT = function() {
  return Ms(arguments);
}();
Ms.isLegacyArguments = my;
var yy = ZT ? Ms : my;
const eM = {}, tM = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: eM
}, Symbol.toStringTag, { value: "Module" })), nM = /* @__PURE__ */ hO(tM);
var Uc = typeof Map == "function" && Map.prototype, wl = Object.getOwnPropertyDescriptor && Uc ? Object.getOwnPropertyDescriptor(Map.prototype, "size") : null, Qo = Uc && wl && typeof wl.get == "function" ? wl.get : null, Bh = Uc && Map.prototype.forEach, Hc = typeof Set == "function" && Set.prototype, Sl = Object.getOwnPropertyDescriptor && Hc ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null, Zo = Hc && Sl && typeof Sl.get == "function" ? Sl.get : null, zh = Hc && Set.prototype.forEach, rM = typeof WeakMap == "function" && WeakMap.prototype, Rr = rM ? WeakMap.prototype.has : null, iM = typeof WeakSet == "function" && WeakSet.prototype, Dr = iM ? WeakSet.prototype.has : null, oM = typeof WeakRef == "function" && WeakRef.prototype, Fh = oM ? WeakRef.prototype.deref : null, sM = Boolean.prototype.valueOf, lM = Object.prototype.toString, aM = Function.prototype.toString, cM = String.prototype.match, Jc = String.prototype.slice, jt = String.prototype.replace, fM = String.prototype.toUpperCase, jh = String.prototype.toLowerCase, by = RegExp.prototype.test, Vh = Array.prototype.concat, He = Array.prototype.join, uM = Array.prototype.slice, Wh = Math.floor, Oa = typeof BigInt == "function" ? BigInt.prototype.valueOf : null, vl = Object.getOwnPropertySymbols, Ta = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Symbol.prototype.toString : null, Qn = typeof Symbol == "function" && typeof Symbol.iterator == "object", ce = typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === Qn || !0) ? Symbol.toStringTag : null, wy = Object.prototype.propertyIsEnumerable, Uh = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(n) {
  return n.__proto__;
} : null);
function Hh(n, e) {
  if (n === 1 / 0 || n === -1 / 0 || n !== n || n && n > -1e3 && n < 1e3 || by.call(/e/, e))
    return e;
...
var Ma = nM, Jh = Ma.custom, Gh = vy(Jh) ? Jh : null, hM = function n(e, t, r, i) {
  var o = t || {};
  ...
  if (OM(e)) {
    for (var m = "<" + jh.call(String(e.nodeName)), y = e.attributes || [], v = 0; v < y.length; v++)
      m += " " + y[v].name + "=" + Sy(dM(y[v].value), "double", o);
    return m += ">", e.childNodes && e.childNodes.length && (m += "..."), m += "</" + jh.call(String(e.nodeName)) + ">", m;
  }
  if (Na(e)) {
    if (e.length === 0)
      return "[]";
  ...
  if (gM(e)) {
    var A = Ti(e, h);
    return !("cause" in Error.prototype) && "cause" in e && !wy.call(e, "cause") ? "{ [" + String(e) + "] " + He.call(Vh.call("[cause]: " + h(e.cause), A), ", ") + " }" : A.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + He.call(A, ", ") + " }";
  }
  if (typeof e == "object" && s) {
    if (Gh && typeof e[Gh] == "function" && Ma)
  ...
  if (xM(e)) {
    var O = [];
    return Bh && Bh.call(e, function(we, ke) {
      O.push(h(ke, e, !0) + " => " + h(we, e));
    }), qh("Map", Qo.call(e), O, u);
  }
  if (EM(e)) {
    var x = [];
    return zh && zh.call(e, function(we) {
      x.push(h(we, e));
    }), qh("Set", Zo.call(e), x, u);
  }
  if (CM(e))
    return xl("WeakMap");
  if (AM(e))
  ...
  if (typeof globalThis < "u" && e === globalThis || typeof qo < "u" && e === qo)
    return "{ [object globalThis] }";
  if (!pM(e) && !Kh(e)) {
    var N = Ti(e, h), $ = Uh ? Uh(e) === Object.prototype : e instanceof Object || e.constructor === Object, C = e instanceof Object ? "" : "null prototype", U = !$ && ce && Object(e) === e && ce in e ? Jc.call(Zt(e), 8, -1) : C ? "Object" : "", ge = $ || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "", P = ge + (U || C ? "[" + He.call(Vh.call([], U || [], C || []), ": ") + "] " : "");
...
function Cy(n, e) {
  if (n.length > e.maxStringLength) {
    ...
    return Cy(Jc.call(n, 0, e.maxStringLength), e) + r;
  }
  var i = jt.call(jt.call(n, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, TM);
  return Sy(i, "single", e);
}
function TM(n) {
...
function Ti(n, e) {
  ...
  for (var a in n)
    Rt(n, a) && (t && String(Number(a)) === a && a < n.length || Qn && s["$" + a] instanceof Symbol || (by.call(/[^\w$]/, a) ? r.push(e(a, n) + ": " + e(n[a], n)) : r.push(a + ": " + e(n[a], n))));
  if (typeof vl == "function")
    for (var c = 0; c < o.length; c++)
      wy.call(n, o[c]) && r.push("[" + e(o[c]) + "]: " + e(n[o[c]], n));
  return r;
}
var ky = rt, ar = Ie, IM = hM, RM = Qt, Mi = ky("%WeakMap%", !0), Ni = ky("%Map%", !0), DM = ar("WeakMap.prototype.get", !0), $M = ar("WeakMap.prototype.set", !0), PM = ar("WeakMap.prototype.has", !0), _M = ar("Map.prototype.get", !0), LM = ar("Map.prototype.set", !0), BM = ar("Map.prototype.has", !0), Gc = function(n, e) {
...
var WM = Kc, mr = WM, UM = SyntaxError, Yh = typeof StopIteration == "object" ? StopIteration : null, HM = function(e) {
  if (!Yh)
...
}, JM = {}.toString, Ay = Array.isArray || function(n) {
...
}, qM = Object.prototype.toString, YM = "[object String]", XM = Cn(), Oy = function(e) {
  return typeof e == "string" ? !0 : typeof e != "object" ? !1 : XM ? KM(e) : qM.call(e) === YM;
}, qc = typeof Map == "function" && Map.prototype ? Map : null, QM = typeof Set == "function" && Set.prototype ? Set : null, es;
qc || (es = function(e) {
  return !1;
});
var Ty = qc ? Map.prototype.has : null, Xh = QM ? Set.prototype.has : null;
!es && !Ty && (es = function(e) {
  return !1;
});
var My = es || function(e) {
  ...
  return !1;
}, ZM = typeof Map == "function" && Map.prototype ? Map : null, Yc = typeof Set == "function" && Set.prototype ? Set : null, ts;
Yc || (ts = function(e) {
  return !1;
});
var Qh = ZM ? Map.prototype.has : null, Ny = Yc ? Set.prototype.has : null;
!ts && !Ny && (ts = function(e) {
  return !1;
});
var Iy = ts || function(e) {
  if (!e || typeof e != "object")
    return !1;
  try {
    if (Ny.call(e), Qh)
...
if (Bc() || Ts()) {
  ...
  var eN = Ay, tN = Oy, td = rt, nN = td("%Map%", !0), rN = td("%Set%", !0), Re = Ie, nd = Re("Array.prototype.push"), rd = Re("String.prototype.charCodeAt"), iN = Re("String.prototype.slice"), oN = function(e, t) {
    var r = e.length;
    if (t + 1 >= r)
      return t + 1;
    var i = rd(e, t);
  ...
  if (!nN && !rN)
    ...
    var sN = My, lN = Iy, od = Re("Map.prototype.forEach", !0), sd = Re("Set.prototype.forEach", !0);
    if (typeof process > "u" || !process.versions || !process.versions.node)
      var ld = Re("Map.prototype.iterator", !0), ad = Re("Set.prototype.iterator", !0);
    var cd = Re("Map.prototype.@@iterator", !0) || Re("Map.prototype._es6-shim iterator_", !0), fd = Re("Set.prototype.@@iterator", !0) || Re("Set.prototype._es6-shim iterator_", !0), aN = function(e) {
      if (sN(e)) {
        if (ld)
          return ed(ld(e));
        if (cd)
...
var cN = Hi.exports, ud = function(n) {
  return n !== n;
}, Ry = function(e, t) {
  return e === 0 && t === 0 ? 1 / e === 1 / t : !!(e === t || ud(e) && ud(t));
}, fN = Ry, Dy = function() {
  return typeof Object.is == "function" ? Object.is : fN;
}, uN = Dy, hN = xn, dN = function() {
  var e = uN();
...
}, pN = xn, gN = lr, mN = Ry, $y = Dy, yN = dN, Py = gN($y(), Object);
pN(Py, {
  getPolyfill: $y,
  implementation: mN,
  shim: yN
});
var bN = Py, wN = lr, _y = Ie, SN = rt, Ra = SN("%ArrayBuffer%", !0), Ji = _y("ArrayBuffer.prototype.byteLength", !0), vN = _y("Object.prototype.toString"), hd = !!Ra && !Ji && new Ra(0).slice, dd = !!hd && wN(hd), Ly = Ji || dd ? function(e) {
  if (!e || typeof e != "object")
    return !1;
  try {
    return Ji ? Ji(e) : dd(e, 0), !0;
  } catch {
    return !1;
  }
} : Ra ? function(e) {
...
}, Da = Ie, By = Cn(), zy, Fy, $a, Pa;
if (By) {
  zy = Da("Object.prototype.hasOwnProperty"), Fy = Da("RegExp.prototype.exec"), $a = {};
  var El = function() {
    throw $a;
  };
  Pa = {
...
var TN = Da("Object.prototype.toString"), MN = Object.getOwnPropertyDescriptor, NN = "[object RegExp]", IN = By ? function(e) {
  if (!e || typeof e != "object")
    return !1;
  var t = MN(e, "lastIndex"), r = t && zy(t, "value");
  if (!r)
    return !1;
  try {
    Fy(e, Pa);
...
}, RN = Ie, pd = RN("SharedArrayBuffer.prototype.byteLength", !0), DN = pd ? function(e) {
  if (!e || typeof e != "object")
    return !1;
  try {
    return pd(e), !0;
...
}, jy = Ie, FN = jy("Boolean.prototype.toString"), jN = jy("Object.prototype.toString"), VN = function(e) {
  try {
    return FN(e), !0;
  } catch {
    return !1;
...
var XN = _a.exports, La = { exports: {} }, gd = typeof BigInt < "u" && BigInt, QN = function() {
  return typeof gd == "function" && typeof BigInt == "function" && typeof gd(42) == "bigint" && typeof BigInt(42) == "bigint";
}, ZN = QN();
if (ZN) {
...
var nI = La.exports, rI = Oy, iI = zN, oI = HN, sI = XN, lI = nI, aI = function(e) {
  ...
  if (lI(e))
    return "BigInt";
}, ns = typeof WeakMap == "function" && WeakMap.prototype ? WeakMap : null, md = typeof WeakSet == "function" && WeakSet.prototype ? WeakSet : null, rs;
ns || (rs = function(e) {
  return !1;
});
var Ba = ns ? ns.prototype.has : null, Al = md ? md.prototype.has : null;
!rs && !Ba && (rs = function(e) {
  return !1;
});
var cI = rs || function(e) {
  if (!e || typeof e != "object")
    return !1;
  try {
    if (Ba.call(e, Ba), Al)
  ...
  return !1;
}, za = { exports: {} }, fI = rt, Vy = Ie, uI = fI("%WeakSet%", !0), Ol = Vy("WeakSet.prototype.has", !0);
if (Ol) {
  var Tl = Vy("WeakMap.prototype.has", !0);
...
var hI = za.exports, dI = My, pI = Iy, gI = cI, mI = hI, yI = function(e) {
  if (e && typeof e == "object") {
    if (dI(e))
      return "Map";
    if (pI(e))
  ...
  return !1;
}, Wy = Function.prototype.toString, $n = typeof Reflect == "object" && Reflect !== null && Reflect.apply, Fa, Gi;
...
var bI = /^\s*class\b/, ja = function(e) {
  ...
  try {
    return ja(e) ? !1 : (Wy.call(e), !0);
  } catch {
    return !1;
  }
}, Ki = Object.prototype.toString, wI = "[object Object]", SI = "[object Function]", vI = "[object GeneratorFunction]", xI = "[object HTMLAllCollection]", CI = "[object HTML document.all class]", kI = "[object HTMLCollection]", EI = typeof Symbol == "function" && !!Symbol.toStringTag, AI = !(0 in [,]), Va = function() {
  return !1;
};
if (typeof document == "object") {
  var OI = document.all;
  Ki.call(OI) === Ki.call(document.all) && (Va = function(e) {
...
var TI = $n ? function(e) {
...
}, MI = TI, NI = Object.prototype.toString, Uy = Object.prototype.hasOwnProperty, II = function(e, t, r) {
  for (var i = 0, o = e.length; i < o; i++)
    Uy.call(e, i) && (r == null ? t(e[i], i, e) : t.call(r, e[i], i, e));
}, RI = function(e, t, r) {
  for (var i = 0, o = e.length; i < o; i++)
  ...
  "BigInt64Array",
  "BigUint64Array"
], Nl = _I, LI = typeof globalThis > "u" ? qo : globalThis, BI = function() {
  for (var e = [], t = 0; t < Nl.length; t++)
    typeof LI[Nl[t]] == "function" && (e[e.length] = Nl[t]);
  return e;
}, is = PI, zI = BI, yd = lr, Xc = Ie, qi = jc, FI = Xc("Object.prototype.toString"), Hy = Cn(), bd = typeof globalThis > "u" ? qo : globalThis, Wa = zI(), Qc = Xc("String.prototype.slice"), Il = Object.getPrototypeOf, jI = Xc("Array.prototype.indexOf", !0) || function(e, t) {
  for (var r = 0; r < e.length; r += 1)
    if (e[r] === t)
      return r;
  return -1;
}, ss = { __proto__: null };
Hy && qi && Il ? is(Wa, function(n) {
  var e = new bd[n]();
  if (Symbol.toStringTag in e) {
    var t = Il(e), r = qi(t, Symbol.toStringTag);
    if (!r) {
      var i = Il(t);
      r = qi(i, Symbol.toStringTag);
    }
    ss["$" + n] = yd(r.get);
  }
}) : is(Wa, function(n) {
  var e = new bd[n](), t = e.slice || e.set;
  t && (ss["$" + n] = yd(t));
});
var VI = function(e) {
  var t = !1;
  ...
  return qi ? VI(e) : null;
}, HI = Ie, wd = HI("ArrayBuffer.prototype.byteLength", !0), JI = Ly, GI = function(e) {
  return JI(e) ? wd ? wd(e) : e.byteLength : NaN;
}, Jy = ET, it = Ie, Sd = qT, KI = rt, Zn = cN, qI = Ey, vd = bN, xd = yy, Cd = Ay, kd = Ly, Ed = ON, Ad = IN, Od = DN, Td = Lc, Md = aI, Nd = yI, Id = UI, Rd = GI, Dd = it("SharedArrayBuffer.prototype.byteLength", !0), $d = it("Date.prototype.getTime"), Rl = Object.getPrototypeOf, Pd = it("Object.prototype.toString"), ls = KI("%Set%", !0), Ua = it("Map.prototype.has", !0), as = it("Map.prototype.get", !0), _d = it("Map.prototype.size", !0), cs = it("Set.prototype.add", !0), Gy = it("Set.prototype.delete", !0), fs = it("Set.prototype.has", !0), Yi = it("Set.prototype.size", !0);
function Ld(n, e, t, r) {
  for (var i = Zn(n), o; (o = i.next()) && !o.done; )
    if (_e(e, o.value, t, r))
      return Gy(n, o.value), !0;
  return !1;
}
function Ky(n) {
  if (typeof n > "u")
...
function QI(n, e, t, r) {
  ...
  for (var i = Zn(n), o = Zn(e), s, l, a; (s = i.next()) && !s.done; )
    if (s.value && typeof s.value == "object")
      a || (a = new ls()), cs(a, s.value);
    else if (!fs(e, s.value)) {
  ...
  if (a) {
    for (; (l = o.next()) && !l.done; )
      if (l.value && typeof l.value == "object") {
        if (!Ld(a, l.value, t.strict, r))
          return !1;
      } else if (!t.strict && !fs(n, l.value) && !Ld(a, l.value, t.strict, r))
        return !1;
    return Yi(a) === 0;
  }
  return !0;
...
function ZI(n, e, t, r) {
  ...
  for (var i = Zn(n), o = Zn(e), s, l, a, c, f, u; (s = i.next()) && !s.done; )
    if (c = s.value[0], f = s.value[1], c && typeof c == "object")
      a || (a = new ls()), cs(a, c);
    else if (u = as(e, c), typeof u > "u" && !Ua(e, c) || !_e(f, u, t, r)) {
  ...
  if (a) {
    for (; (l = o.next()) && !l.done; )
      if (c = l.value[0], u = l.value[1], c && typeof c == "object") {
        if (!Bd(a, n, c, u, t, r))
          return !1;
      } else if (!t.strict && (!n.has(c) || !_e(as(n, c), u, t, r)) && !Bd(a, n, c, u, Jy({}, t, { strict: !1 }), r))
        return !1;
    return Yi(a) === 0;
  }
  return !0;
...
function eR(n, e, t, r) {
  var i, o;
  if (typeof n != typeof e || n == null || e == null || Pd(n) !== Pd(e) || xd(n) !== xd(e))
    return !1;
  var s = Cd(n), l = Cd(e);
  if (s !== l)
    return !1;
  ...
  if (a !== c || (a || c) && (n.name !== e.name || n.message !== e.message))
    return !1;
  var f = Ad(n), u = Ad(e);
  if (f !== u || (f || u) && (n.source !== e.source || Sd(n) !== Sd(e)))
    return !1;
  var h = Ed(n), d = Ed(e);
  if (h !== d || (h || d) && $d(n) !== $d(e) || t.strict && Rl && Rl(n) !== Rl(e))
    return !1;
  var p = Id(n), g = Id(e);
  if (p !== g)
    return !1;
  ...
  if (v !== k)
    return !1;
  if (v || k)
    return Rd(n) !== Rd(e) ? !1 : typeof Uint8Array == "function" && _e(new Uint8Array(n), new Uint8Array(e), t, r);
  var A = Od(n), O = Od(e);
  if (A !== O)
    return !1;
  if (A || O)
