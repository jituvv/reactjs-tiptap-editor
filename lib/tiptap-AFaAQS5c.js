...
import { P, a as I, N as Q, S as X, f as Fe, c as Nt, T as ze, l as Ve, b as We, d as $, e as Ke, g as Ue, j as qe, h as Ge, i as Je, k as Ye, m as ve, n as Xe, o as Qe, p as Ze, q as tn, r as en, s as nn, t as rn, u as sn, v as on, w as an, x as ln, y as Jt, z as cn, A as at, F as lt, B as dn, C as un, D as pn, E as hn, G as fn, H as mn, I as Me, J as Et, R as gn, K as yn, L as bn, M as Yt, O as Se, Q as vn, U as Mn, V as Sn, W as kn, X as wn, Y as En, Z as dt, _ as Bt, $ as Tn, a0 as Cn, a1 as xn, a2 as An, a3 as On, a4 as Ln, a5 as _n, a6 as Rn, a7 as Xt, a8 as Qt, a9 as Zt, aa as Hn, ab as Pn, ac as te, ad as In, ae as ke, af as $n, ag as Dn } from "./vendor-CmhbSbc7.js";
import O, { forwardRef as Nn, useRef as Bn, useState as jt, useDebugValue as we, useEffect as Ft, createContext as Ee, useContext as Te } from "react";
import jn, { flushSync as Fn } from "react-dom";
function ft(e) {
...
function Kn(e, t) {
  var n;
  const r = Ce(e), { nodeExtensions: s, markExtensions: o } = gt(e), i = (n = s.find((c) => v(c, "topNode"))) === null || n === void 0 ? void 0 : n.name, a = Object.fromEntries(s.map((c) => {
...
function st(e) {
  return Jn(e) !== "Object" ? !1 : e.constructor === Object && Object.getPrototypeOf(e) === Object.prototype;
}
function bt(e, t) {
  const n = { ...e };
  ...
  return n.map((u) => new P({
    ...
    appendTransaction: (d, p, h) => {
      ...
      if (!m && !y && !k)
        return;
      if (k) {
        const { from: w, text: S } = g, C = w + S.length, A = tr(S);
        return l({
          rule: u,
          state: h,
          from: w,
...
class Y {
  constructor(t, n) {
    this.splittableMarks = [], this.editor = n, this.extensions = Y.resolve(t), this.schema = Kn(this.extensions, n), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(t) {
    const n = Y.sort(Y.flatten(t)), r = nr(n.map((s) => s.name));
   ...
   */
  get plugins() {
    const { editor: t } = this, n = Y.sort([...this.extensions].reverse()), r = [], s = [], o = n.map((i) => {
      const a = {
        name: i.name,
        options: i.options,
        storage: i.storage,
      ...
      re(i, t.options.enableInputRules) && p && r.push(...p());
      const h = v(i, "addPasteRules", a);
      re(i, t.options.enablePasteRules) && h && s.push(...h());
...
}), sr = () => ({ editor: e, view: t }) => (requestAnimationFrame(() => {
  var n;
  e.isDestroyed || (t.dom.blur(), (n = window == null ? void 0 : window.getSelection()) === null || n === void 0 || n.removeAllRanges());
}), !0), or = (e = !1) => ({ commands: t }) => t.setContent("", e), ir = () => ({ state: e, tr: t, dispatch: n }) => {
...
}, ar = (e) => (t) => e(t), lr = () => ({ state: e, dispatch: t }) => We(e, t), cr = (e, t) => ({ editor: n, tr: r }) => {
...
}, hr = () => ({ state: e, dispatch: t }) => Ke(e, t), fr = () => ({ commands: e }) => e.keyboardShortcut("Enter"), mr = () => ({ state: e, dispatch: t }) => Ue(e, t);
function pt(e, t, n = { strict: !0 }) {
  const r = Object.keys(t);
  return r.length ? r.every((s) => n.strict ? t[s] === e[s] : zt(t[s]) ? t[s].test(e[s]) : t[s] === e[s]) : !0;
}
function Rt(e, t, n = {}) {
...
function Vt(e, t, n = {}) {
  ...
  for (; a < e.parent.childCount && gr([...e.parent.child(a).marks], t, n); )
...
const yr = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  const o = z(e, r.schema), { doc: i, selection: a } = n, { $from: l, from: c, to: u } = a;
  if (s) {
    const d = Vt(l, o, t);
...
function Le(e, t = null) {
  if (!t)
    return null;
  const n = X.atStart(e), r = X.atEnd(e);
  if (t === "start" || t === !0)
    return n;
  if (t === "end")
    return r;
...
const vr = (e = null, t = {}) => ({ editor: n, view: r, tr: s, dispatch: o }) => {
  ...
  if (r.hasFocus() && e === null || e === !1)
    return !0;
  if (o && e === null && !Wt(n.state.selection))
    return i(), !0;
...
}, Mr = (e, t) => (n) => e.every((r, s) => t(r, { ...n, index: s })), Sr = (e, t) => ({ tr: n, commands: r }) => r.insertContentAt({ from: n.selection.from, to: n.selection.to }, e, t), _e = (e) => {
...
function kr(e, t, n) {
  ...
  if (r < t)
    return;
  const s = e.steps[r];
  if (!(s instanceof gn || s instanceof yn))
    return;
  const o = e.mapping.maps[r];
  let i = 0;
  o.forEach((a, l, c, u) => {
    i === 0 && (i = u);
  }), e.setSelection(X.near(e.doc.resolve(i), n));
}
const wr = (e) => !("type" in e), Er = (e, t, n) => ({ tr: r, dispatch: s, editor: o }) => {
  var i;
  if (s) {
    n = {
    ...
    let h;
    u ? (Array.isArray(t) ? h = t.map((f) => f.text || "").join("") : typeof t == "object" && t && t.text ? h = t.text : h = t, r.insertText(h, l, c)) : (h = a, r.replaceWith(l, c, h)), n.updateSelection && kr(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", { from: l, text: h }), n.applyPasteRules && r.setMeta("applyPasteRules", { from: l, text: h });
  }
  return !0;
}, Tr = () => ({ state: e, dispatch: t }) => qe(e, t), Cr = () => ({ state: e, dispatch: t }) => Ge(e, t), xr = () => ({ state: e, dispatch: t }) => Je(e, t), Ar = () => ({ state: e, dispatch: t }) => Ye(e, t), Or = () => ({ state: e, dispatch: t, tr: n }) => {
  try {
...
}, _r = () => ({ state: e, dispatch: t }) => Xe(e, t), Rr = () => ({ state: e, dispatch: t }) => Qe(e, t);
function Re() {
...
const Pr = (e) => ({ editor: t, view: n, tr: r, dispatch: s }) => {
  const o = Hr(e).split(/-(?!$)/), i = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), a = new KeyboardEvent("keydown", {
    key: i === "Space" ? " " : i,
...
const Ir = (e, t = {}) => ({ state: n, dispatch: r }) => {
  const s = H(e, n.schema);
  return nt(n, s, t) ? Ze(n, r) : !1;
}, $r = () => ({ state: e, dispatch: t }) => tn(e, t), Dr = (e) => ({ state: t, dispatch: n }) => {
  const r = H(e, t.schema);
  return en(r)(t, n);
}, Nr = () => ({ state: e, dispatch: t }) => nn(e, t);
function Mt(e, t) {
...
const Br = (e, t) => ({ tr: n, state: r, dispatch: s }) => {
  ...
  return a ? (a === "node" && (o = H(e, r.schema)), a === "mark" && (i = z(e, r.schema)), s && n.selection.ranges.forEach((l) => {
    r.doc.nodesBetween(l.$from.pos, l.$to.pos, (c, u) => {
      o && o === c.type && n.setNodeMarkup(u, void 0, se(c.attrs, t)), i && c.marks.length && c.marks.forEach((d) => {
        i === d.type && n.addMark(u, u + c.nodeSize, i.create(se(d.attrs, t)));
      });
    });
  }), !0) : !1;
}, jr = () => ({ tr: e, dispatch: t }) => (t && e.scrollIntoView(), !0), Fr = () => ({ tr: e, commands: t }) => t.setTextSelection({
  from: 0,
  to: e.doc.content.size
}), zr = () => ({ state: e, dispatch: t }) => rn(e, t), Vr = () => ({ state: e, dispatch: t }) => sn(e, t), Wr = () => ({ state: e, dispatch: t }) => on(e, t), Kr = () => ({ state: e, dispatch: t }) => an(e, t), Ur = () => ({ state: e, dispatch: t }) => ln(e, t);
function Ht(e, t, n = {}, r = {}) {
  return ht(e, t, {
    slice: !1,
    parseOptions: n,
...
const qr = (e, t = !1, n = {}, r = {}) => ({ editor: s, tr: o, dispatch: i, commands: a }) => {
  var l, c;
  const { doc: u } = o;
...
function Xr(e, t) {
  const n = bn.fromSchema(t).serializeFragment(e), s = document.implementation.createHTMLDocument().createElement("div");
...
function Pe(e, t) {
  ...
  return n === "node" ? Zr(e, t) : n === "mark" ? Kt(e, t) : {};
}
function ts(e, t = JSON.stringify) {
  const n = {};
  return e.filter((r) => {
    const s = t(r);
...
const is = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  const { selection: o } = n, { empty: i, ranges: a } = o, l = z(e, r.schema);
  if (s)
    if (i) {
      const c = Kt(r, l);
  ...
  return os(r, n, l);
}, as = (e, t) => ({ tr: n }) => (n.setMeta(e, t), !0), ls = (e, t = {}) => ({ state: n, dispatch: r, chain: s }) => {
  const o = H(e, n.schema);
  return o.isTextblock ? s().command(({ commands: i }) => Jt(o, t)(n) ? !0 : i.clearNodes()).command(({ state: i }) => Jt(o, t)(i, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
}, cs = (e) => ({ tr: t, dispatch: n }) => {
  if (n) {
    const { doc: r } = t, s = B(e, 0, r.content.size), o = Q.create(r, s);
    t.setSelection(o);
  }
  return !0;
}, ds = (e) => ({ tr: t, dispatch: n }) => {
  if (n) {
    const { doc: r } = t, { from: s, to: o } = typeof e == "number" ? { from: e, to: e } : e, i = $.atStart(r).from, a = $.atEnd(r).to, l = B(s, i, a), c = B(o, i, a), u = $.create(r, l, c);
    t.setSelection(u);
  }
  return !0;
}, us = (e) => ({ state: t, dispatch: n }) => {
  const r = H(e, t.schema);
  return cn(r)(t, n);
};
function ie(e, t) {
...
const ps = ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: r, editor: s }) => {
  ...
  if (o instanceof Q && o.node.isBlock)
    return !a.parentOffset || !at(i, a.pos) ? !1 : (r && (e && ie(n, s.extensionManager.splittableMarks), t.split(a.pos).scrollIntoView()), !0);
  if (!a.parent.isBlock)
    return !1;
  const d = l.parentOffset === l.parent.content.size, p = a.depth === 0 ? void 0 : Jr(a.node(-1).contentMatchAt(a.indexAfter(-1)));
  let h = d && p ? [
    {
      type: p,
      attrs: u
  ...
  if (!h && !f && at(t.doc, t.mapping.map(a.pos), 1, p ? [{ type: p }] : void 0) && (f = !0, h = p ? [
    ...
    e && ie(n, s.extensionManager.splittableMarks), t.scrollIntoView();
  }
  return f;
  ...
  if (l.parent.content.size === 0 && l.node(-1).childCount === l.indexAfter(-1)) {
    ...
    if (s) {
      ...
      n.replace(S, l.after(-b), new dn(g, 4 - k, 0));
      let C = -1;
  ...
  return n.node.type === (s == null ? void 0 : s.type) && Nt(e.doc, n.pos) && e.join(n.pos), !0;
}, xt = (e, t) => {
  const n = Ut((i) => i.type === t)(e.selection);
  if (!n)
    return !0;
  ...
  if (r === void 0)
    return !0;
  const s = e.doc.nodeAt(r);
  return n.node.type === (s == null ? void 0 : s.type) && Nt(e.doc, r) && e.join(r), !0;
}, fs = (e, t, n, r = {}) => ({ editor: s, tr: o, state: i, dispatch: a, chain: l, commands: c, can: u }) => {
  ...
  if (!b)
    return !1;
  const w = Ut((S) => oe(S.type.name, d))(m);
  if (b.depth >= 1 && w && b.depth - w.depth <= 1) {
    if (w.node.type === h)
      return c.liftListItem(f);
    if (oe(w.node.type.name, d) && h.validContent(w.node.content) && a)
...
}, Ms = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  var o;
  const { extendEmptyMarkRange: i = !1 } = t, { selection: a } = n, l = z(e, r.schema), { $from: c, empty: u, ranges: d } = a;
  if (!s)
    return !0;
  if (u && i) {
    let { from: p, to: h } = a;
    const f = (o = c.marks().find((y) => y.type === l)) === null || o === void 0 ? void 0 : o.attrs, m = Vt(c, l, f);
...
}, Ss = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  let o = null, i = null;
  const a = Mt(typeof e == "string" ? e : e.name, r.schema);
  return a ? (a === "node" && (o = H(e, r.schema)), a === "mark" && (i = z(e, r.schema)), s && n.selection.ranges.forEach((l) => {
...
var Es = /* @__PURE__ */ Object.freeze({
  ...
  clearNodes: ir,
  command: ar,
  createParagraphNear: lr,
  cut: cr,
  deleteCurrentNode: dr,
  deleteNode: ur,
  deleteRange: pr,
  deleteSelection: hr,
  enter: fr,
  ...
  joinItemBackward: Or,
  joinItemForward: Lr,
  joinTextblockBackward: _r,
  joinTextblockForward: Rr,
  joinUp: Tr,
  keyboardShortcut: Pr,
  lift: Ir,
  liftEmptyBlock: $r,
  ...
  scrollIntoView: jr,
  selectAll: Fr,
  selectNodeBackward: zr,
  selectNodeForward: Vr,
  selectParentNode: Wr,
  selectTextblockEnd: Kr,
  selectTextblockStart: Ur,
  setContent: qr,
  setMark: is,
  setMeta: as,
  setNode: ls,
...
const Ts = L.create({
  ...
  addKeyboardShortcuts() {
    const e = () => this.editor.commands.first(({ commands: i }) => [
      ...
      () => i.command(({ tr: a }) => {
        const { selection: l, doc: c } = a, { empty: u, $anchor: d } = l, { pos: p, parent: h } = d, f = d.parent.isTextblock && p > 0 ? a.doc.resolve(p - 1) : d, m = f.parent.type.spec.isolating, y = d.pos - d.parentOffset, g = m && f.parent.childCount === 1 ? y === d.pos : X.atStart(c).from === p;
    ...
    return [
      ...
      new P({
        ...
        appendTransaction: (e, t, n) => {
          ...
          if (!r || s)
            return;
          const { empty: o, from: i, to: a } = t.selection, l = X.atStart(t.doc).from, c = X.atEnd(t.doc).to;
  ...
  get children() {
    ...
    return this.node.content.forEach((n, r) => {
      ...
      if (!s && a.depth <= this.depth)
        return;
      const l = new U(a, this.editor, s, s ? n : null);
      s && (l.actualDepth = this.depth + 1), t.push(new U(a, this.editor, s, s ? n : null));
    }), t;
  }
  get firstChild() {
...
class Ps extends zn {
   ...
   */
  injectCSS() {
    this.options.injectCSS && document && (this.css = Hs(Rs, this.options.injectNonce));
  }
  /**
  ...
  createExtensionManager() {
    ...
    this.extensionManager = new Y(s, this);
  }
  /**
   ...
   */
  getHTML() {
    return Xr(this.state.doc.content, this.schema);
  }
  /**
  ...
  return new yt({
    ...
    handler: ({ state: t, range: n, match: r }) => {
      ...
      if (i) {
        ...
        if (qt(n.from, n.to, t.doc).filter((h) => h.mark.type.excluded.find((m) => m === e.type && m !== h.mark.type)).filter((h) => h.to > c).length)
          return null;
...
function tt(e) {
  return new yt({
    ...
    handler: ({ state: t, range: n, match: r, chain: s }) => {
      const o = E(e.getAttributes, void 0, r) || {}, i = t.tr.delete(n.from, n.to), l = i.doc.resolve(n.from).blockRange(), c = l && Fe(l, e.type, o);
      if (!c)
        return null;
      ...
      u && u.type === e.type && Nt(i.doc, n.from - 1) && (!e.joinPredicate || e.joinPredicate(r, u)) && i.join(n.from - 1);
    }
  });
}
class _ {
...
class Ns {
  ...
  onDragStart(t) {
    ...
    if (typeof f != "number")
      return;
    const m = Q.create(c.state.doc, f), y = c.state.tr.setSelection(m);
    c.dispatch(y);
  }
  stopEvent(t) {
    var n;
    ...
    if ((["INPUT", "BUTTON", "SELECT", "TEXTAREA"].includes(r.tagName) || r.isContentEditable) && !i && !o)
      return !0;
    const { isEditable: l } = this.editor, { isDragging: c } = this, u = !!this.node.type.spec.draggable, d = Q.isSelectable(this.node), p = t.type === "copy", h = t.type === "paste", f = t.type === "cut", m = t.type === "mousedown";
   ...
   */
  ignoreMutation(t) {
    return !this.dom || !this.contentDOM ? !0 : typeof this.options.ignoreMutation == "function" ? this.options.ignoreMutation({ mutation: t }) : this.node.isLeaf || this.node.isAtom ? !0 : t.type === "selection" || this.dom.contains(t.target) && t.type === "childList" && (vt() || Ds()) && this.editor.isFocused && [
  ...
  return new Xn({
    ...
    handler: ({ state: t, range: n, match: r, pasteEvent: s }) => {
      ...
      if (a) {
        ...
        if (qt(n.from, n.to, t.doc).filter((f) => f.mark.type.excluded.find((y) => y === e.type && y !== f.mark.type)).filter((f) => f.to > d).length)
          return null;
...
const js = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, Fs = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, zs = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, Vs = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, Ko = D.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
class Ws {
  constructor({ editor: t, element: n, view: r, tippyOptions: s = {}, updateDelay: o = 250, shouldShow: i }) {
    this.preventHide = !1, this.shouldShow = ({ view: a, state: l, from: c, to: u }) => {
      const { doc: d, selection: p } = l, { empty: h } = p, f = !d.textBetween(c, u).length && Wt(l.selection), m = this.element.contains(document.activeElement);
...
process.env.NODE_ENV === "production" ? It.exports = Us() : It.exports = qs();
var kt = It.exports;
const Gs = (...e) => (t) => {
  e.forEach((n) => {
    typeof n == "function" ? n(t) : n && (n.current = t);
  });
}, Js = ({ contentComponent: e }) => {
...
function Ys() {
  ...
  return {
    ...
    setRenderer(n, r) {
      t = {
        ...t,
        [n]: jn.createPortal(r.reactElement, r.element, n)
      }, e.forEach((s) => s());
    },
    /**
...
class Xs extends O.Component {
  ...
  init() {
    ...
    if (t && !t.isDestroyed && t.options.element) {
      ...
      n.append(...t.options.element.childNodes), t.setOptions({
        element: n
      }), t.contentComponent = Ys(), this.state.hasContentComponentInitialized || (this.unsubscribeToContentComponent = t.contentComponent.subscribe(() => {
  ...
  render() {
    ...
    return O.createElement(
      O.Fragment,
      null,
      O.createElement("div", { ref: Gs(n, this.editorContentRef), ...r }),
      (t == null ? void 0 : t.contentComponent) && O.createElement(Js, { contentComponent: t.contentComponent })
    );
  }
}
const Qs = Nn((e, t) => {
...
var Zs = function e(t, n) {
  ...
  return t !== t && n !== n;
}, to = /* @__PURE__ */ Ks(Zs), $t = { exports: {} }, Lt = {};
/**
 * @license React
      ...
      var g = a(function() {
        var w = !1, S, C, A = function(j) {
          ...
          if (r(W, j))
            return F;
          var K = h(j);
          return f !== void 0 && f(F, K) ? F : (S = j, C = K, K);
...
process.env.NODE_ENV === "production" ? $t.exports = eo() : $t.exports = no();
var ro = $t.exports;
class so {
  constructor(t) {
...
function oo(e) {
  var t;
  const [n] = jt(() => new so(e.editor)), r = ro.useSyncExternalStoreWithSelector(n.subscribe, n.getSnapshot, n.getServerSnapshot, e.selector, (t = e.equalityFn) !== null && t !== void 0 ? t : to);
  return Ft(() => n.watch(e.editor), [e.editor, n]), we(r), r;
}
const ue = process.env.NODE_ENV !== "production", Dt = typeof window > "u", io = Dt || !!(typeof window < "u" && window.next);
class ao {
  constructor(t) {
  ...
  getInitialEditor() {
    if (this.options.current.immediatelyRender === void 0)
      return Dt || io ? (ue && console.warn("Tiptap Error: SSR has been detected, please set `immediatelyRender` explicitly to `false` to avoid hydration mismatches."), null) : this.createEditor();
    if (this.options.current.immediatelyRender && Dt && ue)
...
function qo(e = {}, t = []) {
  const n = Bn(e);
  n.current = e;
  const [r] = jt(() => new ao(n)), s = kt.useSyncExternalStore(r.subscribe, r.getEditor, r.getServerSnapshot);
  return we(s), Ft(r.onRender(t)), oo({
    editor: s,
...
const lo = () => Te(De), Go = (e) => {
  ...
  onDragStart: void 0
}), co = () => Te(Ne), Jo = O.forwardRef((e, t) => {
  const { onDragStart: n } = co(), r = e.as || "div";
  return (
    // @ts-ignore
...
class ho {
  ...
  constructor(t, { editor: n, props: r = {}, as: s = "div", className: o = "" }) {
    this.ref = null, this.id = Math.floor(Math.random() * 4294967295).toString(), this.component = t, this.editor = n, this.props = r, this.element = document.createElement(s), this.element.classList.add("react-renderer"), o && this.element.classList.add(...o.split(" ")), this.editor.isInitialized ? Fn(() => {
      this.render();
    }) : this.render();
  }
  /**
...
class fo extends Ns {
  ...
  mount() {
    ...
    } }, o = this.component, i = O.memo((c) => O.createElement(Ne.Provider, { value: s }, O.createElement(o, c)));
...
const mo = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, go = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, yo = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, bo = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, Xo = D.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), vo = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, Mo = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, Zo = D.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), wo = "listItem", pe = "textStyle", he = /^\s*([-+*])\s$/, ii = _.create({
  name: "bulletList",
  addOptions() {
    return {
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(wo, this.editor.getAttributes(pe)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (e = tt({
      ...
      getAttributes: () => this.editor.getAttributes(pe),
      editor: this.editor
    })), [
      e
    ];
  }
}), Eo = "listItem", fe = "textStyle", me = /^(\d+)\.\s$/, ai = _.create({
  name: "orderedList",
  addOptions() {
    return {
      itemTypeName: "listItem",
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: e, chain: t }) => this.options.keepAttributes ? t().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(Eo, this.editor.getAttributes(fe)).run() : e.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (e = tt({
      ...
      keepMarks: this.options.keepMarks,
      keepAttributes: this.options.keepAttributes,
      getAttributes: (t) => ({ start: +t[1], ...this.editor.getAttributes(fe) }),
      joinPredicate: (t, n) => n.childCount + n.attrs.start === +t[1],
      editor: this.editor
    })), [
      e
...
function Ao(e) {
  return new P({
    ...
    appendTransaction: (t, n, r) => {
      ...
      if (!s || o)
        return;
      const { tr: i } = r, a = Gr(n.doc, [...t]);
      if (ns(a).forEach(({ newRange: c }) => {
        const u = Yr(r.doc, c, (h) => h.isTextblock);
        let d, p;
        if (u.length > 1 ? (d = u[0], p = r.doc.textBetween(d.pos, d.pos + d.node.nodeSize, void 0, " ")) : u.length && r.doc.textBetween(c.from, c.to, " ", " ").endsWith(" ") && (d = u[0], p = r.doc.textBetween(d.pos, c.to, void 0, " ")), d && p) {
          ...
          if (!f)
            return !1;
          const y = vn(f).map((g) => g.toObject(e.defaultProtocol));
          if (!xo(y))
            return !1;
          y.filter((g) => g.isLink).map((g) => ({
            ...
            qt(g.from, g.to, r.doc).some((k) => k.mark.type === e.type) || i.addMark(g.from, g.to, e.type.create({
              href: g.href
            }));
          });
        }
...
function ge(e, t) {
  ...
  return t && t.forEach((r) => {
    ...
    s && n.push(s);
  }), !e || e.replace(_o, "").match(new RegExp(`^(?:(?:${n.join("|")}):|[^a-z]|[a-z+.-]+(?:[^a-z+.-:]|$))`, "i"));
}
const ui = D.create({
  name: "link",
  priority: 1e3,
  ...
  addProseMirrorPlugins() {
    const e = [];
    return this.options.autolink && e.push(Ao({
      type: this.type,
      defaultProtocol: this.options.defaultProtocol,
      validate: this.options.validate
    })), this.options.openOnClick === !0 && e.push(Oo({
      type: this.type
    })), this.options.linkOnPaste && e.push(Lo({
      editor: this.editor,
      defaultProtocol: this.options.defaultProtocol,
      type: this.type
    })), e;
      ...
      setHorizontalRule: () => ({ chain: e, state: t }) => {
        ...
        return r.parentOffset === 0 ? o.insertContentAt({
          ...
          if (a) {
            ...
            if (c.nodeAfter)
              c.nodeAfter.isTextblock ? i.setSelection($.create(i.doc, c.pos + 1)) : c.nodeAfter.isBlock ? i.setSelection(Q.create(i.doc, c.pos)) : i.setSelection($.create(i.doc, c.pos));
            else {
  ...
  addCommands() {
    return {
      undo: () => ({ state: e, dispatch: t }) => Sn(e, t),
          ...
          decorations: ({ doc: e, selection: t }) => {
            ...
            return e.descendants((i, a) => {
              ...
              if ((l || !this.options.showOnlyCurrent) && c) {
                ...
                const d = Bt.node(a, a + i.nodeSize, {
                  class: u.join(" "),
...
function Ro(e) {
  var t;
  const { char: n, allowSpaces: r, allowedPrefixes: s, startOfLine: o, $position: i } = e, a = Bs(n), l = new RegExp(`\\s${a}$`), c = o ? "^" : "", u = r ? new RegExp(`${c}${a}.*?(?=\\s${a}|$)`, "gm") : new RegExp(`${c}(?:^)?${a}[^\\s${a}]*`, "gm"), d = ((t = i.nodeBefore) === null || t === void 0 ? void 0 : t.isText) && i.nodeBefore.text;
  if (!d)
    return null;
...
const Ho = new I("suggestion");
function Po({ pluginKey: e = Ho, editor: t, char: n = "@", allowSpaces: r = !1, allowedPrefixes: s = [" "], startOfLine: o = !1, decorationTag: i = "span", decorationClass: a = "suggestion", command: l = () => null, items: c = () => [], render: u = () => ({}), allow: d = () => !0, findSuggestionMatch: p = Ro }) {
  let h;
  const f = u == null ? void 0 : u(), m = new P({
    ...
    view() {
      return {
        update: async (y, g) => {
          var k, b, M, w, S, C, A;
          const T = (k = this.key) === null || k === void 0 ? void 0 : k.getState(g), R = (b = this.key) === null || b === void 0 ? void 0 : b.getState(y.state), N = T.active && R.active && T.range.from !== R.range.from, j = !T.active && R.active, G = T.active && !R.active, V = !j && !G && T.query !== R.query, W = j || N && V, F = V || N, K = G || N && V;
          if (!W && !F && !K)
            return;
          const J = K && !W ? T : R, Gt = y.dom.querySelector(`[data-decoration-id="${J.decorationId}"]`);
          h = {
            editor: t,
            range: J.range,
            query: J.query,
            ...
            clientRect: Gt ? () => {
              var et;
              const { decorationId: Be } = (et = this.key) === null || et === void 0 ? void 0 : et.getState(t.state), wt = y.dom.querySelector(`[data-decoration-id="${Be}"]`);
              return (wt == null ? void 0 : wt.getBoundingClientRect()) || null;
            } : null
          }, W && ((M = f == null ? void 0 : f.onBeforeStart) === null || M === void 0 || M.call(f, h)), F && ((w = f == null ? void 0 : f.onBeforeUpdate) === null || w === void 0 || w.call(f, h)), (F || W) && (h.items = await c({
            editor: t,
            query: J.query
          })), K && ((S = f == null ? void 0 : f.onExit) === null || S === void 0 || S.call(f, h)), F && ((C = f == null ? void 0 : f.onUpdate) === null || C === void 0 || C.call(f, h)), W && ((A = f == null ? void 0 : f.onStart) === null || A === void 0 || A.call(f, h));
        },
        destroy: () => {
          var y;
...
const it = ({ editor: e }) => {
  ...
  if (!Bo(t))
    return !1;
  let n = 0;
  const r = He(t.ranges[0].$from, (o) => o.type.name === "table");
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const { colgroup: n, tableWidth: r, tableMinWidth: s } = $o(e, this.options.cellMinWidth);
    return [
      "table",
      x(this.options.HTMLAttributes, t, {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: e, dispatch: t }) => Cn(e, t),
      addColumnAfter: () => ({ state: e, dispatch: t }) => xn(e, t),
      deleteColumn: () => ({ state: e, dispatch: t }) => An(e, t),
      addRowBefore: () => ({ state: e, dispatch: t }) => On(e, t),
      addRowAfter: () => ({ state: e, dispatch: t }) => Ln(e, t),
      deleteRow: () => ({ state: e, dispatch: t }) => _n(e, t),
      deleteTable: () => ({ state: e, dispatch: t }) => Rn(e, t),
      mergeCells: () => ({ state: e, dispatch: t }) => Xt(e, t),
      splitCell: () => ({ state: e, dispatch: t }) => Qt(e, t),
      toggleHeaderColumn: () => ({ state: e, dispatch: t }) => Zt("column")(e, t),
      toggleHeaderRow: () => ({ state: e, dispatch: t }) => Zt("row")(e, t),
      toggleHeaderCell: () => ({ state: e, dispatch: t }) => Hn(e, t),
      mergeOrSplit: () => ({ state: e, dispatch: t }) => Xt(e, t) ? !0 : Qt(e, t),
      setCellAttribute: (e, t) => ({ state: n, dispatch: r }) => Pn(e, t)(n, r),
      goToNextCell: () => ({ state: e, dispatch: t }) => te(1)(e, t),
      goToPreviousCell: () => ({ state: e, dispatch: t }) => te(-1)(e, t),
      fixTables: () => ({ state: e, dispatch: t }) => (t && In(e), !0),
